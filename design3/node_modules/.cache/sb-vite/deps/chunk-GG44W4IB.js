...
var $9f79659886946c16$export$e5c5a5f917a5871c = globalThis?.document ? import_react.useLayoutEffect : () => {
};
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      let { scope, children, ...context } = props, Context = scope?.[scopeName][index] || BaseContext, value = (0, import_react.useMemo)(() => context, Object.values(context));
      return (0, import_react.createElement)(Context.Provider, { value }, children);
    }
    function useContext$1(consumerName, scope) {
      let Context = scope?.[scopeName][index] || BaseContext, context = (0, import_react.useContext)(Context);
...
function $e42e1063c40fb3ef$export$b9ecd428b558ff10(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return function(event) {
    if (originalEventHandler?.(event), checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
  };
}
...
function createCopyToClipboardFunction() {
  return navigator?.clipboard ? (text) => navigator.clipboard.writeText(text) : async (text) => {
...
//# sourceMappingURL=chunk-GG44W4IB.js.map
