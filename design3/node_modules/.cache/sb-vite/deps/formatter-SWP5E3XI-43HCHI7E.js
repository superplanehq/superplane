...
`);
        ...
        ne();
        var t = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), s = (a) => t.has(a?.type);
        r.exports = s;
...
`) + _;
        ...
        function q(De) {
          ...
          if (re?.type !== "IfStatement" || !ye) return false;
        ...
        function J(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ce } = De;
          return re?.type !== "WhileStatement" || !ye ? false : n(Ce, A, o) === ")" ? (l(G, A), true) : ye.type === "BlockStatement" ? (k(ye, A), true) : re.body === ye ? (i(ye, A), true) : false;
        }
        function L(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = De;
          return re?.type !== "TryStatement" && re?.type !== "CatchClause" || !ye ? false : re.type === "CatchClause" && G ? (l(G, A), true) : ye.type === "BlockStatement" ? (k(ye, A), true) : ye.type === "TryStatement" ? (M(ye.finalizer, A), true) : ye.type === "CatchClause" ? (M(ye.body, A), true) : false;
        }
        function Q(De) {
          let { comment: A, enclosingNode: G, followingNode: re } = De;
          return I(G) && re?.type === "Identifier" ? (i(G, A), true) : false;
        }
        function V(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ce } = De, Be = G && !u(Ce, o(G), C(A));
          return (!G || !Be) && (re?.type === "ConditionalExpression" || re?.type === "TSConditionalType") && ye ? (i(ye, A), true) : false;
        }
        function j(De) {
        ...
        function ce(De) {
          ...
          return re && G && n(ye, A, o) === "(" && (re.type === "Property" || re.type === "TSDeclareMethod" || re.type === "TSAbstractMethodDefinition") && G.type === "Identifier" && re.key === G && n(ye, G, o) !== ":" || G?.type === "Decorator" && ee.has(re?.type) ? (l(G, A), true) : false;
        }
        var W = /* @__PURE__ */ new Set(["FunctionDeclaration", "FunctionExpression", "ClassMethod", "MethodDefinition", "ObjectMethod"]);
        function K(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = De;
          return n(ye, A, o) !== "(" ? false : G && W.has(re?.type) ? (l(G, A), true) : false;
        }
        function de(De) {
          let { comment: A, enclosingNode: G, text: re } = De;
          if (G?.type !== "ArrowFunctionExpression") return false;
          let ye = y(re, A, o);
          return ye !== false && re.slice(ye, ye + 2) === "=>" ? (p(G, A), true) : false;
        }
        function ue(De) {
          let { comment: A, enclosingNode: G, text: re } = De;
          return n(re, A, o) !== ")" ? false : G && (le(G) && g(G).length === 0 || E(G) && N(G).length === 0) ? (p(G, A), true) : (G?.type === "MethodDefinition" || G?.type === "TSAbstractMethodDefinition") && g(G.value).length === 0 ? (p(G.value, A), true) : false;
        }
        function Fe(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ce } = De;
          if (G?.type === "FunctionTypeParam" && re?.type === "FunctionTypeAnnotation" && ye?.type !== "FunctionTypeParam" || (G?.type === "Identifier" || G?.type === "AssignmentPattern") && re && le(re) && n(Ce, A, o) === ")") return l(G, A), true;
          if (re?.type === "FunctionDeclaration" && ye?.type === "BlockStatement") {
            let Be = (() => {
              let ve = g(re);
        ...
        function z(De) {
          ...
          return G?.type === "LabeledStatement" ? (i(G, A), true) : false;
        }
        function U(De) {
          let { comment: A, enclosingNode: G } = De;
          return (G?.type === "ContinueStatement" || G?.type === "BreakStatement") && !G.label ? (l(G, A), true) : false;
        }
        function Z(De) {
          let { comment: A, precedingNode: G, enclosingNode: re } = De;
        ...
        function se(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = De;
          return re?.type === "UnionTypeAnnotation" || re?.type === "TSUnionType" ? (c(A) && (ye.prettierIgnore = true, A.unignore = true), G ? (l(G, A), true) : false) : ((ye?.type === "UnionTypeAnnotation" || ye?.type === "TSUnionType") && c(A) && (ye.types[0].prettierIgnore = true, A.unignore = true), false);
        }
        function fe(De) {
          let { comment: A, enclosingNode: G } = De;
        ...
        function ge(De) {
          ...
          return ye && ye.body && ye.body.length === 0 ? (Ce ? p(ye, A) : i(ye, A), true) : G?.type === "Program" && G?.body.length === 0 && !h(G.directives) ? (Ce ? p(G, A) : i(G, A), true) : re?.type === "Program" && re?.body.length === 0 && G?.type === "ModuleExpression" ? (p(re, A), true) : false;
        }
        function he(De) {
          let { comment: A, enclosingNode: G } = De;
          return G?.type === "ForInStatement" || G?.type === "ForOfStatement" ? (i(G, A), true) : false;
        }
        function we(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = De;
          if (re?.type === "ImportSpecifier" || re?.type === "ExportSpecifier") return i(re, A), true;
          let Ce = G?.type === "ImportSpecifier" && re?.type === "ImportDeclaration", Be = G?.type === "ExportSpecifier" && re?.type === "ExportNamedDeclaration";
          return (Ce || Be) && s(ye, o(A)) ? (l(G, A), true) : false;
        }
        function ke(De) {
          let { comment: A, enclosingNode: G } = De;
          return G?.type === "AssignmentPattern" ? (i(G, A), true) : false;
        }
        ...
        function Pe(De) {
          let { comment: A, enclosingNode: G, followingNode: re } = De;
          return Re.has(G?.type) && re && (Ne.has(re.type) || d(A)) ? (i(re, A), true) : false;
        }
        function oe(De) {
          let { comment: A, enclosingNode: G, followingNode: re, text: ye } = De;
          return !re && (G?.type === "TSMethodSignature" || G?.type === "TSDeclareFunction" || G?.type === "TSAbstractMethodDefinition") && n(ye, A, o) === ";" ? (l(G, A), true) : false;
        }
        function H(De) {
          let { comment: A, enclosingNode: G, followingNode: re } = De;
          if (c(A) && G?.type === "TSMappedType" && re?.type === "TSTypeParameter" && re.constraint) return G.prettierIgnore = true, A.unignore = true, true;
        }
        function pe(De) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = De;
          return re?.type !== "TSMappedType" ? false : ye?.type === "TSTypeParameter" && ye.name ? (i(ye.name, A), true) : G?.type === "TSTypeParameter" && G.constraint ? (l(G.constraint, A), true) : false;
        }
        function X(De) {
          let { comment: A, enclosingNode: G, followingNode: re } = De;
...
` : "") + t.insertPragma(l);
        ...
        function l(z, U) {
          ...
          return Z?.name && Z.name.toLowerCase().endsWith("keyframes") && ["from", "to"].includes(U.toLowerCase());
        }
        function p(z) {
        ...
        function c(z) {
          ...
          return Z?.name === "import" && U.groups[0].value === "url" && U.groups.length === 2;
        }
        function f(z) {
        ...
        function b(z, U) {
          return z.value === "$$" && z.type === "value-func" && U?.type === "value-word" && !U.raws.before;
        }
        function B(z) {
          var U, Z;
        ...
        function de(z) {
          return z?.type === "value-atword" && z.value.startsWith("prettier-placeholder-");
        }
        function ue(z, U) {
          var Z, se;
          ...
          if (U.type === "value-comma_group") {
            ...
            if (ge?.type === "value-word" && ge.value === "with") return true;
          }
          return false;
        }
        function Fe(z) {
...
//# sourceMappingURL=formatter-SWP5E3XI-43HCHI7E.js.map
