...
import {
  require_throttle
} from "./chunk-FIEYC6GU.js";
import "./chunk-4LNJMGYL.js";
...
var useColorInput = (initialValue, onChange) => {
  let [value, setValue] = (0, import_react2.useState)(initialValue || ""), [color, setColor] = (0, import_react2.useState)(() => parseValue(value)), [colorSpace, setColorSpace] = (0, import_react2.useState)(color?.colorSpace || "hex");
...
var usePresets = (presetColors, currentColor, colorSpace) => {
  let [selectedColors, setSelectedColors] = (0, import_react2.useState)(currentColor?.valid ? [currentColor] : []);
  (0, import_react2.useEffect)(() => {
...
//# sourceMappingURL=Color-6VNJS4EI-DIYZIN5B.js.map
