...
func (s *TestContext) Start() {
	...
	os.Setenv("START_REPOSITORY_PROVISIONER", "yes")
	os.Setenv("START_REPOSITORY_MATERIALIZER", "yes")
	os.Setenv("GIT_STORAGE_PROVIDER", "supergit")
	os.Setenv("GIT_STORAGE_SUPERGIT_BASE_URL", "http://supergit:8080/api")
