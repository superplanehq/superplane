...
# Set START_TASK_BROKER=yes and TASK_BROKER_AUTH_TOKEN to embed the runner task broker.
START_TASK_BROKER=no
TASK_BROKER_LISTEN_ADDR=:8081
# TASK_BROKER_AUTH_TOKEN=
# TASK_BROKER_BASE_URL=http://localhost:8081
