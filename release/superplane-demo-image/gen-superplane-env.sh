...
START_RUN_INITIALIZER="${START_RUN_INITIALIZER:-yes}"
START_NODE_EXECUTOR="${START_NODE_EXECUTOR:-yes}"
START_EXECUTION_TERMINATOR="${START_EXECUTION_TERMINATOR:-yes}"
...
START_NODE_REQUEST_CLEANUP_WORKER="${START_NODE_REQUEST_CLEANUP_WORKER:-yes}"
...
export START_RUN_INITIALIZER="${START_RUN_INITIALIZER}"
export START_NODE_EXECUTOR="${START_NODE_EXECUTOR}"
export START_EXECUTION_TERMINATOR="${START_EXECUTION_TERMINATOR}"
...
export START_NODE_REQUEST_CLEANUP_WORKER="${START_NODE_REQUEST_CLEANUP_WORKER}"
