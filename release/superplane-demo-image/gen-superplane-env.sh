...
WEBHOOKS_BASE_URL="${WEBHOOKS_BASE_URL:-${BASE_URL}}"
...
ENABLE_PASSWORD_LOGIN="${ENABLE_PASSWORD_LOGIN:-yes}"
...
START_EVENT_ROUTER="${START_EVENT_ROUTER:-yes}"
START_RUN_FINALIZER="${START_RUN_FINALIZER:-yes}"
START_NODE_EXECUTOR="${START_NODE_EXECUTOR:-yes}"
START_NODE_QUEUE_WORKER="${START_NODE_QUEUE_WORKER:-yes}"
START_NODE_REQUEST_WORKER="${START_NODE_REQUEST_WORKER:-yes}"
START_APP_MESSAGE_WORKER="${START_APP_MESSAGE_WORKER:-yes}"
START_INTEGRATION_REQUEST_WORKER="${START_INTEGRATION_REQUEST_WORKER:-yes}"
START_WEBHOOK_PROVISIONER="${START_WEBHOOK_PROVISIONER:-yes}"
START_WEBHOOK_CLEANUP_WORKER="${START_WEBHOOK_CLEANUP_WORKER:-yes}"
START_CANVAS_CLEANUP_WORKER="${START_CANVAS_CLEANUP_WORKER:-yes}"
START_REPOSITORY_PROVISIONER="${START_REPOSITORY_PROVISIONER:-yes}"
NO_ENCRYPTION="${NO_ENCRYPTION:-yes}"
SUPERPLANE_BEACON_ENABLED="${SUPERPLANE_BEACON_ENABLED:-yes}"
SUPERPLANE_INSTALLATION_TYPE="${SUPERPLANE_INSTALLATION_TYPE:-demo}"
GIT_STORAGE_PROVIDER="${GIT_STORAGE_PROVIDER:-supergit}"
GIT_STORAGE_SUPERGIT_BASE_URL="${GIT_STORAGE_SUPERGIT_BASE_URL:-http://127.0.0.1:8080/api}"
...
export ENABLE_PASSWORD_LOGIN="${ENABLE_PASSWORD_LOGIN}"
...
export START_EVENT_ROUTER="${START_EVENT_ROUTER}"
export START_RUN_FINALIZER="${START_RUN_FINALIZER}"
export START_NODE_EXECUTOR="${START_NODE_EXECUTOR}"
export START_NODE_QUEUE_WORKER="${START_NODE_QUEUE_WORKER}"
export START_NODE_REQUEST_WORKER="${START_NODE_REQUEST_WORKER}"
export START_APP_MESSAGE_WORKER="${START_APP_MESSAGE_WORKER}"
export START_INTEGRATION_REQUEST_WORKER="${START_INTEGRATION_REQUEST_WORKER}"
...
export START_CANVAS_CLEANUP_WORKER="${START_CANVAS_CLEANUP_WORKER}"
export START_REPOSITORY_PROVISIONER="${START_REPOSITORY_PROVISIONER}"
...
export SUPERPLANE_INSTALLATION_TYPE="${SUPERPLANE_INSTALLATION_TYPE}"
export GIT_STORAGE_PROVIDER="${GIT_STORAGE_PROVIDER}"
export GIT_STORAGE_SUPERGIT_BASE_URL="${GIT_STORAGE_SUPERGIT_BASE_URL}"
export SUPERGIT_ROOT="${SUPERGIT_ROOT}"
export SUPERGIT_PORT="${SUPERGIT_PORT}"
export SUPERGIT_DEFAULT_BRANCH="${SUPERGIT_DEFAULT_BRANCH}"
export SUPERGIT_MAX_FILE_BYTES="${SUPERGIT_MAX_FILE_BYTES}"
export SUPERGIT_MAX_COMMIT_BYTES="${SUPERGIT_MAX_COMMIT_BYTES}"
EOF
chmod 600 "${ENV_FILE}"
