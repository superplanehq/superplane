...
if [ -z "${SUPERPLANE_INSTALLATION_ID:-}" ]; then
  SUPERPLANE_INSTALLATION_ID=$(generate_secret)
fi
...
export SUPERPLANE_BEACON_URL="${SUPERPLANE_BEACON_URL}"
export SUPERPLANE_INSTALLATION_TYPE="${SUPERPLANE_INSTALLATION_TYPE}"
export SUPERPLANE_PLATFORM="${SUPERPLANE_PLATFORM}"
export SUPERPLANE_INSTALLATION_ID="${SUPERPLANE_INSTALLATION_ID}"
EOF
chmod 600 "${ENV_FILE}"
