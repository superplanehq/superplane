...
START_APP_INSTALLATION_REQUEST_WORKER="${START_APP_INSTALLATION_REQUEST_WORKER:-yes}"
...
export START_APP_INSTALLATION_REQUEST_WORKER="${START_APP_INSTALLATION_REQUEST_WORKER}"
