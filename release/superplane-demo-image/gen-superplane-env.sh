...
START_TASK_BROKER="${START_TASK_BROKER:-no}"
...
export START_TASK_BROKER="${START_TASK_BROKER}"
export TASK_BROKER_LISTEN_ADDR="${TASK_BROKER_LISTEN_ADDR}"
export TASK_BROKER_BASE_URL="${TASK_BROKER_BASE_URL}"
export TASK_BROKER_AUTH_TOKEN="${TASK_BROKER_AUTH_TOKEN}"
