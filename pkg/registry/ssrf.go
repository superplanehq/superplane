...
// The client has no overall timeout - callers should use request context for timeout control.
// Connection establishment has a fixed 30-second timeout via the dialer.
