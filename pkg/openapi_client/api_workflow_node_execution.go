...
type ApiWorkflowsReEmitNodeExecutionEventRequest struct {
	ctx         context.Context
	ApiService  *WorkflowNodeExecutionAPIService
	workflowId  string
	executionId string
...
func (r ApiWorkflowsReEmitNodeExecutionEventRequest) Body(body WorkflowsReEmitNodeExecutionEventBody) ApiWorkflowsReEmitNodeExecutionEventRequest {
	r.body = &body
	return r
}

func (r ApiWorkflowsReEmitNodeExecutionEventRequest) Execute() (*WorkflowsReEmitNodeExecutionEventResponse, *http.Response, error) {
	return r.ApiService.WorkflowsReEmitNodeExecutionEventExecute(r)
}

/*
WorkflowsReEmitNodeExecutionEvent Re-emit node execution event
...
Re-emit node execution event
	...
	@param workflowId
	@param executionId
	@return ApiWorkflowsReEmitNodeExecutionEventRequest
*/
func (a *WorkflowNodeExecutionAPIService) WorkflowsReEmitNodeExecutionEvent(ctx context.Context, workflowId string, executionId string) ApiWorkflowsReEmitNodeExecutionEventRequest {
	return ApiWorkflowsReEmitNodeExecutionEventRequest{
		ApiService:  a,
		ctx:         ctx,
		workflowId:  workflowId,
...
// Execute executes the request
//
//	@return WorkflowsReEmitNodeExecutionEventResponse
func (a *WorkflowNodeExecutionAPIService) WorkflowsReEmitNodeExecutionEventExecute(r ApiWorkflowsReEmitNodeExecutionEventRequest) (*WorkflowsReEmitNodeExecutionEventResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *WorkflowsReEmitNodeExecutionEventResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowNodeExecutionAPIService.WorkflowsReEmitNodeExecutionEvent")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/workflows/{workflowId}/executions/{executionId}/reemit"
	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", url.PathEscape(parameterValueToString(r.executionId, "executionId")), -1)
