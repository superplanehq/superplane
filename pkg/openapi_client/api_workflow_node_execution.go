...
func (r ApiWorkflowsResolveExecutionErrorsRequest) Body(body WorkflowsResolveExecutionErrorsBody) ApiWorkflowsResolveExecutionErrorsRequest {
	r.body = &body
	return r
}

func (r ApiWorkflowsResolveExecutionErrorsRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.WorkflowsResolveExecutionErrorsExecute(r)
}
...
Marks workflow node execution errors as resolved
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param workflowId
	@return ApiWorkflowsResolveExecutionErrorsRequest
*/
...
func (a *WorkflowNodeExecutionAPIService) WorkflowsResolveExecutionErrorsExecute(r ApiWorkflowsResolveExecutionErrorsRequest) (map[string]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowNodeExecutionAPIService.WorkflowsResolveExecutionErrors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/workflows/{workflowId}/executions/resolve"
	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
