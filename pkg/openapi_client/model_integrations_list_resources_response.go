...
type IntegrationsListResourcesResponse struct {
	Resources []IntegrationsResourceRef `json:"resources,omitempty"`
}
...
func (o *IntegrationsListResourcesResponse) GetResources() []IntegrationsResourceRef {
...
func (o *IntegrationsListResourcesResponse) GetResourcesOk() ([]IntegrationsResourceRef, bool) {
	if o == nil || IsNil(o.Resources) {
		return nil, false
	}
...
// SetResources gets a reference to the given []IntegrationsResourceRef and assigns it to the Resources field.
func (o *IntegrationsListResourcesResponse) SetResources(v []IntegrationsResourceRef) {
	o.Resources = v
}
