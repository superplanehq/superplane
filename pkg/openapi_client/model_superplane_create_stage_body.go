...
func (o *SuperplaneCreateStageBody) GetLabelDefinitions() []SuperplaneLabelDefinition {
...
// and a boolean to check if the value has been set.
func (o *SuperplaneCreateStageBody) GetLabelDefinitionsOk() ([]SuperplaneLabelDefinition, bool) {
	if o == nil || IsNil(o.LabelDefinitions) {
		return nil, false
	}
...
func (o *SuperplaneCreateStageBody) HasLabelDefinitions() bool {
	if o != nil && !IsNil(o.LabelDefinitions) {
		return true
	}
...
func (o *SuperplaneCreateStageBody) SetLabelDefinitions(v []SuperplaneLabelDefinition) {
