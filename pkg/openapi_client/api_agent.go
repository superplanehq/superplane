...
type ApiAgentsDeleteAgentChatRequest struct {
	ctx        context.Context
	ApiService *AgentAPIService
	chatId     string
	canvasId   *string
...
func (r ApiAgentsDeleteAgentChatRequest) CanvasId(canvasId string) ApiAgentsDeleteAgentChatRequest {
	r.canvasId = &canvasId
	return r
}

func (r ApiAgentsDeleteAgentChatRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.AgentsDeleteAgentChatExecute(r)
}

/*
AgentsDeleteAgentChat Delete an agent chat

Permanently deletes an agent chat and all its messages

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param chatId
	@return ApiAgentsDeleteAgentChatRequest
*/
func (a *AgentAPIService) AgentsDeleteAgentChat(ctx context.Context, chatId string) ApiAgentsDeleteAgentChatRequest {
	return ApiAgentsDeleteAgentChatRequest{
		ApiService: a,
		ctx:        ctx,
		chatId:     chatId,
...
func (a *AgentAPIService) AgentsDeleteAgentChatExecute(r ApiAgentsDeleteAgentChatRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AgentAPIService.AgentsDeleteAgentChat")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
