...
// checks if the RolesUpdateRoleBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RolesUpdateRoleBody{}
...
func NewNullableRolesUpdateRoleBody(val *RolesUpdateRoleBody) *NullableRolesUpdateRoleBody {
	return &NullableRolesUpdateRoleBody{value: val, isSet: true}
}
