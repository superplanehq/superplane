...
func (o *SuperplaneStageEvent) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *SuperplaneStageEvent) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *SuperplaneStageEvent) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *SuperplaneStageEvent) SetMessage(v string) {
	o.Message = &v
}
