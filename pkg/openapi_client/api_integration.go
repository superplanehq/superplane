...
type ApiIntegrationsListComponentsRequest struct {
	ctx context.Context
	ApiService *IntegrationAPIService
	type_ string
}

func (r ApiIntegrationsListComponentsRequest) Execute() (*SuperplaneIntegrationsListComponentsResponse, *http.Response, error) {
	return r.ApiService.IntegrationsListComponentsExecute(r)
}

/*
IntegrationsListComponents List integration components

List integration components

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param type_
 @return ApiIntegrationsListComponentsRequest
*/
func (a *IntegrationAPIService) IntegrationsListComponents(ctx context.Context, type_ string) ApiIntegrationsListComponentsRequest {
	return ApiIntegrationsListComponentsRequest{
		ApiService: a,
		ctx: ctx,
		type_: type_,
...
// Execute executes the request
//  @return SuperplaneIntegrationsListComponentsResponse
func (a *IntegrationAPIService) IntegrationsListComponentsExecute(r ApiIntegrationsListComponentsRequest) (*SuperplaneIntegrationsListComponentsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SuperplaneIntegrationsListComponentsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationAPIService.IntegrationsListComponents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/integrations/{type}/components"
...
func (r ApiIntegrationsUpdateIntegrationRequest) Execute() (*IntegrationsUpdateIntegrationResponse, *http.Response, error) {
	return r.ApiService.IntegrationsUpdateIntegrationExecute(r)
}

/*
IntegrationsUpdateIntegration Update an integration
