...
------------ | ------------- | ------------- | -------------
**InviteLink** | Pointer to [**OrganizationsInviteLink**](OrganizationsInviteLink.md) |  | [optional] 

## Methods

### NewOrganizationsUpdateInviteLinkResponse
...
### NewOrganizationsUpdateInviteLinkResponseWithDefaults
