...
------------ | ------------- | ------------- | -------------
**Component** | Pointer to [**ComponentsComponent**](ComponentsComponent.md) |  | [optional] 

## Methods

### NewComponentsDescribeComponentResponse
...
### NewComponentsDescribeComponentResponseWithDefaults
