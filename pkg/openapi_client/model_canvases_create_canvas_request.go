...
func (o *CanvasesCreateCanvasRequest) GetAutoLayout() CanvasesCanvasAutoLayout {
...
// and a boolean to check if the value has been set.
func (o *CanvasesCreateCanvasRequest) GetAutoLayoutOk() (*CanvasesCanvasAutoLayout, bool) {
	if o == nil || IsNil(o.AutoLayout) {
		return nil, false
	}
...
func (o *CanvasesCreateCanvasRequest) HasAutoLayout() bool {
	if o != nil && !IsNil(o.AutoLayout) {
		return true
	}
...
func (o *CanvasesCreateCanvasRequest) SetAutoLayout(v CanvasesCanvasAutoLayout) {
	o.AutoLayout = &v
}
