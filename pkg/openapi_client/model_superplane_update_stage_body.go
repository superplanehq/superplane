...
func (o *SuperplaneUpdateStageBody) GetLabelDefinitions() []SuperplaneLabelDefinition {
...
// and a boolean to check if the value has been set.
func (o *SuperplaneUpdateStageBody) GetLabelDefinitionsOk() ([]SuperplaneLabelDefinition, bool) {
	if o == nil || IsNil(o.LabelDefinitions) {
		return nil, false
	}
...
func (o *SuperplaneUpdateStageBody) HasLabelDefinitions() bool {
	if o != nil && !IsNil(o.LabelDefinitions) {
		return true
	}
...
func (o *SuperplaneUpdateStageBody) SetLabelDefinitions(v []SuperplaneLabelDefinition) {
