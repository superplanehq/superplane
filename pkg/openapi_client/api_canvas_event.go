...
type ApiCanvasesDescribeRunRequest struct {
	ctx        context.Context
...
func (r ApiCanvasesDescribeRunRequest) Execute() (*CanvasesDescribeRunResponse, *http.Response, error) {
	return r.ApiService.CanvasesDescribeRunExecute(r)
}

/*
CanvasesDescribeRun Describe run
...
Returns run details including the canvas version snapshot and all node executions
	...
	@param canvasId
	@param eventId
	@return ApiCanvasesDescribeRunRequest
*/
func (a *CanvasEventAPIService) CanvasesDescribeRun(ctx context.Context, canvasId string, eventId string) ApiCanvasesDescribeRunRequest {
	return ApiCanvasesDescribeRunRequest{
		ApiService: a,
		ctx:        ctx,
		canvasId:   canvasId,
...
//
//	@return CanvasesDescribeRunResponse
func (a *CanvasEventAPIService) CanvasesDescribeRunExecute(r ApiCanvasesDescribeRunRequest) (*CanvasesDescribeRunResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CanvasesDescribeRunResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CanvasEventAPIService.CanvasesDescribeRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/canvases/{canvasId}/runs/{eventId}"
