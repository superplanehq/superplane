...
func (o *SuperplaneInputDefinition) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *SuperplaneInputDefinition) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *SuperplaneInputDefinition) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *SuperplaneInputDefinition) SetType(v string) {
	o.Type = &v
}
