...
type ApiUsersRegenerateTokenRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
	userId string
}

func (r ApiUsersRegenerateTokenRequest) Execute() (*UsersRegenerateTokenResponse, *http.Response, error) {
	return r.ApiService.UsersRegenerateTokenExecute(r)
}

/*
UsersRegenerateToken Regenerate API token

Regenerates a user's API token

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param userId
 @return ApiUsersRegenerateTokenRequest
*/
func (a *UsersAPIService) UsersRegenerateToken(ctx context.Context, userId string) ApiUsersRegenerateTokenRequest {
	return ApiUsersRegenerateTokenRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return UsersRegenerateTokenResponse
func (a *UsersAPIService) UsersRegenerateTokenExecute(r ApiUsersRegenerateTokenRequest) (*UsersRegenerateTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UsersRegenerateTokenResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UsersRegenerateToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/users/{userId}/token"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
