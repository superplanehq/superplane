...
// checks if the CanvasesListNodeEventsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CanvasesListNodeEventsResponse{}
...
// NewCanvasesListNodeEventsResponse instantiates a new CanvasesListNodeEventsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCanvasesListNodeEventsResponse() *CanvasesListNodeEventsResponse {
	this := CanvasesListNodeEventsResponse{}
	return &this
}

// NewCanvasesListNodeEventsResponseWithDefaults instantiates a new CanvasesListNodeEventsResponse object
...
func (o *CanvasesListNodeEventsResponse) GetEvents() []CanvasesCanvasEvent {
...
func (o *CanvasesListNodeEventsResponse) GetEventsOk() ([]CanvasesCanvasEvent, bool) {
	if o == nil || IsNil(o.Events) {
		return nil, false
	}
...
func (o *CanvasesListNodeEventsResponse) SetEvents(v []CanvasesCanvasEvent) {
	o.Events = v
}
...
type NullableCanvasesListNodeEventsResponse struct {
	value *CanvasesListNodeEventsResponse
	isSet bool
}

func (v NullableCanvasesListNodeEventsResponse) Get() *CanvasesListNodeEventsResponse {
	return v.value
}

func (v *NullableCanvasesListNodeEventsResponse) Set(val *CanvasesListNodeEventsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCanvasesListNodeEventsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCanvasesListNodeEventsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCanvasesListNodeEventsResponse(val *CanvasesListNodeEventsResponse) *NullableCanvasesListNodeEventsResponse {
	return &NullableCanvasesListNodeEventsResponse{value: val, isSet: true}
}
