...
type ApiOrganizationsInvokeIntegrationActionRequest struct {
	ctx           context.Context
	ApiService    *OrganizationAPIService
	id            string
	integrationId string
...
func (r ApiOrganizationsInvokeIntegrationActionRequest) Body(body OrganizationsInvokeIntegrationActionBody) ApiOrganizationsInvokeIntegrationActionRequest {
	r.body = &body
	return r
}

func (r ApiOrganizationsInvokeIntegrationActionRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.OrganizationsInvokeIntegrationActionExecute(r)
}

/*
OrganizationsInvokeIntegrationAction Invoke integration action
...
Invokes a custom action on an organization integration
	...
	@param integrationId
	@param actionName
	@return ApiOrganizationsInvokeIntegrationActionRequest
*/
func (a *OrganizationAPIService) OrganizationsInvokeIntegrationAction(ctx context.Context, id string, integrationId string, actionName string) ApiOrganizationsInvokeIntegrationActionRequest {
	return ApiOrganizationsInvokeIntegrationActionRequest{
		ApiService:    a,
		ctx:           ctx,
		id:            id,
...
//
//	@return map[string]interface{}
func (a *OrganizationAPIService) OrganizationsInvokeIntegrationActionExecute(r ApiOrganizationsInvokeIntegrationActionRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAPIService.OrganizationsInvokeIntegrationAction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{id}/integrations/{integrationId}/actions/{actionName}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"integrationId"+"}", url.PathEscape(parameterValueToString(r.integrationId, "integrationId")), -1)
