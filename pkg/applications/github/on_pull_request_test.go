...
func Test__OnPullRequest__Setup(t *testing.T) {
	...
	t.Run("repository is required", func(t *testing.T) {
		...
		err := trigger.Setup(core.TriggerContext{
			...
			Configuration:          OnPullRequestConfiguration{Repository: ""},
		})
	...
	t.Run("repository is not accessible", func(t *testing.T) {
		...
		err := trigger.Setup(core.TriggerContext{
			AppInstallationContext: appCtx,
			MetadataContext:        &contexts.MetadataContext{},
			Configuration:          OnPullRequestConfiguration{Repository: "world"},
		})
	...
	t.Run("metadata is set and webhook is requested", func(t *testing.T) {
		...
		require.NoError(t, trigger.Setup(core.TriggerContext{
			...
			Configuration:          OnPullRequestConfiguration{Repository: "hello"},
		}))

		require.Equal(t, nodeMetadataCtx.Get(), OnPullRequestMetadata{Repository: &helloRepo})
