...
func Test__ListAlerts__Execute(t *testing.T) {
	...
	httpCtx := &contexts.HTTPContext{
		Responses: []*http.Response{
			sentryMockResponse(http.StatusOK, `[{"id":"7","name":"High error rate","projects":["backend"],"timeWindow":60.0,"owner":null,"triggers":[{"id":"1","label":"critical","actions":[{"id":"a1","type":"email","targetType":"user","targetIdentifier":"7","inputChannelId":null,"integrationId":null,"sentryAppID":null}]}]},{"id":"8","name":"Latency alert","projects":["frontend"],"timeWindow":30.0,"owner":null}]`),
		},
	}
