...
func Test__CreateIssueComment__Setup(t *testing.T) {
	...
	t.Run("issue number is required", func(t *testing.T) {
		...
		err := component.Setup(core.SetupContext{
			...
			Configuration: map[string]any{"repository": "hello", "issueNumber": "", "body": "hi"},
		})
	...
	t.Run("repository is not accessible", func(t *testing.T) {
		...
		err := component.Setup(core.SetupContext{
			Integration:   integrationCtx,
			Metadata:      &contexts.MetadataContext{},
			Configuration: map[string]any{"repository": "world", "issueNumber": "42", "body": "hi"},
		})
	...
	t.Run("metadata is set successfully", func(t *testing.T) {
		...
		require.NoError(t, component.Setup(core.SetupContext{
			...
			Configuration: map[string]any{"repository": "hello", "issueNumber": "42", "body": "hi"},
		}))
