...
func (c *CreateIssue) Configuration() []configuration.Field {
	return []configuration.Field{
		...
		},
		{
			...
			Required:    true,
			Description: "Issue title. Supports expressions.",
		...
		},
		{
			...
			Type:        configuration.FieldTypeString,
			Required:    false,
			Description: "Optional issue description. Supports expressions.",
		...
		},
		{
			...
			Type:        configuration.FieldTypeIntegrationResource,
			Required:    false,
			Description: "Optional team member to assign the issue to",
		...
		},
		{
			...
			Type:        configuration.FieldTypeIntegrationResource,
			Required:    false,
			Description: "Optional workflow state for the issue",
