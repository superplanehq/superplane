...
- **Icon URL** (optional): Icon shown on the attachment card.
...
func (c *CreateAttachment) Configuration() []configuration.Field {
	return []configuration.Field{
		...
		},
		{
			...
			Type:        configuration.FieldTypeString,
			Required:    false,
			Description: "Icon shown on the attachment card",
		},
	}
}
...
func (c *CreateAttachment) ProcessQueueItem(ctx core.ProcessQueueContext) (*uuid.UUID, error) {
