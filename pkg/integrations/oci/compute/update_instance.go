...
func (c *UpdateInstance) Documentation() string { return "Update an OCI Compute instance" }
func (c *UpdateInstance) ExampleOutput() map[string]any {
	return map[string]any{"id": "ocid1.instance.oc1...", "status": "updated"}
}
func (c *UpdateInstance) OutputChannels(any) []core.OutputChannel { return nil }
