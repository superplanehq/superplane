...
func (c *ManageInstancePower) Documentation() string { return "Manage the power state of an OCI Compute instance" }
func (c *ManageInstancePower) ExampleOutput() map[string]any {
	return map[string]any{"id": "ocid1.instance.oc1...", "action": "START", "status": "action_initiated"}
}
func (c *ManageInstancePower) OutputChannels(any) []core.OutputChannel { return nil }
