...
func (c *CreateInstance) Documentation() string { return "Provision a new OCI Compute instance" }
...
func (c *CreateInstance) Execute(ctx core.ExecutionContext) error {
	...
	return ctx.ExecutionState.Emit("success", "oci.instance", []any{map[string]interface{}{
		"id": *resp.Instance.Id,
		"status": "provisioning",
	}})
}
...
func (c *CreateInstance) OutputChannels(any) []core.OutputChannel { return nil }
