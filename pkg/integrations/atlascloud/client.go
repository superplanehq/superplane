...
// defaultBaseURL is Atlas Cloud's OpenAI-compatible API endpoint.
// Atlas Cloud exposes the same /responses and /models routes as OpenAI,
// so the integration reuses that request/response shape.
const defaultBaseURL = "https://api.atlascloud.ai/v1"
...
func (c *Client) CreateResponse(model, input string) (*Response, error) {
