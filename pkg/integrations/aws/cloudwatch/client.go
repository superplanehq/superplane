...
func (c *Client) DescribeLogGroups(namePrefix string) ([]LogGroup, error) {
...
func (c *Client) StartQuery(input StartQueryInput) (string, error) {
	payload := map[string]any{
...
func (c *Client) GetQueryResults(queryID string) (*QueryResults, error) {
...
func (c *Client) CreateLogStream(logGroupName, logStreamName string) error {
	payload := map[string]any{
...
func (c *Client) PutLogEvents(logGroupName, logStreamName string, events []LogEvent) error {
