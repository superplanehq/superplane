...
1. In the AWS IAM Console, go to **Identity Providers → Add provider** and choose **OpenID Connect** as the provider type. Set the **Provider URL** to `+"`%s`"+` and the **Audience** to `+"`%s`"+`.
