...
func Test__GetImageScanFindings__Setup(t *testing.T) {
	component := &GetImageScanFindings{}
...
func Test__GetImageScanFindings__Execute(t *testing.T) {
	component := &GetImageScanFindings{}
	...
	t.Run("valid request -> emits findings", func(t *testing.T) {
