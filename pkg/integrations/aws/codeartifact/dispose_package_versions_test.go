...
func TestDisposePackageVersions_Setup(t *testing.T) {
	component := &DisposePackageVersions{}
...
func TestDisposePackageVersions_Execute(t *testing.T) {
	component := &DisposePackageVersions{}
	...
	t.Run("success -> emits result", func(t *testing.T) {
		resp := map[string]any{
			"successfulVersions": map[string]any{"1.0.0": map[string]any{"revision": "rev1", "status": "Disposed"}},
