...
func (c *CreateBucket) Documentation() string {
	return `The Create Bucket component creates an AWS S3 bucket in the specified region.

## Use Cases

- **Environment provisioning**: Create buckets as part of environment setup workflows
- **Data pipeline bootstrap**: Provision storage buckets before running data processing jobs
- **Self-service operations**: Allow teams to create storage resources on demand`
}
