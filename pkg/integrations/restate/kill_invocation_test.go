...
func Test__KillInvocation__Setup(t *testing.T) {
...
func Test__KillInvocation__Execute(t *testing.T) {
	component := &KillInvocation{}
	...
	t.Run("successful kill", func(t *testing.T) {
		...
		assert.Equal(t, "restate.invocation.killed", executionState.Type)

		require.Len(t, httpContext.Requests, 1)
		req := httpContext.Requests[0]
		assert.Equal(t, http.MethodPatch, req.Method)
		assert.Contains(t, req.URL.String(), "/invocations/inv_abc123/kill")
	})
}
