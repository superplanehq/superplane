...
func Test__PurgeInvocation__Setup(t *testing.T) {
...
func Test__PurgeInvocation__Execute(t *testing.T) {
	component := &PurgeInvocation{}
	...
	t.Run("successful purge", func(t *testing.T) {
		...
		assert.Equal(t, "restate.invocation.purged", executionState.Type)

		require.Len(t, httpContext.Requests, 1)
		req := httpContext.Requests[0]
		assert.Equal(t, http.MethodPatch, req.Method)
		assert.Contains(t, req.URL.String(), "/invocations/inv_abc123/purge")
	})
}
