...
func (c *GetRecentWorkflowRuns) HandleWebhook(ctx core.WebhookRequestContext) (int, *core.WebhookResponseBody, error) {
...
func (c *GetRecentWorkflowRuns) Hooks() []core.Hook {
	return []core.Hook{}
}

func (c *GetRecentWorkflowRuns) HandleHook(ctx core.ActionHookContext) error {
	return nil
}
