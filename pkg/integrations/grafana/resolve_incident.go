...
func (r *ResolveIncident) ExampleOutput() map[string]any {
	return exampleIncidentOutput("grafana.incident.resolved")
}
...
func (r *ResolveIncident) Actions() []core.Action {
	return []core.Action{}
}

func (r *ResolveIncident) HandleAction(ctx core.ActionContext) error {
	return nil
}
