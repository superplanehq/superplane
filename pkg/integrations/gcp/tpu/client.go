...
const tpuBaseURL = "https://tpu.googleapis.com/v2"

// Client is the interface used by Cloud TPU components to call the API.
...
func getClient(httpCtx core.HTTPContext, integration core.IntegrationContext) (Client, error) {
	...
	if fn == nil {
		panic("gcp tpu: SetClientFactory was not called by the gcp integration")
	}
