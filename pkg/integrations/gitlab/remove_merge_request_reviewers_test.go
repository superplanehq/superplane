...
func Test__RemoveMergeRequestReviewers__Setup(t *testing.T) {
	c := &RemoveMergeRequestReviewers{}
...
func Test__RemoveMergeRequestReviewers__Execute(t *testing.T) {
	c := &RemoveMergeRequestReviewers{}
	...
	t.Run("removes reviewer and keeps the rest", func(t *testing.T) {
