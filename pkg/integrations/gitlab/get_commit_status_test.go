...
func Test__GetCommitStatus__Execute(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		assert.Equal(t, "https://gitlab.com/api/v4/projects/123/repository/commits/abc123/statuses", httpCtx.Requests[0].URL.String())
	})
	...
	t.Run("applies ref and name filters", func(t *testing.T) {
		...
		require.Len(t, httpCtx.Requests, 1)
		assert.Equal(t, "https://gitlab.com/api/v4/projects/123/repository/commits/abc123/statuses?name=ci%2Fsuperplane&ref=main", httpCtx.Requests[0].URL.String())
	})
