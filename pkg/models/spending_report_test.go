...
func TestSpendingModelDisplayName(t *testing.T) {
	...
	assert.Equal(t, "claude-sonnet-4-6", models.SpendingModelDisplayName("sonnet", nil))
	assert.Equal(t, "claude-sonnet-4-6", models.SpendingModelDisplayName("sonnet", []string{"sonnet"}))
