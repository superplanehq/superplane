...
func Test__DescribeIntegration(t *testing.T) {
	...
	t.Run("using id", func(t *testing.T) {
		response, err := DescribeIntegration(context.Background(), models.DomainTypeOrganization, r.Organization.ID.String(), r.Integration.ID.String())
	...
	t.Run("using name", func(t *testing.T) {
		response, err := DescribeIntegration(context.Background(), models.DomainTypeOrganization, r.Organization.ID.String(), r.Integration.Name)
		require.NoError(t, err)
		require.NotNil(t, response)
		require.NotNil(t, response.Integration)
		assert.Equal(t, r.Integration.ID.String(), response.Integration.Metadata.Id)
