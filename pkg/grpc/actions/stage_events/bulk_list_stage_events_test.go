...
func Test__BulkListStageEvents(t *testing.T) {
	...
	t.Run("canvas with no stage events -> empty results", func(t *testing.T) {
		...
		res, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 10, nil, nil, nil, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
	...
	t.Run("limit per stage is respected", func(t *testing.T) {
		...
		res, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 2, nil, nil, nil, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
		require.NoError(t, err)
		require.NotNil(t, res)
		require.Len(t, res.Results, 1)
	...
	t.Run("stage not found", func(t *testing.T) {
		...
		_, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 10, nil, nil, nil, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
		require.Error(t, err)
	...
	t.Run("filter by before timestamp", func(t *testing.T) {
		...
		res, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 10, beforeTimestamp, nil, nil, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
		require.NoError(t, err)
		require.NotNil(t, res)
		require.Len(t, res.Results, 1)
	...
	t.Run("filter by states", func(t *testing.T) {
		...
		res, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 10, nil, states, nil, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
		require.NoError(t, err)
		require.NotNil(t, res)
		require.Len(t, res.Results, 1)
	...
	t.Run("filter by state reasons", func(t *testing.T) {
		...
		res, err := BulkListStageEvents(ctx, r.Canvas.ID.String(), stages, 10, nil, nil, stateReasons, nil, nil, protos.ExecutionFilter_EXECUTION_FILTER_UNKNOWN)
		require.NoError(t, err)
		require.NotNil(t, res)
		require.Len(t, res.Results, 1)
