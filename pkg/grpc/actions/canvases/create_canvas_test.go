...
func TestCreateCanvasDuplicateName(t *testing.T) {
	...
	_, err := CreateCanvas(ctx, r.Registry, r.Encryptor, r.AuthService, baseURL, r.Organization.ID, workflow, nil, nil, nil)
...
func TestCreateCanvasRejectsWhitespaceOnlyName(t *testing.T) {
	...
	baseURL := "https://example.com"
	_, err := CreateCanvas(ctx, r.Registry, r.Encryptor, r.AuthService, baseURL, r.Organization.ID, canvas, nil, nil, nil)
	require.Error(t, err)
...
func TestCreateCanvasInheritsOrganizationChangeManagementWhenEnabled(t *testing.T) {
	...
	baseURL := "https://example.com"
	response, err := CreateCanvas(ctx, r.Registry, r.Encryptor, r.AuthService, baseURL, r.Organization.ID, workflow, nil, nil, nil)
	require.NoError(t, err)
...
func TestCreateCanvasResponseShowsCanvasLevelChangeManagementWhenEnabled(t *testing.T) {
	...
	baseURL := "https://example.com"
	response, err := CreateCanvas(ctx, r.Registry, r.Encryptor, r.AuthService, baseURL, r.Organization.ID, canvas, nil, nil, nil)
	require.NoError(t, err)
	require.NotNil(t, response)
	require.NotNil(t, response.Canvas)
	require.NotNil(t, response.Canvas.Spec)
...
func TestCreateCanvasWithUsageRejectsLimitViolation(t *testing.T) {
	...
	baseURL := "https://example.com"
	_, err := CreateCanvas(ctx, r.Registry, r.Encryptor, r.AuthService, baseURL, r.Organization.ID, workflow, nil, service, nil)
	require.Error(t, err)
