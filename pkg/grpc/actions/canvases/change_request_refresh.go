...
func refreshCanvasChangeRequestDiffInTransaction(
	...
	baseNodes, baseEdges, liveNodes, liveEdges, err := resolveCanvasVersionBaseAndLiveInTransaction(tx, canvas, version)
	if err != nil {
		return err
	}
	...
	request.BasedOnVersionID = version.BasedOnVersionID
