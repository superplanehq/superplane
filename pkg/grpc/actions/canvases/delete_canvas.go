...
func DeleteCanvas(ctx context.Context, registry *registry.Registry, organizationID uuid.UUID, id string, storage git.Provider) (*pb.DeleteCanvasResponse, error) {
