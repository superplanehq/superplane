...
func ListRoles(ctx context.Context, domainType string, domainID string, req *pb.ListRolesRequest, authService authorization.Authorization) (*pb.ListRolesResponse, error) {
