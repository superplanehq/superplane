...
func TestUpdateGroup(t *testing.T) {
	...
	t.Run("canvas group update", func(t *testing.T) {
		...
		err = r.AuthService.CreateGroup(canvasID, models.DomainTypeCanvas, "canvas-group", models.RoleCanvasViewer, "Canvas Group", "Canvas Description")
		require.NoError(t, err)
		...
		resp, err := UpdateGroup(ctx, models.DomainTypeCanvas, canvasID, "canvas-group", groupSpec, r.AuthService)
		require.NoError(t, err)
		assert.NotNil(t, resp)
