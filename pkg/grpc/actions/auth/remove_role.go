...
func RemoveRole(ctx context.Context, orgID string, domainType string, domainID string, roleName, userID, userEmail string, authService authorization.Authorization) (*pb.RemoveRoleResponse, error) {
	if roleName == "" {
