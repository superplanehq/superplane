...
func Test__UpdateOrganization(t *testing.T) {
	...
	t.Run("update organization by ID -> success", func(t *testing.T) {
		organization, err := models.CreateOrganization("test-org", "Test Organization", "Original description")
	...
	t.Run("update organization by name -> success", func(t *testing.T) {
		organization, err := models.CreateOrganization("test-org-2", "Test Organization 2", "Original description 2")
		require.NoError(t, err)
