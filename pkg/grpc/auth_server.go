...
func (s *AuthorizationServer) GetCanvasUsers(ctx context.Context, req *pb.GetCanvasUsersRequest) (*pb.GetCanvasUsersResponse, error) {
	return auth.GetCanvasUsers(ctx, req, s.authService)
}
