...
var file_organizations_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_organizations_proto_goTypes = []any{
	...
	(*ListApplicationsRequest)(nil),          // 23: Superplane.Organizations.ListApplicationsRequest
	(*ListApplicationsResponse)(nil),         // 24: Superplane.Organizations.ListApplicationsResponse
	(*InstallApplicationRequest)(nil),        // 25: Superplane.Organizations.InstallApplicationRequest
	(*InstallApplicationResponse)(nil),       // 26: Superplane.Organizations.InstallApplicationResponse
	(*DescribeApplicationRequest)(nil),       // 27: Superplane.Organizations.DescribeApplicationRequest
	(*DescribeApplicationResponse)(nil),      // 28: Superplane.Organizations.DescribeApplicationResponse
	(*ListApplicationResourcesRequest)(nil),  // 29: Superplane.Organizations.ListApplicationResourcesRequest
	(*ListApplicationResourcesResponse)(nil), // 30: Superplane.Organizations.ListApplicationResourcesResponse
	(*AppInstallationResourceRef)(nil),       // 31: Superplane.Organizations.AppInstallationResourceRef
	(*UpdateApplicationRequest)(nil),         // 32: Superplane.Organizations.UpdateApplicationRequest
	(*UpdateApplicationResponse)(nil),        // 33: Superplane.Organizations.UpdateApplicationResponse
	(*UninstallApplicationRequest)(nil),      // 34: Superplane.Organizations.UninstallApplicationRequest
	(*UninstallApplicationResponse)(nil),     // 35: Superplane.Organizations.UninstallApplicationResponse
	(*AppInstallation)(nil),                  // 36: Superplane.Organizations.AppInstallation
	...
	(*AppInstallation_Metadata)(nil),         // 43: Superplane.Organizations.AppInstallation.Metadata
	(*AppInstallation_Spec)(nil),             // 44: Superplane.Organizations.AppInstallation.Spec
	(*AppInstallation_Status)(nil),           // 45: Superplane.Organizations.AppInstallation.Status
	(*AppInstallation_NodeRef)(nil),          // 46: Superplane.Organizations.AppInstallation.NodeRef
	nil,                                      // 47: Superplane.Organizations.BrowserAction.FormFieldsEntry
...
var file_organizations_proto_depIdxs = []int32{
	...
	48, // 4: Superplane.Organizations.Invitation.created_at:type_name -> google.protobuf.Timestamp
	48, // 5: Superplane.Organizations.InviteLink.created_at:type_name -> google.protobuf.Timestamp
	48, // 6: Superplane.Organizations.InviteLink.updated_at:type_name -> google.protobuf.Timestamp
	...
	36, // 12: Superplane.Organizations.ListApplicationsResponse.applications:type_name -> Superplane.Organizations.AppInstallation
	49, // 13: Superplane.Organizations.InstallApplicationRequest.configuration:type_name -> google.protobuf.Struct
	36, // 14: Superplane.Organizations.InstallApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	36, // 15: Superplane.Organizations.DescribeApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	31, // 16: Superplane.Organizations.ListApplicationResourcesResponse.resources:type_name -> Superplane.Organizations.AppInstallationResourceRef
	49, // 17: Superplane.Organizations.UpdateApplicationRequest.configuration:type_name -> google.protobuf.Struct
	36, // 18: Superplane.Organizations.UpdateApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	43, // 19: Superplane.Organizations.AppInstallation.metadata:type_name -> Superplane.Organizations.AppInstallation.Metadata
	44, // 20: Superplane.Organizations.AppInstallation.spec:type_name -> Superplane.Organizations.AppInstallation.Spec
	45, // 21: Superplane.Organizations.AppInstallation.status:type_name -> Superplane.Organizations.AppInstallation.Status
	47, // 22: Superplane.Organizations.BrowserAction.form_fields:type_name -> Superplane.Organizations.BrowserAction.FormFieldsEntry
	48, // 23: Superplane.Organizations.OrganizationCreated.timestamp:type_name -> google.protobuf.Timestamp
	48, // 24: Superplane.Organizations.OrganizationUpdated.timestamp:type_name -> google.protobuf.Timestamp
	48, // 25: Superplane.Organizations.OrganizationDeleted.timestamp:type_name -> google.protobuf.Timestamp
	48, // 26: Superplane.Organizations.InvitationCreated.timestamp:type_name -> google.protobuf.Timestamp
	48, // 27: Superplane.Organizations.Organization.Metadata.created_at:type_name -> google.protobuf.Timestamp
	48, // 28: Superplane.Organizations.Organization.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	48, // 29: Superplane.Organizations.AppInstallation.Metadata.created_at:type_name -> google.protobuf.Timestamp
	48, // 30: Superplane.Organizations.AppInstallation.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	49, // 31: Superplane.Organizations.AppInstallation.Spec.configuration:type_name -> google.protobuf.Struct
	49, // 32: Superplane.Organizations.AppInstallation.Status.metadata:type_name -> google.protobuf.Struct
	37, // 33: Superplane.Organizations.AppInstallation.Status.browser_action:type_name -> Superplane.Organizations.BrowserAction
	46, // 34: Superplane.Organizations.AppInstallation.Status.used_in:type_name -> Superplane.Organizations.AppInstallation.NodeRef
	1,  // 35: Superplane.Organizations.Organizations.DescribeOrganization:input_type -> Superplane.Organizations.DescribeOrganizationRequest
	3,  // 36: Superplane.Organizations.Organizations.UpdateOrganization:input_type -> Superplane.Organizations.UpdateOrganizationRequest
	5,  // 37: Superplane.Organizations.Organizations.DeleteOrganization:input_type -> Superplane.Organizations.DeleteOrganizationRequest
	21, // 38: Superplane.Organizations.Organizations.RemoveUser:input_type -> Superplane.Organizations.RemoveUserRequest
	9,  // 39: Superplane.Organizations.Organizations.CreateInvitation:input_type -> Superplane.Organizations.CreateInvitationRequest
	11, // 40: Superplane.Organizations.Organizations.ListInvitations:input_type -> Superplane.Organizations.ListInvitationsRequest
	13, // 41: Superplane.Organizations.Organizations.RemoveInvitation:input_type -> Superplane.Organizations.RemoveInvitationRequest
