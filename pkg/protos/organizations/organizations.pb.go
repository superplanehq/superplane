...
type ListApplicationResourcesRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Id             string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	InstallationId string                 `protobuf:"bytes,2,opt,name=installation_id,json=installationId,proto3" json:"installation_id,omitempty"`
...
func (x *ListApplicationResourcesRequest) Reset() {
	*x = ListApplicationResourcesRequest{}
	mi := &file_organizations_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListApplicationResourcesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListApplicationResourcesRequest) ProtoMessage() {}

func (x *ListApplicationResourcesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_organizations_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListApplicationResourcesRequest.ProtoReflect.Descriptor instead.
func (*ListApplicationResourcesRequest) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{22}
}

func (x *ListApplicationResourcesRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListApplicationResourcesRequest) GetInstallationId() string {
	if x != nil {
		return x.InstallationId
	}
	return ""
...
func (x *ListApplicationResourcesRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type ListApplicationResourcesResponse struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Resources     []*AppInstallationResourceRef `protobuf:"bytes,1,rep,name=resources,proto3" json:"resources,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListApplicationResourcesResponse) Reset() {
	*x = ListApplicationResourcesResponse{}
	mi := &file_organizations_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListApplicationResourcesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListApplicationResourcesResponse) ProtoMessage() {}

func (x *ListApplicationResourcesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_organizations_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListApplicationResourcesResponse.ProtoReflect.Descriptor instead.
func (*ListApplicationResourcesResponse) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{23}
}

func (x *ListApplicationResourcesResponse) GetResources() []*AppInstallationResourceRef {
	if x != nil {
		return x.Resources
	}
	return nil
...
type AppInstallationResourceRef struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AppInstallationResourceRef) Reset() {
	*x = AppInstallationResourceRef{}
	mi := &file_organizations_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AppInstallationResourceRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppInstallationResourceRef) ProtoMessage() {}

func (x *AppInstallationResourceRef) ProtoReflect() protoreflect.Message {
	mi := &file_organizations_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppInstallationResourceRef.ProtoReflect.Descriptor instead.
func (*AppInstallationResourceRef) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{24}
}

func (x *AppInstallationResourceRef) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *AppInstallationResourceRef) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AppInstallationResourceRef) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (*AppInstallation_Metadata) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{29, 0}
}
...
func (*AppInstallation_Spec) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{29, 1}
}
...
func (*AppInstallation_Status) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{29, 2}
}
...
func (*AppInstallation_NodeRef) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{29, 3}
}
...
const file_organizations_proto_rawDesc = "" +
	...
	"\finstallation\x18\x01 \x01(\v2).Superplane.Organizations.AppInstallationR\finstallation\"n\n" +
	"\x1fListApplicationResourcesRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12'\n" +
	"\x0finstallation_id\x18\x02 \x01(\tR\x0einstallationId\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\"v\n" +
	" ListApplicationResourcesResponse\x12R\n" +
	"\tresources\x18\x01 \x03(\v24.Superplane.Organizations.AppInstallationResourceRefR\tresources\"T\n" +
	"\x1aAppInstallationResourceRef\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02id\"\x92\x01\n" +
	...
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xbf\x1d\n" +
	...
	"\fOrganization\x12*Describe an application in an organization\x1a<Returns details of a specific application in an organization\x82\xd3\xe4\x93\x02;\x129/api/v1/organizations/{id}/applications/{installation_id}\x12\xbd\x02\n" +
	"\x18ListApplicationResources\x129.Superplane.Organizations.ListApplicationResourcesRequest\x1a:.Superplane.Organizations.ListApplicationResourcesResponse\"\xa9\x01\x92A[\n" +
	"\fOrganization\x12\x1aList application resources\x1a/Lists resources for an application installation\x82\xd3\xe4\x93\x02E\x12C/api/v1/organizations/{id}/applications/{installation_id}/resources\x12\x95\x02\n" +
	...
	"\fOrganization\x12\x15Uninstall application\x1a.Uninstalls an application from an organization\x82\xd3\xe4\x93\x02;*9/api/v1/organizations/{id}/applications/{installation_id}B\xf0\x01\x92A\xaf\x01\x12\x84\x01\n" +
...
var file_organizations_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_organizations_proto_goTypes = []any{
	...
	(*ListApplicationResourcesRequest)(nil),  // 22: Superplane.Organizations.ListApplicationResourcesRequest
	(*ListApplicationResourcesResponse)(nil), // 23: Superplane.Organizations.ListApplicationResourcesResponse
	(*AppInstallationResourceRef)(nil),       // 24: Superplane.Organizations.AppInstallationResourceRef
	(*UpdateApplicationRequest)(nil),         // 25: Superplane.Organizations.UpdateApplicationRequest
	(*UpdateApplicationResponse)(nil),        // 26: Superplane.Organizations.UpdateApplicationResponse
	(*UninstallApplicationRequest)(nil),      // 27: Superplane.Organizations.UninstallApplicationRequest
	(*UninstallApplicationResponse)(nil),     // 28: Superplane.Organizations.UninstallApplicationResponse
	(*AppInstallation)(nil),                  // 29: Superplane.Organizations.AppInstallation
	(*BrowserAction)(nil),                    // 30: Superplane.Organizations.BrowserAction
	(*OrganizationCreated)(nil),              // 31: Superplane.Organizations.OrganizationCreated
	(*OrganizationUpdated)(nil),              // 32: Superplane.Organizations.OrganizationUpdated
	(*OrganizationDeleted)(nil),              // 33: Superplane.Organizations.OrganizationDeleted
	(*InvitationCreated)(nil),                // 34: Superplane.Organizations.InvitationCreated
	(*Organization_Metadata)(nil),            // 35: Superplane.Organizations.Organization.Metadata
	(*AppInstallation_Metadata)(nil),         // 36: Superplane.Organizations.AppInstallation.Metadata
	(*AppInstallation_Spec)(nil),             // 37: Superplane.Organizations.AppInstallation.Spec
	(*AppInstallation_Status)(nil),           // 38: Superplane.Organizations.AppInstallation.Status
	(*AppInstallation_NodeRef)(nil),          // 39: Superplane.Organizations.AppInstallation.NodeRef
	nil,                                      // 40: Superplane.Organizations.BrowserAction.FormFieldsEntry
...
var file_organizations_proto_depIdxs = []int32{
	35, // 0: Superplane.Organizations.Organization.metadata:type_name -> Superplane.Organizations.Organization.Metadata
	...
	41, // 4: Superplane.Organizations.Invitation.created_at:type_name -> google.protobuf.Timestamp
	...
	29, // 7: Superplane.Organizations.ListApplicationsResponse.applications:type_name -> Superplane.Organizations.AppInstallation
	42, // 8: Superplane.Organizations.InstallApplicationRequest.configuration:type_name -> google.protobuf.Struct
	29, // 9: Superplane.Organizations.InstallApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	29, // 10: Superplane.Organizations.DescribeApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	24, // 11: Superplane.Organizations.ListApplicationResourcesResponse.resources:type_name -> Superplane.Organizations.AppInstallationResourceRef
	42, // 12: Superplane.Organizations.UpdateApplicationRequest.configuration:type_name -> google.protobuf.Struct
	29, // 13: Superplane.Organizations.UpdateApplicationResponse.installation:type_name -> Superplane.Organizations.AppInstallation
	36, // 14: Superplane.Organizations.AppInstallation.metadata:type_name -> Superplane.Organizations.AppInstallation.Metadata
	37, // 15: Superplane.Organizations.AppInstallation.spec:type_name -> Superplane.Organizations.AppInstallation.Spec
	38, // 16: Superplane.Organizations.AppInstallation.status:type_name -> Superplane.Organizations.AppInstallation.Status
	40, // 17: Superplane.Organizations.BrowserAction.form_fields:type_name -> Superplane.Organizations.BrowserAction.FormFieldsEntry
	41, // 18: Superplane.Organizations.OrganizationCreated.timestamp:type_name -> google.protobuf.Timestamp
	41, // 19: Superplane.Organizations.OrganizationUpdated.timestamp:type_name -> google.protobuf.Timestamp
	41, // 20: Superplane.Organizations.OrganizationDeleted.timestamp:type_name -> google.protobuf.Timestamp
	41, // 21: Superplane.Organizations.InvitationCreated.timestamp:type_name -> google.protobuf.Timestamp
	41, // 22: Superplane.Organizations.Organization.Metadata.created_at:type_name -> google.protobuf.Timestamp
	41, // 23: Superplane.Organizations.Organization.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	41, // 24: Superplane.Organizations.AppInstallation.Metadata.created_at:type_name -> google.protobuf.Timestamp
	41, // 25: Superplane.Organizations.AppInstallation.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	42, // 26: Superplane.Organizations.AppInstallation.Spec.configuration:type_name -> google.protobuf.Struct
	42, // 27: Superplane.Organizations.AppInstallation.Status.metadata:type_name -> google.protobuf.Struct
	30, // 28: Superplane.Organizations.AppInstallation.Status.browser_action:type_name -> Superplane.Organizations.BrowserAction
	39, // 29: Superplane.Organizations.AppInstallation.Status.used_in:type_name -> Superplane.Organizations.AppInstallation.NodeRef
	1,  // 30: Superplane.Organizations.Organizations.DescribeOrganization:input_type -> Superplane.Organizations.DescribeOrganizationRequest
	3,  // 31: Superplane.Organizations.Organizations.UpdateOrganization:input_type -> Superplane.Organizations.UpdateOrganizationRequest
	5,  // 32: Superplane.Organizations.Organizations.DeleteOrganization:input_type -> Superplane.Organizations.DeleteOrganizationRequest
	14, // 33: Superplane.Organizations.Organizations.RemoveUser:input_type -> Superplane.Organizations.RemoveUserRequest
	8,  // 34: Superplane.Organizations.Organizations.CreateInvitation:input_type -> Superplane.Organizations.CreateInvitationRequest
	10, // 35: Superplane.Organizations.Organizations.ListInvitations:input_type -> Superplane.Organizations.ListInvitationsRequest
	12, // 36: Superplane.Organizations.Organizations.RemoveInvitation:input_type -> Superplane.Organizations.RemoveInvitationRequest
	16, // 37: Superplane.Organizations.Organizations.ListApplications:input_type -> Superplane.Organizations.ListApplicationsRequest
	20, // 38: Superplane.Organizations.Organizations.DescribeApplication:input_type -> Superplane.Organizations.DescribeApplicationRequest
	22, // 39: Superplane.Organizations.Organizations.ListApplicationResources:input_type -> Superplane.Organizations.ListApplicationResourcesRequest
	...
	25, // 41: Superplane.Organizations.Organizations.UpdateApplication:input_type -> Superplane.Organizations.UpdateApplicationRequest
	27, // 42: Superplane.Organizations.Organizations.UninstallApplication:input_type -> Superplane.Organizations.UninstallApplicationRequest
	2,  // 43: Superplane.Organizations.Organizations.DescribeOrganization:output_type -> Superplane.Organizations.DescribeOrganizationResponse
	4,  // 44: Superplane.Organizations.Organizations.UpdateOrganization:output_type -> Superplane.Organizations.UpdateOrganizationResponse
	6,  // 45: Superplane.Organizations.Organizations.DeleteOrganization:output_type -> Superplane.Organizations.DeleteOrganizationResponse
	15, // 46: Superplane.Organizations.Organizations.RemoveUser:output_type -> Superplane.Organizations.RemoveUserResponse
	9,  // 47: Superplane.Organizations.Organizations.CreateInvitation:output_type -> Superplane.Organizations.CreateInvitationResponse
	11, // 48: Superplane.Organizations.Organizations.ListInvitations:output_type -> Superplane.Organizations.ListInvitationsResponse
	13, // 49: Superplane.Organizations.Organizations.RemoveInvitation:output_type -> Superplane.Organizations.RemoveInvitationResponse
	17, // 50: Superplane.Organizations.Organizations.ListApplications:output_type -> Superplane.Organizations.ListApplicationsResponse
	21, // 51: Superplane.Organizations.Organizations.DescribeApplication:output_type -> Superplane.Organizations.DescribeApplicationResponse
	23, // 52: Superplane.Organizations.Organizations.ListApplicationResources:output_type -> Superplane.Organizations.ListApplicationResourcesResponse
	19, // 53: Superplane.Organizations.Organizations.InstallApplication:output_type -> Superplane.Organizations.InstallApplicationResponse
	26, // 54: Superplane.Organizations.Organizations.UpdateApplication:output_type -> Superplane.Organizations.UpdateApplicationResponse
	28, // 55: Superplane.Organizations.Organizations.UninstallApplication:output_type -> Superplane.Organizations.UninstallApplicationResponse
