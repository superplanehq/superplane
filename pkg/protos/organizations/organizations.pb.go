...
type GetUsageResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Usage         *UsageInfo             `protobuf:"bytes,1,opt,name=usage,proto3" json:"usage,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetUsageResponse) GetUsage() *UsageInfo {
	if x != nil {
		return x.Usage
	}
	return nil
...
type UsageInfo struct {
	...
	EffectiveLimits *UsageLimits           `protobuf:"bytes,2,opt,name=effective_limits,json=effectiveLimits,proto3" json:"effective_limits,omitempty"`
	CurrentUsage    *UsageCounters         `protobuf:"bytes,3,opt,name=current_usage,json=currentUsage,proto3" json:"current_usage,omitempty"`
	HasOverrides    bool                   `protobuf:"varint,4,opt,name=has_overrides,json=hasOverrides,proto3" json:"has_overrides,omitempty"`
...
func (x *UsageInfo) GetProfileName() string {
	if x != nil {
...
func (x *UsageInfo) GetEffectiveLimits() *UsageLimits {
	if x != nil {
...
func (x *UsageInfo) GetCurrentUsage() *UsageCounters {
	if x != nil {
...
func (x *UsageInfo) GetHasOverrides() bool {
	if x != nil {
...
func (x *UsageInfo) GetIsUnlimited() bool {
	if x != nil {
...
type UsageLimits struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	MaxOrgsPerAccount     int32                  `protobuf:"varint,1,opt,name=max_orgs_per_account,json=maxOrgsPerAccount,proto3" json:"max_orgs_per_account,omitempty"`
	MaxCanvasesPerOrg     int32                  `protobuf:"varint,2,opt,name=max_canvases_per_org,json=maxCanvasesPerOrg,proto3" json:"max_canvases_per_org,omitempty"`
	MaxNodesPerCanvas     int32                  `protobuf:"varint,3,opt,name=max_nodes_per_canvas,json=maxNodesPerCanvas,proto3" json:"max_nodes_per_canvas,omitempty"`
	MaxUsersPerOrg        int32                  `protobuf:"varint,4,opt,name=max_users_per_org,json=maxUsersPerOrg,proto3" json:"max_users_per_org,omitempty"`
	MaxIntegrationsPerOrg int32                  `protobuf:"varint,5,opt,name=max_integrations_per_org,json=maxIntegrationsPerOrg,proto3" json:"max_integrations_per_org,omitempty"`
	MaxEventsPerMonth     int32                  `protobuf:"varint,6,opt,name=max_events_per_month,json=maxEventsPerMonth,proto3" json:"max_events_per_month,omitempty"`
...
func (x *UsageLimits) GetMaxOrgsPerAccount() int32 {
	if x != nil {
		return x.MaxOrgsPerAccount
	}
	return 0
}

func (x *UsageLimits) GetMaxCanvasesPerOrg() int32 {
	if x != nil {
		return x.MaxCanvasesPerOrg
	}
	return 0
}

func (x *UsageLimits) GetMaxNodesPerCanvas() int32 {
	if x != nil {
...
func (x *UsageLimits) GetMaxUsersPerOrg() int32 {
	if x != nil {
		return x.MaxUsersPerOrg
	}
	return 0
}

func (x *UsageLimits) GetMaxIntegrationsPerOrg() int32 {
	if x != nil {
		return x.MaxIntegrationsPerOrg
	}
	return 0
}

func (x *UsageLimits) GetMaxEventsPerMonth() int32 {
	if x != nil {
...
func (x *UsageLimits) GetRetentionDays() int32 {
	if x != nil {
...
type UsageCounters struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Canvases        int64                  `protobuf:"varint,1,opt,name=canvases,proto3" json:"canvases,omitempty"`
	Users           int64                  `protobuf:"varint,2,opt,name=users,proto3" json:"users,omitempty"`
	Integrations    int64                  `protobuf:"varint,3,opt,name=integrations,proto3" json:"integrations,omitempty"`
	EventsThisMonth int64                  `protobuf:"varint,4,opt,name=events_this_month,json=eventsThisMonth,proto3" json:"events_this_month,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *UsageCounters) Reset() {
	*x = UsageCounters{}
...
func (x *UsageCounters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UsageCounters) ProtoMessage() {}

func (x *UsageCounters) ProtoReflect() protoreflect.Message {
	mi := &file_organizations_proto_msgTypes[56]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UsageCounters.ProtoReflect.Descriptor instead.
func (*UsageCounters) Descriptor() ([]byte, []int) {
	return file_organizations_proto_rawDescGZIP(), []int{56}
}

func (x *UsageCounters) GetCanvases() int64 {
	if x != nil {
		return x.Canvases
	}
	return 0
...
func (x *UsageCounters) GetUsers() int64 {
	if x != nil {
		return x.Users
	}
	return 0
...
func (x *UsageCounters) GetIntegrations() int64 {
	if x != nil {
		return x.Integrations
	}
	return 0
...
func (x *UsageCounters) GetEventsThisMonth() int64 {
	if x != nil {
...
const file_organizations_proto_rawDesc = "" +
	...
	"\x10GetUsageResponse\x129\n" +
	"\x05usage\x18\x01 \x01(\v2#.Superplane.Organizations.UsageInfoR\x05usage\"\x96\x02\n" +
	"\tUsageInfo\x12!\n" +
	"\fprofile_name\x18\x01 \x01(\tR\vprofileName\x12P\n" +
	"\x10effective_limits\x18\x02 \x01(\v2%.Superplane.Organizations.UsageLimitsR\x0feffectiveLimits\x12L\n" +
	"\rcurrent_usage\x18\x03 \x01(\v2'.Superplane.Organizations.UsageCountersR\fcurrentUsage\x12#\n" +
	"\rhas_overrides\x18\x04 \x01(\bR\fhasOverrides\x12!\n" +
	"\fis_unlimited\x18\x05 \x01(\bR\visUnlimited\"\xdc\x02\n" +
	"\vUsageLimits\x12/\n" +
	"\x14max_orgs_per_account\x18\x01 \x01(\x05R\x11maxOrgsPerAccount\x12/\n" +
	"\x14max_canvases_per_org\x18\x02 \x01(\x05R\x11maxCanvasesPerOrg\x12/\n" +
	"\x14max_nodes_per_canvas\x18\x03 \x01(\x05R\x11maxNodesPerCanvas\x12)\n" +
	"\x11max_users_per_org\x18\x04 \x01(\x05R\x0emaxUsersPerOrg\x127\n" +
	"\x18max_integrations_per_org\x18\x05 \x01(\x05R\x15maxIntegrationsPerOrg\x12/\n" +
	"\x14max_events_per_month\x18\x06 \x01(\x05R\x11maxEventsPerMonth\x12%\n" +
	"\x0eretention_days\x18\a \x01(\x05R\rretentionDays\"\x91\x01\n" +
	"\rUsageCounters\x12\x1a\n" +
	"\bcanvases\x18\x01 \x01(\x03R\bcanvases\x12\x14\n" +
	"\x05users\x18\x02 \x01(\x03R\x05users\x12\"\n" +
	"\fintegrations\x18\x03 \x01(\x03R\fintegrations\x12*\n" +
	"\x11events_this_month\x18\x04 \x01(\x03R\x0feventsThisMonth2\xbd1\n" +
	...
	"\fOrganization\x12\x1fDelete organization integration\x1a+Deletes an integration from an organization\x82\xd3\xe4\x93\x02:*8/api/v1/organizations/{id}/integrations/{integration_id}\x12\xa4\x02\n" +
	"\bGetUsage\x12).Superplane.Organizations.GetUsageRequest\x1a*.Superplane.Organizations.GetUsageResponse\"\xc0\x01\x92A\x94\x01\n" +
	"\fOrganization\x12\x16Get organization usage\x1alReturns the usage profile, effective limits, current usage counters, and override status for an organization\x82\xd3\xe4\x93\x02\"\x12 /api/v1/organizations/{id}/usageB\xf0\x01\x92A\xaf\x01\x12\x84\x01\n" +
...
var file_organizations_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_organizations_proto_goTypes = []any{
	...
	(*GetUsageRequest)(nil),                  // 52: Superplane.Organizations.GetUsageRequest
	(*GetUsageResponse)(nil),                 // 53: Superplane.Organizations.GetUsageResponse
	(*UsageInfo)(nil),                        // 54: Superplane.Organizations.UsageInfo
	(*UsageLimits)(nil),                      // 55: Superplane.Organizations.UsageLimits
	(*UsageCounters)(nil),                    // 56: Superplane.Organizations.UsageCounters
	(*Organization_Metadata)(nil),            // 57: Superplane.Organizations.Organization.Metadata
	nil,                                      // 58: Superplane.Organizations.ListIntegrationResourcesRequest.ParametersEntry
	(*Integration_Metadata)(nil),             // 59: Superplane.Organizations.Integration.Metadata
	(*Integration_Spec)(nil),                 // 60: Superplane.Organizations.Integration.Spec
	(*Integration_Status)(nil),               // 61: Superplane.Organizations.Integration.Status
	(*Integration_NodeRef)(nil),              // 62: Superplane.Organizations.Integration.NodeRef
	nil,                                      // 63: Superplane.Organizations.BrowserAction.FormFieldsEntry
...
var file_organizations_proto_depIdxs = []int32{
	57, // 0: Superplane.Organizations.Organization.metadata:type_name -> Superplane.Organizations.Organization.Metadata
	...
	64, // 4: Superplane.Organizations.Invitation.created_at:type_name -> google.protobuf.Timestamp
	64, // 5: Superplane.Organizations.InviteLink.created_at:type_name -> google.protobuf.Timestamp
	64, // 6: Superplane.Organizations.InviteLink.updated_at:type_name -> google.protobuf.Timestamp
	64, // 7: Superplane.Organizations.AgentOpenAIKey.validated_at:type_name -> google.protobuf.Timestamp
	64, // 8: Superplane.Organizations.AgentOpenAIKey.updated_at:type_name -> google.protobuf.Timestamp
	...
	65, // 20: Superplane.Organizations.CreateIntegrationRequest.configuration:type_name -> google.protobuf.Struct
	...
	58, // 23: Superplane.Organizations.ListIntegrationResourcesRequest.parameters:type_name -> Superplane.Organizations.ListIntegrationResourcesRequest.ParametersEntry
	...
	65, // 25: Superplane.Organizations.UpdateIntegrationRequest.configuration:type_name -> google.protobuf.Struct
	46, // 26: Superplane.Organizations.UpdateIntegrationResponse.integration:type_name -> Superplane.Organizations.Integration
	59, // 27: Superplane.Organizations.Integration.metadata:type_name -> Superplane.Organizations.Integration.Metadata
	60, // 28: Superplane.Organizations.Integration.spec:type_name -> Superplane.Organizations.Integration.Spec
	61, // 29: Superplane.Organizations.Integration.status:type_name -> Superplane.Organizations.Integration.Status
	63, // 30: Superplane.Organizations.BrowserAction.form_fields:type_name -> Superplane.Organizations.BrowserAction.FormFieldsEntry
	64, // 31: Superplane.Organizations.OrganizationCreated.timestamp:type_name -> google.protobuf.Timestamp
	64, // 32: Superplane.Organizations.OrganizationUpdated.timestamp:type_name -> google.protobuf.Timestamp
	64, // 33: Superplane.Organizations.OrganizationDeleted.timestamp:type_name -> google.protobuf.Timestamp
	64, // 34: Superplane.Organizations.InvitationCreated.timestamp:type_name -> google.protobuf.Timestamp
	54, // 35: Superplane.Organizations.GetUsageResponse.usage:type_name -> Superplane.Organizations.UsageInfo
	55, // 36: Superplane.Organizations.UsageInfo.effective_limits:type_name -> Superplane.Organizations.UsageLimits
	56, // 37: Superplane.Organizations.UsageInfo.current_usage:type_name -> Superplane.Organizations.UsageCounters
	64, // 38: Superplane.Organizations.Organization.Metadata.created_at:type_name -> google.protobuf.Timestamp
	64, // 39: Superplane.Organizations.Organization.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	64, // 40: Superplane.Organizations.Integration.Metadata.created_at:type_name -> google.protobuf.Timestamp
	64, // 41: Superplane.Organizations.Integration.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	65, // 42: Superplane.Organizations.Integration.Spec.configuration:type_name -> google.protobuf.Struct
	65, // 43: Superplane.Organizations.Integration.Status.metadata:type_name -> google.protobuf.Struct
	47, // 44: Superplane.Organizations.Integration.Status.browser_action:type_name -> Superplane.Organizations.BrowserAction
	62, // 45: Superplane.Organizations.Integration.Status.used_in:type_name -> Superplane.Organizations.Integration.NodeRef
	1,  // 46: Superplane.Organizations.Organizations.DescribeOrganization:input_type -> Superplane.Organizations.DescribeOrganizationRequest
	3,  // 47: Superplane.Organizations.Organizations.UpdateOrganization:input_type -> Superplane.Organizations.UpdateOrganizationRequest
	5,  // 48: Superplane.Organizations.Organizations.DeleteOrganization:input_type -> Superplane.Organizations.DeleteOrganizationRequest
	31, // 49: Superplane.Organizations.Organizations.RemoveUser:input_type -> Superplane.Organizations.RemoveUserRequest
	11, // 50: Superplane.Organizations.Organizations.CreateInvitation:input_type -> Superplane.Organizations.CreateInvitationRequest
	13, // 51: Superplane.Organizations.Organizations.ListInvitations:input_type -> Superplane.Organizations.ListInvitationsRequest
	15, // 52: Superplane.Organizations.Organizations.RemoveInvitation:input_type -> Superplane.Organizations.RemoveInvitationRequest
	17, // 53: Superplane.Organizations.Organizations.GetInviteLink:input_type -> Superplane.Organizations.GetInviteLinkRequest
	19, // 54: Superplane.Organizations.Organizations.UpdateInviteLink:input_type -> Superplane.Organizations.UpdateInviteLinkRequest
	21, // 55: Superplane.Organizations.Organizations.ResetInviteLink:input_type -> Superplane.Organizations.ResetInviteLinkRequest
	23, // 56: Superplane.Organizations.Organizations.GetAgentSettings:input_type -> Superplane.Organizations.GetAgentSettingsRequest
	25, // 57: Superplane.Organizations.Organizations.UpdateAgentSettings:input_type -> Superplane.Organizations.UpdateAgentSettingsRequest
	27, // 58: Superplane.Organizations.Organizations.SetAgentOpenAIKey:input_type -> Superplane.Organizations.SetAgentOpenAIKeyRequest
	29, // 59: Superplane.Organizations.Organizations.DeleteAgentOpenAIKey:input_type -> Superplane.Organizations.DeleteAgentOpenAIKeyRequest
	8,  // 60: Superplane.Organizations.Organizations.AcceptInviteLink:input_type -> Superplane.Organizations.InviteLink
	33, // 61: Superplane.Organizations.Organizations.ListIntegrations:input_type -> Superplane.Organizations.ListIntegrationsRequest
	37, // 62: Superplane.Organizations.Organizations.DescribeIntegration:input_type -> Superplane.Organizations.DescribeIntegrationRequest
	39, // 63: Superplane.Organizations.Organizations.ListIntegrationResources:input_type -> Superplane.Organizations.ListIntegrationResourcesRequest
	35, // 64: Superplane.Organizations.Organizations.CreateIntegration:input_type -> Superplane.Organizations.CreateIntegrationRequest
	42, // 65: Superplane.Organizations.Organizations.UpdateIntegration:input_type -> Superplane.Organizations.UpdateIntegrationRequest
	44, // 66: Superplane.Organizations.Organizations.DeleteIntegration:input_type -> Superplane.Organizations.DeleteIntegrationRequest
	52, // 67: Superplane.Organizations.Organizations.GetUsage:input_type -> Superplane.Organizations.GetUsageRequest
	2,  // 68: Superplane.Organizations.Organizations.DescribeOrganization:output_type -> Superplane.Organizations.DescribeOrganizationResponse
	4,  // 69: Superplane.Organizations.Organizations.UpdateOrganization:output_type -> Superplane.Organizations.UpdateOrganizationResponse
	6,  // 70: Superplane.Organizations.Organizations.DeleteOrganization:output_type -> Superplane.Organizations.DeleteOrganizationResponse
	32, // 71: Superplane.Organizations.Organizations.RemoveUser:output_type -> Superplane.Organizations.RemoveUserResponse
	12, // 72: Superplane.Organizations.Organizations.CreateInvitation:output_type -> Superplane.Organizations.CreateInvitationResponse
	14, // 73: Superplane.Organizations.Organizations.ListInvitations:output_type -> Superplane.Organizations.ListInvitationsResponse
	16, // 74: Superplane.Organizations.Organizations.RemoveInvitation:output_type -> Superplane.Organizations.RemoveInvitationResponse
	18, // 75: Superplane.Organizations.Organizations.GetInviteLink:output_type -> Superplane.Organizations.GetInviteLinkResponse
	20, // 76: Superplane.Organizations.Organizations.UpdateInviteLink:output_type -> Superplane.Organizations.UpdateInviteLinkResponse
	22, // 77: Superplane.Organizations.Organizations.ResetInviteLink:output_type -> Superplane.Organizations.ResetInviteLinkResponse
	24, // 78: Superplane.Organizations.Organizations.GetAgentSettings:output_type -> Superplane.Organizations.GetAgentSettingsResponse
	26, // 79: Superplane.Organizations.Organizations.UpdateAgentSettings:output_type -> Superplane.Organizations.UpdateAgentSettingsResponse
	28, // 80: Superplane.Organizations.Organizations.SetAgentOpenAIKey:output_type -> Superplane.Organizations.SetAgentOpenAIKeyResponse
	30, // 81: Superplane.Organizations.Organizations.DeleteAgentOpenAIKey:output_type -> Superplane.Organizations.DeleteAgentOpenAIKeyResponse
	65, // 82: Superplane.Organizations.Organizations.AcceptInviteLink:output_type -> google.protobuf.Struct
	34, // 83: Superplane.Organizations.Organizations.ListIntegrations:output_type -> Superplane.Organizations.ListIntegrationsResponse
	38, // 84: Superplane.Organizations.Organizations.DescribeIntegration:output_type -> Superplane.Organizations.DescribeIntegrationResponse
	40, // 85: Superplane.Organizations.Organizations.ListIntegrationResources:output_type -> Superplane.Organizations.ListIntegrationResourcesResponse
	36, // 86: Superplane.Organizations.Organizations.CreateIntegration:output_type -> Superplane.Organizations.CreateIntegrationResponse
	43, // 87: Superplane.Organizations.Organizations.UpdateIntegration:output_type -> Superplane.Organizations.UpdateIntegrationResponse
	45, // 88: Superplane.Organizations.Organizations.DeleteIntegration:output_type -> Superplane.Organizations.DeleteIntegrationResponse
	53, // 89: Superplane.Organizations.Organizations.GetUsage:output_type -> Superplane.Organizations.GetUsageResponse
...
func file_organizations_proto_init() {
	...
	file_organizations_proto_msgTypes[57].OneofWrappers = []any{}
	type x struct{}
