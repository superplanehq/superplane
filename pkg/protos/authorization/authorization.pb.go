...
func (x *ReloadPolicyMessage) Reset() {
	*x = ReloadPolicyMessage{}
	mi := &file_authorization_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReloadPolicyMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReloadPolicyMessage) ProtoMessage() {}

func (x *ReloadPolicyMessage) ProtoReflect() protoreflect.Message {
	mi := &file_authorization_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReloadPolicyMessage.ProtoReflect.Descriptor instead.
func (*ReloadPolicyMessage) Descriptor() ([]byte, []int) {
	return file_authorization_proto_rawDescGZIP(), []int{1}
}

func (x *ReloadPolicyMessage) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
const file_authorization_proto_rawDesc = "" +
	"\n" +
	"\x13authorization.proto\x12\x18Superplane.Authorization\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x01\n" +
	"\n" +
	"Permission\x12\x1a\n" +
	...
	"domainType\"O\n" +
	"\x13ReloadPolicyMessage\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp*_\n" +
	"\n" +
	"DomainType\x12\x1b\n" +
...
var file_authorization_proto_goTypes = []any{
	...
	(*ReloadPolicyMessage)(nil), // 2: Superplane.Authorization.ReloadPolicyMessage
...
var file_authorization_proto_depIdxs = []int32{
	...
	3, // 1: Superplane.Authorization.ReloadPolicyMessage.timestamp:type_name -> google.protobuf.Timestamp
