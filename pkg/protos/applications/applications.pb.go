...
func (x *ApplicationDefinition) GetInstallationInstructions() string {
	if x != nil {
...
const file_applications_proto_rawDesc = "" +
	...
	"\fapplications\x18\x01 \x03(\v2..Superplane.Applications.ApplicationDefinitionR\fapplications\"\xf7\x02\n" +
