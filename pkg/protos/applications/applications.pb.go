...
type ApplicationDefinition struct {
	...
	Configuration []*configuration.Field  `protobuf:"bytes,2,rep,name=configuration,proto3" json:"configuration,omitempty"`
	Components    []*components.Component `protobuf:"bytes,3,rep,name=components,proto3" json:"components,omitempty"`
	Triggers      []*triggers.Trigger     `protobuf:"bytes,4,rep,name=triggers,proto3" json:"triggers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_applications_proto_rawDesc = "" +
	...
	"\fapplications\x18\x01 \x03(\v2..Superplane.Applications.ApplicationDefinitionR\fapplications\"\xee\x01\n" +
	"\x15ApplicationDefinition\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12E\n" +
	"\rconfiguration\x18\x02 \x03(\v2\x1f.Superplane.Configuration.FieldR\rconfiguration\x12@\n" +
	"\n" +
	"components\x18\x03 \x03(\v2 .Superplane.Components.ComponentR\n" +
	"components\x128\n" +
	"\btriggers\x18\x04 \x03(\v2\x1c.Superplane.Triggers.TriggerR\btriggers2\xf0\x01\n" +
