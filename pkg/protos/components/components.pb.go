...
const file_components_proto_rawDesc = "" +
	...
	"\vAPI Support\x1a\x16support@superplane.com2\x031.0*\x02\x02\x012\x10application/json:\x10application/jsonZ8github.com/superplanehq/superplane/pkg/protos/componentsb\x06proto3"
