...
func (CanvasNodeExecution_Result) EnumDescriptor() ([]byte, []int) {
	return file_canvases_proto_rawDescGZIP(), []int{33, 1}
}
...
func (CanvasNodeExecution_ResultReason) EnumDescriptor() ([]byte, []int) {
	return file_canvases_proto_rawDescGZIP(), []int{33, 2}
}
...
func (*Canvas_Metadata) Descriptor() ([]byte, []int) {
	return file_canvases_proto_rawDescGZIP(), []int{17, 0}
}
...
func (*Canvas_Spec) Descriptor() ([]byte, []int) {
	return file_canvases_proto_rawDescGZIP(), []int{17, 1}
}
...
func (*Canvas_Status) Descriptor() ([]byte, []int) {
	return file_canvases_proto_rawDescGZIP(), []int{17, 2}
}
...
const file_canvases_proto_rawDesc = "" +
	...
	"\aversion\x18\x01 \x01(\v2\".Superplane.Canvases.CanvasVersionR\aversion\"\x8d\x01\n" +
	"\x1aUpdateCanvasVersionRequest\x12\x1b\n" +
	"\tcanvas_id\x18\x01 \x01(\tR\bcanvasId\x12\x1d\n" +
	"\n" +
	"version_id\x18\x02 \x01(\tR\tversionId\x123\n" +
	"\x06canvas\x18\x03 \x01(\v2\x1b.Superplane.Canvases.CanvasR\x06canvas\"[\n" +
	...
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xc9-\n" +
...
var file_canvases_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_canvases_proto_goTypes = []any{
	...
	(*CreateCanvasVersionRequest)(nil),        // 11: Superplane.Canvases.CreateCanvasVersionRequest
	(*CreateCanvasVersionResponse)(nil),       // 12: Superplane.Canvases.CreateCanvasVersionResponse
	(*UpdateCanvasVersionRequest)(nil),        // 13: Superplane.Canvases.UpdateCanvasVersionRequest
	(*UpdateCanvasVersionResponse)(nil),       // 14: Superplane.Canvases.UpdateCanvasVersionResponse
	(*PublishCanvasVersionRequest)(nil),       // 15: Superplane.Canvases.PublishCanvasVersionRequest
	(*PublishCanvasVersionResponse)(nil),      // 16: Superplane.Canvases.PublishCanvasVersionResponse
	(*DeleteCanvasRequest)(nil),               // 17: Superplane.Canvases.DeleteCanvasRequest
	(*DeleteCanvasResponse)(nil),              // 18: Superplane.Canvases.DeleteCanvasResponse
	(*UserRef)(nil),                           // 19: Superplane.Canvases.UserRef
	(*Canvas)(nil),                            // 20: Superplane.Canvases.Canvas
	(*CanvasVersion)(nil),                     // 21: Superplane.Canvases.CanvasVersion
	(*ListNodeEventsRequest)(nil),             // 22: Superplane.Canvases.ListNodeEventsRequest
	(*ListNodeEventsResponse)(nil),            // 23: Superplane.Canvases.ListNodeEventsResponse
	(*EmitNodeEventRequest)(nil),              // 24: Superplane.Canvases.EmitNodeEventRequest
	(*EmitNodeEventResponse)(nil),             // 25: Superplane.Canvases.EmitNodeEventResponse
	(*ListNodeQueueItemsRequest)(nil),         // 26: Superplane.Canvases.ListNodeQueueItemsRequest
	(*ListNodeQueueItemsResponse)(nil),        // 27: Superplane.Canvases.ListNodeQueueItemsResponse
	(*DeleteNodeQueueItemRequest)(nil),        // 28: Superplane.Canvases.DeleteNodeQueueItemRequest
	(*DeleteNodeQueueItemResponse)(nil),       // 29: Superplane.Canvases.DeleteNodeQueueItemResponse
	(*UpdateNodePauseRequest)(nil),            // 30: Superplane.Canvases.UpdateNodePauseRequest
	(*UpdateNodePauseResponse)(nil),           // 31: Superplane.Canvases.UpdateNodePauseResponse
	(*ListNodeExecutionsRequest)(nil),         // 32: Superplane.Canvases.ListNodeExecutionsRequest
	(*ListNodeExecutionsResponse)(nil),        // 33: Superplane.Canvases.ListNodeExecutionsResponse
	(*ListChildExecutionsRequest)(nil),        // 34: Superplane.Canvases.ListChildExecutionsRequest
	(*ListChildExecutionsResponse)(nil),       // 35: Superplane.Canvases.ListChildExecutionsResponse
	(*CanvasNodeExecution)(nil),               // 36: Superplane.Canvases.CanvasNodeExecution
	(*CanvasNodeQueueItem)(nil),               // 37: Superplane.Canvases.CanvasNodeQueueItem
	(*InvokeNodeExecutionActionRequest)(nil),  // 38: Superplane.Canvases.InvokeNodeExecutionActionRequest
	(*InvokeNodeExecutionActionResponse)(nil), // 39: Superplane.Canvases.InvokeNodeExecutionActionResponse
	(*InvokeNodeTriggerActionRequest)(nil),    // 40: Superplane.Canvases.InvokeNodeTriggerActionRequest
	(*InvokeNodeTriggerActionResponse)(nil),   // 41: Superplane.Canvases.InvokeNodeTriggerActionResponse
	(*ListCanvasEventsRequest)(nil),           // 42: Superplane.Canvases.ListCanvasEventsRequest
	(*ListCanvasEventsResponse)(nil),          // 43: Superplane.Canvases.ListCanvasEventsResponse
	(*CanvasEvent)(nil),                       // 44: Superplane.Canvases.CanvasEvent
	(*CanvasEventWithExecutions)(nil),         // 45: Superplane.Canvases.CanvasEventWithExecutions
	(*ListEventExecutionsRequest)(nil),        // 46: Superplane.Canvases.ListEventExecutionsRequest
	(*ListEventExecutionsResponse)(nil),       // 47: Superplane.Canvases.ListEventExecutionsResponse
	(*CancelExecutionRequest)(nil),            // 48: Superplane.Canvases.CancelExecutionRequest
	(*CancelExecutionResponse)(nil),           // 49: Superplane.Canvases.CancelExecutionResponse
	(*ResolveExecutionErrorsRequest)(nil),     // 50: Superplane.Canvases.ResolveExecutionErrorsRequest
	(*ResolveExecutionErrorsResponse)(nil),    // 51: Superplane.Canvases.ResolveExecutionErrorsResponse
	(*CanvasAiNodeContext)(nil),               // 52: Superplane.Canvases.CanvasAiNodeContext
	(*CanvasAiBlockContext)(nil),              // 53: Superplane.Canvases.CanvasAiBlockContext
	(*CanvasAiContext)(nil),                   // 54: Superplane.Canvases.CanvasAiContext
	(*SendAiMessageRequest)(nil),              // 55: Superplane.Canvases.SendAiMessageRequest
	(*SendAiMessageResponse)(nil),             // 56: Superplane.Canvases.SendAiMessageResponse
	(*CanvasNodeEventMessage)(nil),            // 57: Superplane.Canvases.CanvasNodeEventMessage
	(*CanvasNodeExecutionMessage)(nil),        // 58: Superplane.Canvases.CanvasNodeExecutionMessage
	(*CanvasNodeQueueItemMessage)(nil),        // 59: Superplane.Canvases.CanvasNodeQueueItemMessage
	(*CanvasMessage)(nil),                     // 60: Superplane.Canvases.CanvasMessage
	(*Canvas_Metadata)(nil),                   // 61: Superplane.Canvases.Canvas.Metadata
	(*Canvas_Spec)(nil),                       // 62: Superplane.Canvases.Canvas.Spec
	(*Canvas_Status)(nil),                     // 63: Superplane.Canvases.Canvas.Status
	(*CanvasVersion_Metadata)(nil),            // 64: Superplane.Canvases.CanvasVersion.Metadata
	(*timestamp.Timestamp)(nil),               // 65: google.protobuf.Timestamp
	(*_struct.Struct)(nil),                    // 66: google.protobuf.Struct
	(*components.Node)(nil),                   // 67: Superplane.Components.Node
	(*components.Edge)(nil),                   // 68: Superplane.Components.Edge
}
var file_canvases_proto_depIdxs = []int32{
	20, // 0: Superplane.Canvases.ListCanvasesResponse.canvases:type_name -> Superplane.Canvases.Canvas
	20, // 1: Superplane.Canvases.DescribeCanvasResponse.canvas:type_name -> Superplane.Canvases.Canvas
	20, // 2: Superplane.Canvases.CreateCanvasRequest.canvas:type_name -> Superplane.Canvases.Canvas
	20, // 3: Superplane.Canvases.CreateCanvasResponse.canvas:type_name -> Superplane.Canvases.Canvas
	20, // 4: Superplane.Canvases.UpdateCanvasRequest.canvas:type_name -> Superplane.Canvases.Canvas
	20, // 5: Superplane.Canvases.UpdateCanvasResponse.canvas:type_name -> Superplane.Canvases.Canvas
	21, // 6: Superplane.Canvases.CreateCanvasVersionResponse.version:type_name -> Superplane.Canvases.CanvasVersion
	20, // 7: Superplane.Canvases.UpdateCanvasVersionRequest.canvas:type_name -> Superplane.Canvases.Canvas
	21, // 8: Superplane.Canvases.UpdateCanvasVersionResponse.version:type_name -> Superplane.Canvases.CanvasVersion
	20, // 9: Superplane.Canvases.PublishCanvasVersionResponse.canvas:type_name -> Superplane.Canvases.Canvas
	21, // 10: Superplane.Canvases.PublishCanvasVersionResponse.version:type_name -> Superplane.Canvases.CanvasVersion
	61, // 11: Superplane.Canvases.Canvas.metadata:type_name -> Superplane.Canvases.Canvas.Metadata
	62, // 12: Superplane.Canvases.Canvas.spec:type_name -> Superplane.Canvases.Canvas.Spec
	63, // 13: Superplane.Canvases.Canvas.status:type_name -> Superplane.Canvases.Canvas.Status
	64, // 14: Superplane.Canvases.CanvasVersion.metadata:type_name -> Superplane.Canvases.CanvasVersion.Metadata
	62, // 15: Superplane.Canvases.CanvasVersion.spec:type_name -> Superplane.Canvases.Canvas.Spec
	65, // 16: Superplane.Canvases.ListNodeEventsRequest.before:type_name -> google.protobuf.Timestamp
	44, // 17: Superplane.Canvases.ListNodeEventsResponse.events:type_name -> Superplane.Canvases.CanvasEvent
	65, // 18: Superplane.Canvases.ListNodeEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	66, // 19: Superplane.Canvases.EmitNodeEventRequest.data:type_name -> google.protobuf.Struct
	65, // 20: Superplane.Canvases.ListNodeQueueItemsRequest.before:type_name -> google.protobuf.Timestamp
	37, // 21: Superplane.Canvases.ListNodeQueueItemsResponse.items:type_name -> Superplane.Canvases.CanvasNodeQueueItem
	65, // 22: Superplane.Canvases.ListNodeQueueItemsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	67, // 23: Superplane.Canvases.UpdateNodePauseResponse.node:type_name -> Superplane.Components.Node
	0,  // 24: Superplane.Canvases.ListNodeExecutionsRequest.states:type_name -> Superplane.Canvases.CanvasNodeExecution.State
	1,  // 25: Superplane.Canvases.ListNodeExecutionsRequest.results:type_name -> Superplane.Canvases.CanvasNodeExecution.Result
	65, // 26: Superplane.Canvases.ListNodeExecutionsRequest.before:type_name -> google.protobuf.Timestamp
	36, // 27: Superplane.Canvases.ListNodeExecutionsResponse.executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	65, // 28: Superplane.Canvases.ListNodeExecutionsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	36, // 29: Superplane.Canvases.ListChildExecutionsResponse.executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	0,  // 30: Superplane.Canvases.CanvasNodeExecution.state:type_name -> Superplane.Canvases.CanvasNodeExecution.State
	1,  // 31: Superplane.Canvases.CanvasNodeExecution.result:type_name -> Superplane.Canvases.CanvasNodeExecution.Result
	2,  // 32: Superplane.Canvases.CanvasNodeExecution.result_reason:type_name -> Superplane.Canvases.CanvasNodeExecution.ResultReason
	66, // 33: Superplane.Canvases.CanvasNodeExecution.input:type_name -> google.protobuf.Struct
	66, // 34: Superplane.Canvases.CanvasNodeExecution.outputs:type_name -> google.protobuf.Struct
	65, // 35: Superplane.Canvases.CanvasNodeExecution.created_at:type_name -> google.protobuf.Timestamp
	65, // 36: Superplane.Canvases.CanvasNodeExecution.updated_at:type_name -> google.protobuf.Timestamp
	66, // 37: Superplane.Canvases.CanvasNodeExecution.metadata:type_name -> google.protobuf.Struct
	66, // 38: Superplane.Canvases.CanvasNodeExecution.configuration:type_name -> google.protobuf.Struct
	36, // 39: Superplane.Canvases.CanvasNodeExecution.child_executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	44, // 40: Superplane.Canvases.CanvasNodeExecution.root_event:type_name -> Superplane.Canvases.CanvasEvent
	19, // 41: Superplane.Canvases.CanvasNodeExecution.cancelled_by:type_name -> Superplane.Canvases.UserRef
	66, // 42: Superplane.Canvases.CanvasNodeQueueItem.input:type_name -> google.protobuf.Struct
	44, // 43: Superplane.Canvases.CanvasNodeQueueItem.root_event:type_name -> Superplane.Canvases.CanvasEvent
	65, // 44: Superplane.Canvases.CanvasNodeQueueItem.created_at:type_name -> google.protobuf.Timestamp
	66, // 45: Superplane.Canvases.InvokeNodeExecutionActionRequest.parameters:type_name -> google.protobuf.Struct
	66, // 46: Superplane.Canvases.InvokeNodeTriggerActionRequest.parameters:type_name -> google.protobuf.Struct
	66, // 47: Superplane.Canvases.InvokeNodeTriggerActionResponse.result:type_name -> google.protobuf.Struct
	65, // 48: Superplane.Canvases.ListCanvasEventsRequest.before:type_name -> google.protobuf.Timestamp
	45, // 49: Superplane.Canvases.ListCanvasEventsResponse.events:type_name -> Superplane.Canvases.CanvasEventWithExecutions
	65, // 50: Superplane.Canvases.ListCanvasEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	66, // 51: Superplane.Canvases.CanvasEvent.data:type_name -> google.protobuf.Struct
	65, // 52: Superplane.Canvases.CanvasEvent.created_at:type_name -> google.protobuf.Timestamp
	66, // 53: Superplane.Canvases.CanvasEventWithExecutions.data:type_name -> google.protobuf.Struct
	65, // 54: Superplane.Canvases.CanvasEventWithExecutions.created_at:type_name -> google.protobuf.Timestamp
	36, // 55: Superplane.Canvases.CanvasEventWithExecutions.executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	36, // 56: Superplane.Canvases.ListEventExecutionsResponse.executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	52, // 57: Superplane.Canvases.CanvasAiContext.nodes:type_name -> Superplane.Canvases.CanvasAiNodeContext
	53, // 58: Superplane.Canvases.CanvasAiContext.available_blocks:type_name -> Superplane.Canvases.CanvasAiBlockContext
	54, // 59: Superplane.Canvases.SendAiMessageRequest.canvas_context:type_name -> Superplane.Canvases.CanvasAiContext
	66, // 60: Superplane.Canvases.SendAiMessageResponse.operations:type_name -> google.protobuf.Struct
	65, // 61: Superplane.Canvases.CanvasNodeEventMessage.timestamp:type_name -> google.protobuf.Timestamp
	65, // 62: Superplane.Canvases.CanvasNodeExecutionMessage.timestamp:type_name -> google.protobuf.Timestamp
	65, // 63: Superplane.Canvases.CanvasNodeQueueItemMessage.timestamp:type_name -> google.protobuf.Timestamp
	65, // 64: Superplane.Canvases.CanvasMessage.timestamp:type_name -> google.protobuf.Timestamp
	65, // 65: Superplane.Canvases.Canvas.Metadata.created_at:type_name -> google.protobuf.Timestamp
	65, // 66: Superplane.Canvases.Canvas.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	19, // 67: Superplane.Canvases.Canvas.Metadata.created_by:type_name -> Superplane.Canvases.UserRef
	67, // 68: Superplane.Canvases.Canvas.Spec.nodes:type_name -> Superplane.Components.Node
	68, // 69: Superplane.Canvases.Canvas.Spec.edges:type_name -> Superplane.Components.Edge
	36, // 70: Superplane.Canvases.Canvas.Status.last_executions:type_name -> Superplane.Canvases.CanvasNodeExecution
	37, // 71: Superplane.Canvases.Canvas.Status.next_queue_items:type_name -> Superplane.Canvases.CanvasNodeQueueItem
	44, // 72: Superplane.Canvases.Canvas.Status.last_events:type_name -> Superplane.Canvases.CanvasEvent
	19, // 73: Superplane.Canvases.CanvasVersion.Metadata.owner:type_name -> Superplane.Canvases.UserRef
	65, // 74: Superplane.Canvases.CanvasVersion.Metadata.published_at:type_name -> google.protobuf.Timestamp
	65, // 75: Superplane.Canvases.CanvasVersion.Metadata.created_at:type_name -> google.protobuf.Timestamp
	65, // 76: Superplane.Canvases.CanvasVersion.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	3,  // 77: Superplane.Canvases.Canvases.ListCanvases:input_type -> Superplane.Canvases.ListCanvasesRequest
	7,  // 78: Superplane.Canvases.Canvases.CreateCanvas:input_type -> Superplane.Canvases.CreateCanvasRequest
	5,  // 79: Superplane.Canvases.Canvases.DescribeCanvas:input_type -> Superplane.Canvases.DescribeCanvasRequest
	9,  // 80: Superplane.Canvases.Canvases.UpdateCanvas:input_type -> Superplane.Canvases.UpdateCanvasRequest
	11, // 81: Superplane.Canvases.Canvases.CreateCanvasVersion:input_type -> Superplane.Canvases.CreateCanvasVersionRequest
	13, // 82: Superplane.Canvases.Canvases.UpdateCanvasVersion:input_type -> Superplane.Canvases.UpdateCanvasVersionRequest
	15, // 83: Superplane.Canvases.Canvases.PublishCanvasVersion:input_type -> Superplane.Canvases.PublishCanvasVersionRequest
	17, // 84: Superplane.Canvases.Canvases.DeleteCanvas:input_type -> Superplane.Canvases.DeleteCanvasRequest
	26, // 85: Superplane.Canvases.Canvases.ListNodeQueueItems:input_type -> Superplane.Canvases.ListNodeQueueItemsRequest
	28, // 86: Superplane.Canvases.Canvases.DeleteNodeQueueItem:input_type -> Superplane.Canvases.DeleteNodeQueueItemRequest
	30, // 87: Superplane.Canvases.Canvases.UpdateNodePause:input_type -> Superplane.Canvases.UpdateNodePauseRequest
	32, // 88: Superplane.Canvases.Canvases.ListNodeExecutions:input_type -> Superplane.Canvases.ListNodeExecutionsRequest
	22, // 89: Superplane.Canvases.Canvases.ListNodeEvents:input_type -> Superplane.Canvases.ListNodeEventsRequest
	24, // 90: Superplane.Canvases.Canvases.EmitNodeEvent:input_type -> Superplane.Canvases.EmitNodeEventRequest
	38, // 91: Superplane.Canvases.Canvases.InvokeNodeExecutionAction:input_type -> Superplane.Canvases.InvokeNodeExecutionActionRequest
	40, // 92: Superplane.Canvases.Canvases.InvokeNodeTriggerAction:input_type -> Superplane.Canvases.InvokeNodeTriggerActionRequest
	34, // 93: Superplane.Canvases.Canvases.ListChildExecutions:input_type -> Superplane.Canvases.ListChildExecutionsRequest
	48, // 94: Superplane.Canvases.Canvases.CancelExecution:input_type -> Superplane.Canvases.CancelExecutionRequest
	50, // 95: Superplane.Canvases.Canvases.ResolveExecutionErrors:input_type -> Superplane.Canvases.ResolveExecutionErrorsRequest
	42, // 96: Superplane.Canvases.Canvases.ListCanvasEvents:input_type -> Superplane.Canvases.ListCanvasEventsRequest
	46, // 97: Superplane.Canvases.Canvases.ListEventExecutions:input_type -> Superplane.Canvases.ListEventExecutionsRequest
	55, // 98: Superplane.Canvases.Canvases.SendAiMessage:input_type -> Superplane.Canvases.SendAiMessageRequest
	4,  // 99: Superplane.Canvases.Canvases.ListCanvases:output_type -> Superplane.Canvases.ListCanvasesResponse
	8,  // 100: Superplane.Canvases.Canvases.CreateCanvas:output_type -> Superplane.Canvases.CreateCanvasResponse
	6,  // 101: Superplane.Canvases.Canvases.DescribeCanvas:output_type -> Superplane.Canvases.DescribeCanvasResponse
	10, // 102: Superplane.Canvases.Canvases.UpdateCanvas:output_type -> Superplane.Canvases.UpdateCanvasResponse
	12, // 103: Superplane.Canvases.Canvases.CreateCanvasVersion:output_type -> Superplane.Canvases.CreateCanvasVersionResponse
	14, // 104: Superplane.Canvases.Canvases.UpdateCanvasVersion:output_type -> Superplane.Canvases.UpdateCanvasVersionResponse
	16, // 105: Superplane.Canvases.Canvases.PublishCanvasVersion:output_type -> Superplane.Canvases.PublishCanvasVersionResponse
	18, // 106: Superplane.Canvases.Canvases.DeleteCanvas:output_type -> Superplane.Canvases.DeleteCanvasResponse
	27, // 107: Superplane.Canvases.Canvases.ListNodeQueueItems:output_type -> Superplane.Canvases.ListNodeQueueItemsResponse
	29, // 108: Superplane.Canvases.Canvases.DeleteNodeQueueItem:output_type -> Superplane.Canvases.DeleteNodeQueueItemResponse
	31, // 109: Superplane.Canvases.Canvases.UpdateNodePause:output_type -> Superplane.Canvases.UpdateNodePauseResponse
	33, // 110: Superplane.Canvases.Canvases.ListNodeExecutions:output_type -> Superplane.Canvases.ListNodeExecutionsResponse
	23, // 111: Superplane.Canvases.Canvases.ListNodeEvents:output_type -> Superplane.Canvases.ListNodeEventsResponse
	25, // 112: Superplane.Canvases.Canvases.EmitNodeEvent:output_type -> Superplane.Canvases.EmitNodeEventResponse
	39, // 113: Superplane.Canvases.Canvases.InvokeNodeExecutionAction:output_type -> Superplane.Canvases.InvokeNodeExecutionActionResponse
	41, // 114: Superplane.Canvases.Canvases.InvokeNodeTriggerAction:output_type -> Superplane.Canvases.InvokeNodeTriggerActionResponse
	35, // 115: Superplane.Canvases.Canvases.ListChildExecutions:output_type -> Superplane.Canvases.ListChildExecutionsResponse
	49, // 116: Superplane.Canvases.Canvases.CancelExecution:output_type -> Superplane.Canvases.CancelExecutionResponse
	51, // 117: Superplane.Canvases.Canvases.ResolveExecutionErrors:output_type -> Superplane.Canvases.ResolveExecutionErrorsResponse
	43, // 118: Superplane.Canvases.Canvases.ListCanvasEvents:output_type -> Superplane.Canvases.ListCanvasEventsResponse
	47, // 119: Superplane.Canvases.Canvases.ListEventExecutions:output_type -> Superplane.Canvases.ListEventExecutionsResponse
	56, // 120: Superplane.Canvases.Canvases.SendAiMessage:output_type -> Superplane.Canvases.SendAiMessageResponse
