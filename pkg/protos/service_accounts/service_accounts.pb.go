...
func (x *ServiceAccount) GetCreatedByName() string {
	if x != nil {
...
const file_service_accounts_proto_rawDesc = "" +
	"\n" +
	"\x16service_accounts.proto\x12\x1aSuperplane.ServiceAccounts\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xd9\x02\n" +
	...
	"\x0fcreated_by_name\x18\t \x01(\tR\rcreatedByName\"g\n" +
