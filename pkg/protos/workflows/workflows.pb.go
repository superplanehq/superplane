...
type ReEmitNodeExecutionEventRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WorkflowId    string                 `protobuf:"bytes,1,opt,name=workflow_id,json=workflowId,proto3" json:"workflow_id,omitempty"`
	NodeId        string                 `protobuf:"bytes,2,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
...
func (x *ReEmitNodeExecutionEventRequest) Reset() {
	*x = ReEmitNodeExecutionEventRequest{}
	mi := &file_workflows_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReEmitNodeExecutionEventRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReEmitNodeExecutionEventRequest) ProtoMessage() {}

func (x *ReEmitNodeExecutionEventRequest) ProtoReflect() protoreflect.Message {
	mi := &file_workflows_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReEmitNodeExecutionEventRequest.ProtoReflect.Descriptor instead.
func (*ReEmitNodeExecutionEventRequest) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{16}
}

func (x *ReEmitNodeExecutionEventRequest) GetWorkflowId() string {
	if x != nil {
		return x.WorkflowId
	}
	return ""
...
func (x *ReEmitNodeExecutionEventRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *ReEmitNodeExecutionEventRequest) GetExecutionId() string {
	if x != nil {
...
type ReEmitNodeExecutionEventResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EventId       string                 `protobuf:"bytes,1,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ReEmitNodeExecutionEventResponse) Reset() {
	*x = ReEmitNodeExecutionEventResponse{}
	mi := &file_workflows_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReEmitNodeExecutionEventResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReEmitNodeExecutionEventResponse) ProtoMessage() {}

func (x *ReEmitNodeExecutionEventResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workflows_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReEmitNodeExecutionEventResponse.ProtoReflect.Descriptor instead.
func (*ReEmitNodeExecutionEventResponse) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{17}
}

func (x *ReEmitNodeExecutionEventResponse) GetEventId() string {
	if x != nil {
		return x.EventId
	}
	return ""
...
const file_workflows_proto_rawDesc = "" +
	...
	"\x1fReEmitNodeExecutionEventRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12!\n" +
	"\fexecution_id\x18\x03 \x01(\tR\vexecutionId\"=\n" +
	" ReEmitNodeExecutionEventResponse\x12\x19\n" +
	...
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x128\n" +
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xe6\x1e\n" +
	...
	"\rWorkflowEvent\x12\x15List event executions\x1a?Returns a list of all node executions triggered by a root event\x82\xd3\xe4\x93\x02>\x12</api/v1/workflows/{workflow_id}/events/{event_id}/executions\x12\xad\x02\n" +
	"\x18ReEmitNodeExecutionEvent\x125.Superplane.Workflows.ReEmitNodeExecutionEventRequest\x1a6.Superplane.Workflows.ReEmitNodeExecutionEventResponse\"\xa1\x01\x92AS\n" +
	"\x15WorkflowNodeExecution\x12\x1cRe-emit node execution event\x1a\x1cRe-emit node execution event\x82\xd3\xe4\x93\x02E:\x01*\"@/api/v1/workflows/{workflow_id}/executions/{execution_id}/reemitB\xcb\x01\x92A\x8e\x01\x12d\n" +
...
var file_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_workflows_proto_goTypes = []any{
	...
	(*ReEmitNodeExecutionEventRequest)(nil),   // 19: Superplane.Workflows.ReEmitNodeExecutionEventRequest
	(*ReEmitNodeExecutionEventResponse)(nil),  // 20: Superplane.Workflows.ReEmitNodeExecutionEventResponse
	(*ListNodeQueueItemsRequest)(nil),         // 21: Superplane.Workflows.ListNodeQueueItemsRequest
	(*ListNodeQueueItemsResponse)(nil),        // 22: Superplane.Workflows.ListNodeQueueItemsResponse
	(*DeleteNodeQueueItemRequest)(nil),        // 23: Superplane.Workflows.DeleteNodeQueueItemRequest
	(*DeleteNodeQueueItemResponse)(nil),       // 24: Superplane.Workflows.DeleteNodeQueueItemResponse
	...
	(*WorkflowNodeEventMessage)(nil),          // 38: Superplane.Workflows.WorkflowNodeEventMessage
	(*WorkflowNodeExecutionMessage)(nil),      // 39: Superplane.Workflows.WorkflowNodeExecutionMessage
	(*WorkflowNodeQueueItemMessage)(nil),      // 40: Superplane.Workflows.WorkflowNodeQueueItemMessage
	(*Workflow_Metadata)(nil),                 // 41: Superplane.Workflows.Workflow.Metadata
	(*Workflow_Spec)(nil),                     // 42: Superplane.Workflows.Workflow.Spec
	(*Workflow_Status)(nil),                   // 43: Superplane.Workflows.Workflow.Status
	(*timestamp.Timestamp)(nil),               // 44: google.protobuf.Timestamp
	(*_struct.Struct)(nil),                    // 45: google.protobuf.Struct
	(*components.Node)(nil),                   // 46: Superplane.Components.Node
	(*components.Edge)(nil),                   // 47: Superplane.Components.Edge
}
var file_workflows_proto_depIdxs = []int32{
	...
	41, // 6: Superplane.Workflows.Workflow.metadata:type_name -> Superplane.Workflows.Workflow.Metadata
	42, // 7: Superplane.Workflows.Workflow.spec:type_name -> Superplane.Workflows.Workflow.Spec
	43, // 8: Superplane.Workflows.Workflow.status:type_name -> Superplane.Workflows.Workflow.Status
	44, // 9: Superplane.Workflows.ListNodeEventsRequest.before:type_name -> google.protobuf.Timestamp
	35, // 10: Superplane.Workflows.ListNodeEventsResponse.events:type_name -> Superplane.Workflows.WorkflowEvent
	44, // 11: Superplane.Workflows.ListNodeEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	45, // 12: Superplane.Workflows.EmitNodeEventRequest.data:type_name -> google.protobuf.Struct
	44, // 13: Superplane.Workflows.ListNodeQueueItemsRequest.before:type_name -> google.protobuf.Timestamp
	30, // 14: Superplane.Workflows.ListNodeQueueItemsResponse.items:type_name -> Superplane.Workflows.WorkflowNodeQueueItem
	44, // 15: Superplane.Workflows.ListNodeQueueItemsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	...
	44, // 18: Superplane.Workflows.ListNodeExecutionsRequest.before:type_name -> google.protobuf.Timestamp
	29, // 19: Superplane.Workflows.ListNodeExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	44, // 20: Superplane.Workflows.ListNodeExecutionsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	29, // 21: Superplane.Workflows.ListChildExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	...
	45, // 25: Superplane.Workflows.WorkflowNodeExecution.input:type_name -> google.protobuf.Struct
	45, // 26: Superplane.Workflows.WorkflowNodeExecution.outputs:type_name -> google.protobuf.Struct
	44, // 27: Superplane.Workflows.WorkflowNodeExecution.created_at:type_name -> google.protobuf.Timestamp
	44, // 28: Superplane.Workflows.WorkflowNodeExecution.updated_at:type_name -> google.protobuf.Timestamp
	45, // 29: Superplane.Workflows.WorkflowNodeExecution.metadata:type_name -> google.protobuf.Struct
	45, // 30: Superplane.Workflows.WorkflowNodeExecution.configuration:type_name -> google.protobuf.Struct
	29, // 31: Superplane.Workflows.WorkflowNodeExecution.child_executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	35, // 32: Superplane.Workflows.WorkflowNodeExecution.root_event:type_name -> Superplane.Workflows.WorkflowEvent
	45, // 33: Superplane.Workflows.WorkflowNodeQueueItem.input:type_name -> google.protobuf.Struct
	44, // 34: Superplane.Workflows.WorkflowNodeQueueItem.created_at:type_name -> google.protobuf.Timestamp
	45, // 35: Superplane.Workflows.InvokeNodeExecutionActionRequest.parameters:type_name -> google.protobuf.Struct
	44, // 36: Superplane.Workflows.ListWorkflowEventsRequest.before:type_name -> google.protobuf.Timestamp
	35, // 37: Superplane.Workflows.ListWorkflowEventsResponse.events:type_name -> Superplane.Workflows.WorkflowEvent
	44, // 38: Superplane.Workflows.ListWorkflowEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	45, // 39: Superplane.Workflows.WorkflowEvent.data:type_name -> google.protobuf.Struct
	44, // 40: Superplane.Workflows.WorkflowEvent.created_at:type_name -> google.protobuf.Timestamp
	29, // 41: Superplane.Workflows.ListEventExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	44, // 42: Superplane.Workflows.WorkflowNodeEventMessage.timestamp:type_name -> google.protobuf.Timestamp
	44, // 43: Superplane.Workflows.WorkflowNodeExecutionMessage.timestamp:type_name -> google.protobuf.Timestamp
	44, // 44: Superplane.Workflows.WorkflowNodeQueueItemMessage.timestamp:type_name -> google.protobuf.Timestamp
	44, // 45: Superplane.Workflows.Workflow.Metadata.created_at:type_name -> google.protobuf.Timestamp
	44, // 46: Superplane.Workflows.Workflow.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	13, // 47: Superplane.Workflows.Workflow.Metadata.created_by:type_name -> Superplane.Workflows.UserRef
	46, // 48: Superplane.Workflows.Workflow.Spec.nodes:type_name -> Superplane.Components.Node
	47, // 49: Superplane.Workflows.Workflow.Spec.edges:type_name -> Superplane.Components.Edge
	29, // 50: Superplane.Workflows.Workflow.Status.last_executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	30, // 51: Superplane.Workflows.Workflow.Status.next_queue_items:type_name -> Superplane.Workflows.WorkflowNodeQueueItem
	35, // 52: Superplane.Workflows.Workflow.Status.last_events:type_name -> Superplane.Workflows.WorkflowEvent
	...
	21, // 58: Superplane.Workflows.Workflows.ListNodeQueueItems:input_type -> Superplane.Workflows.ListNodeQueueItemsRequest
	23, // 59: Superplane.Workflows.Workflows.DeleteNodeQueueItem:input_type -> Superplane.Workflows.DeleteNodeQueueItemRequest
	25, // 60: Superplane.Workflows.Workflows.ListNodeExecutions:input_type -> Superplane.Workflows.ListNodeExecutionsRequest
	...
	31, // 63: Superplane.Workflows.Workflows.InvokeNodeExecutionAction:input_type -> Superplane.Workflows.InvokeNodeExecutionActionRequest
	27, // 64: Superplane.Workflows.Workflows.ListChildExecutions:input_type -> Superplane.Workflows.ListChildExecutionsRequest
	33, // 65: Superplane.Workflows.Workflows.ListWorkflowEvents:input_type -> Superplane.Workflows.ListWorkflowEventsRequest
	36, // 66: Superplane.Workflows.Workflows.ListEventExecutions:input_type -> Superplane.Workflows.ListEventExecutionsRequest
	19, // 67: Superplane.Workflows.Workflows.ReEmitNodeExecutionEvent:input_type -> Superplane.Workflows.ReEmitNodeExecutionEventRequest
	4,  // 68: Superplane.Workflows.Workflows.ListWorkflows:output_type -> Superplane.Workflows.ListWorkflowsResponse
	8,  // 69: Superplane.Workflows.Workflows.CreateWorkflow:output_type -> Superplane.Workflows.CreateWorkflowResponse
	6,  // 70: Superplane.Workflows.Workflows.DescribeWorkflow:output_type -> Superplane.Workflows.DescribeWorkflowResponse
	10, // 71: Superplane.Workflows.Workflows.UpdateWorkflow:output_type -> Superplane.Workflows.UpdateWorkflowResponse
	12, // 72: Superplane.Workflows.Workflows.DeleteWorkflow:output_type -> Superplane.Workflows.DeleteWorkflowResponse
	22, // 73: Superplane.Workflows.Workflows.ListNodeQueueItems:output_type -> Superplane.Workflows.ListNodeQueueItemsResponse
	24, // 74: Superplane.Workflows.Workflows.DeleteNodeQueueItem:output_type -> Superplane.Workflows.DeleteNodeQueueItemResponse
	26, // 75: Superplane.Workflows.Workflows.ListNodeExecutions:output_type -> Superplane.Workflows.ListNodeExecutionsResponse
	16, // 76: Superplane.Workflows.Workflows.ListNodeEvents:output_type -> Superplane.Workflows.ListNodeEventsResponse
	18, // 77: Superplane.Workflows.Workflows.EmitNodeEvent:output_type -> Superplane.Workflows.EmitNodeEventResponse
	32, // 78: Superplane.Workflows.Workflows.InvokeNodeExecutionAction:output_type -> Superplane.Workflows.InvokeNodeExecutionActionResponse
	28, // 79: Superplane.Workflows.Workflows.ListChildExecutions:output_type -> Superplane.Workflows.ListChildExecutionsResponse
	34, // 80: Superplane.Workflows.Workflows.ListWorkflowEvents:output_type -> Superplane.Workflows.ListWorkflowEventsResponse
	37, // 81: Superplane.Workflows.Workflows.ListEventExecutions:output_type -> Superplane.Workflows.ListEventExecutionsResponse
	20, // 82: Superplane.Workflows.Workflows.ReEmitNodeExecutionEvent:output_type -> Superplane.Workflows.ReEmitNodeExecutionEventResponse
