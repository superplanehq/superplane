...
func (WorkflowNodeExecution_State) EnumDescriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{26, 0}
}
...
func (WorkflowNodeExecution_Result) EnumDescriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{26, 1}
}
...
const (
	...
	WorkflowNodeExecution_RESULT_REASON_ERROR_RESOLVED WorkflowNodeExecution_ResultReason = 2
)
...
func (WorkflowNodeExecution_ResultReason) EnumDescriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{26, 2}
}
...
func (x *UpdateNodePauseRequest) GetWorkflowId() string {
	if x != nil {
		return x.WorkflowId
	}
	return ""
...
func (x *WorkflowNodeExecution) GetCancelledBy() *UserRef {
	if x != nil {
...
func (x *ListWorkflowEventsResponse) GetEvents() []*WorkflowEventWithExecutions {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *WorkflowEventWithExecutions) ProtoReflect() protoreflect.Message {
	mi := &file_workflows_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *WorkflowEventWithExecutions) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *WorkflowEventWithExecutions) GetData() *_struct.Struct {
	if x != nil {
		return x.Data
	}
	return nil
...
func (*ListEventExecutionsRequest) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{36}
}
...
func (*ListEventExecutionsResponse) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{37}
}
...
func (*CancelExecutionRequest) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{38}
}
...
func (x *CancelExecutionResponse) Reset() {
	*x = CancelExecutionResponse{}
	mi := &file_workflows_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CancelExecutionResponse) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{39}
}
...
func (x *ResolveExecutionErrorsRequest) Reset() {
	*x = ResolveExecutionErrorsRequest{}
	mi := &file_workflows_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveExecutionErrorsRequest) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{40}
}

func (x *ResolveExecutionErrorsRequest) GetWorkflowId() string {
	if x != nil {
		return x.WorkflowId
	}
	return ""
...
func (x *ResolveExecutionErrorsResponse) Reset() {
	*x = ResolveExecutionErrorsResponse{}
	mi := &file_workflows_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveExecutionErrorsResponse) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{41}
}
...
func (x *WorkflowNodeEventMessage) Reset() {
	*x = WorkflowNodeEventMessage{}
	mi := &file_workflows_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowNodeEventMessage) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{42}
}
...
func (x *WorkflowNodeExecutionMessage) Reset() {
	*x = WorkflowNodeExecutionMessage{}
	mi := &file_workflows_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WorkflowNodeExecutionMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkflowNodeExecutionMessage) ProtoMessage() {}

func (x *WorkflowNodeExecutionMessage) ProtoReflect() protoreflect.Message {
	mi := &file_workflows_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*WorkflowNodeExecutionMessage) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{43}
}

func (x *WorkflowNodeExecutionMessage) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *WorkflowNodeExecutionMessage) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *WorkflowNodeQueueItemMessage) Reset() {
	*x = WorkflowNodeQueueItemMessage{}
	mi := &file_workflows_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkflowNodeQueueItemMessage) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{44}
}
...
func (x *Workflow_Metadata) Reset() {
	*x = Workflow_Metadata{}
	mi := &file_workflows_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Workflow_Spec) Reset() {
	*x = Workflow_Spec{}
	mi := &file_workflows_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Workflow_Status) Reset() {
	*x = Workflow_Status{}
	mi := &file_workflows_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Workflow_Status) Descriptor() ([]byte, []int) {
	return file_workflows_proto_rawDescGZIP(), []int{11, 2}
}
...
const file_workflows_proto_rawDesc = "" +
	...
	"\x06Status\x12T\n" +
	"\x0flast_executions\x18\x01 \x03(\v2+.Superplane.Workflows.WorkflowNodeExecutionR\x0elastExecutions\x12U\n" +
	"\x10next_queue_items\x18\x02 \x03(\v2+.Superplane.Workflows.WorkflowNodeQueueItemR\x0enextQueueItems\x12D\n" +
	"\vlast_events\x18\x03 \x03(\v2#.Superplane.Workflows.WorkflowEventR\n" +
	"lastEvents\"\x9b\x01\n" +
	...
	"totalCount\x12\"\n" +
	"\rhas_next_page\x18\x03 \x01(\bR\vhasNextPage\x12A\n" +
	"\x0elast_timestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\rlastTimestamp\"o\n" +
	"\x1aDeleteNodeQueueItemRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12\x17\n" +
	"\aitem_id\x18\x03 \x01(\tR\x06itemId\"\x1d\n" +
	"\x1bDeleteNodeQueueItemResponse\"j\n" +
	"\x16UpdateNodePauseRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12\x16\n" +
	"\x06paused\x18\x03 \x01(\bR\x06paused\"J\n" +
	"\x17UpdateNodePauseResponse\x12/\n" +
	"\x04node\x18\x01 \x01(\v2\x1b.Superplane.Components.NodeR\x04node\"\xb8\x02\n" +
	...
	"\n" +
	"root_event\x18\x11 \x01(\v2#.Superplane.Workflows.WorkflowEventR\trootEvent\x12@\n" +
	"\fcancelled_by\x18\x12 \x01(\v2\x1d.Superplane.Workflows.UserRefR\vcancelledBy\"T\n" +
	"\x05State\x12\x11\n" +
	...
	"\x1cRESULT_REASON_ERROR_RESOLVED\x10\x02\"\x8f\x02\n" +
	"\x15WorkflowNodeQueueItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vworkflow_id\x18\x02 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x12-\n" +
	"\x05input\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x05input\x12B\n" +
	"\n" +
	"root_event\x18\x05 \x01(\v2#.Superplane.Workflows.WorkflowEventR\trootEvent\x129\n" +
	"\n" +
	...
	"parameters\"#\n" +
	"!InvokeNodeExecutionActionResponse\"\xb4\x01\n" +
	"\x1eInvokeNodeTriggerActionRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	...
	"\x06before\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x06before\"\xef\x01\n" +
	"\x1aListWorkflowEventsResponse\x12I\n" +
	"\x06events\x18\x01 \x03(\v21.Superplane.Workflows.WorkflowEventWithExecutionsR\x06events\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\rR\n" +
	"totalCount\x12\"\n" +
	"\rhas_next_page\x18\x03 \x01(\bR\vhasNextPage\x12A\n" +
	...
	"executions\x18\x01 \x03(\v2+.Superplane.Workflows.WorkflowNodeExecutionR\n" +
	"executions\"\\\n" +
	"\x16CancelExecutionRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12!\n" +
	"\fexecution_id\x18\x02 \x01(\tR\vexecutionId\"\x19\n" +
	"\x17CancelExecutionResponse\"e\n" +
	"\x1dResolveExecutionErrorsRequest\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\x12#\n" +
	"\rexecution_ids\x18\x02 \x03(\tR\fexecutionIds\" \n" +
	"\x1eResolveExecutionErrorsResponse\"\x9e\x01\n" +
	"\x18WorkflowNodeEventMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vworkflow_id\x18\x02 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x128\n" +
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"\xa2\x01\n" +
	"\x1cWorkflowNodeExecutionMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vworkflow_id\x18\x02 \x01(\tR\n" +
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x128\n" +
	...
	"workflowId\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x128\n" +
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xf5%\n" +
	...
	"\fWorkflowNode\x12\x1cList items in a node's queue\x1a)Returns a list of items in a node's queue\x82\xd3\xe4\x93\x027\x125/api/v1/workflows/{workflow_id}/nodes/{node_id}/queue\x12\xa1\x02\n" +
	"\x13DeleteNodeQueueItem\x120.Superplane.Workflows.DeleteNodeQueueItemRequest\x1a1.Superplane.Workflows.DeleteNodeQueueItemResponse\"\xa4\x01\x92AZ\n" +
	"\fWorkflowNode\x12\x1fDelete item from a node's queue\x1a)Deletes a specific item in a node's queue\x82\xd3\xe4\x93\x02A*?/api/v1/workflows/{workflow_id}/nodes/{node_id}/queue/{item_id}\x12\xbf\x02\n" +
	"\x0fUpdateNodePause\x12,.Superplane.Workflows.UpdateNodePauseRequest\x1a-.Superplane.Workflows.UpdateNodePauseResponse\"\xce\x01\x92A\x8a\x01\n" +
	"\fWorkflowNode\x12\x1fPause or resume node processing\x1aYPauses or resumes processing for a workflow node while continuing to queue incoming items\x82\xd3\xe4\x93\x02::\x01*25/api/v1/workflows/{workflow_id}/nodes/{node_id}/pause\x12\x9e\x02\n" +
	...
	"\x15WorkflowNodeExecution\x12\x17Invoke execution action\x1a4Invokes a custom action on a workflow node execution\x82\xd3\xe4\x93\x02T:\x01*\"O/api/v1/workflows/{workflow_id}/executions/{execution_id}/actions/{action_name}\x12\xb8\x02\n" +
	"\x17InvokeNodeTriggerAction\x124.Superplane.Workflows.InvokeNodeTriggerActionRequest\x1a5.Superplane.Workflows.InvokeNodeTriggerActionResponse\"\xaf\x01\x92AY\n" +
	"\fWorkflowNode\x12\x15Invoke trigger action\x1a2Invokes a custom action on a workflow node trigger\x82\xd3\xe4\x93\x02M:\x01*\"H/api/v1/workflows/{workflow_id}/triggers/{node_id}/actions/{action_name}\x12\xb4\x02\n" +
	...
	"\x15WorkflowNodeExecution\x12&List child executions for an execution\x1a&List child executions for an execution\x82\xd3\xe4\x93\x02G:\x01*\"B/api/v1/workflows/{workflow_id}/executions/{execution_id}/children\x12\x93\x02\n" +
	"\x0fCancelExecution\x12,.Superplane.Workflows.CancelExecutionRequest\x1a-.Superplane.Workflows.CancelExecutionResponse\"\xa2\x01\x92AT\n" +
	"\x15WorkflowNodeExecution\x12\x10Cancel execution\x1a)Cancels a running workflow node execution\x82\xd3\xe4\x93\x02E:\x01*2@/api/v1/workflows/{workflow_id}/executions/{execution_id}/cancel\x12\xa9\x02\n" +
	"\x16ResolveExecutionErrors\x123.Superplane.Workflows.ResolveExecutionErrorsRequest\x1a4.Superplane.Workflows.ResolveExecutionErrorsResponse\"\xa3\x01\x92Ac\n" +
	"\x15WorkflowNodeExecution\x12\x18Resolve execution errors\x1a0Marks workflow node execution errors as resolved\x82\xd3\xe4\x93\x027:\x01*22/api/v1/workflows/{workflow_id}/executions/resolve\x12\x97\x02\n" +
...
var file_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_workflows_proto_goTypes = []any{
	...
	(*DeleteNodeQueueItemRequest)(nil),        // 21: Superplane.Workflows.DeleteNodeQueueItemRequest
	(*DeleteNodeQueueItemResponse)(nil),       // 22: Superplane.Workflows.DeleteNodeQueueItemResponse
	(*UpdateNodePauseRequest)(nil),            // 23: Superplane.Workflows.UpdateNodePauseRequest
	(*UpdateNodePauseResponse)(nil),           // 24: Superplane.Workflows.UpdateNodePauseResponse
	(*ListNodeExecutionsRequest)(nil),         // 25: Superplane.Workflows.ListNodeExecutionsRequest
	(*ListNodeExecutionsResponse)(nil),        // 26: Superplane.Workflows.ListNodeExecutionsResponse
	(*ListChildExecutionsRequest)(nil),        // 27: Superplane.Workflows.ListChildExecutionsRequest
	(*ListChildExecutionsResponse)(nil),       // 28: Superplane.Workflows.ListChildExecutionsResponse
	(*WorkflowNodeExecution)(nil),             // 29: Superplane.Workflows.WorkflowNodeExecution
	(*WorkflowNodeQueueItem)(nil),             // 30: Superplane.Workflows.WorkflowNodeQueueItem
	(*InvokeNodeExecutionActionRequest)(nil),  // 31: Superplane.Workflows.InvokeNodeExecutionActionRequest
	(*InvokeNodeExecutionActionResponse)(nil), // 32: Superplane.Workflows.InvokeNodeExecutionActionResponse
	(*InvokeNodeTriggerActionRequest)(nil),    // 33: Superplane.Workflows.InvokeNodeTriggerActionRequest
	(*InvokeNodeTriggerActionResponse)(nil),   // 34: Superplane.Workflows.InvokeNodeTriggerActionResponse
	(*ListWorkflowEventsRequest)(nil),         // 35: Superplane.Workflows.ListWorkflowEventsRequest
	(*ListWorkflowEventsResponse)(nil),        // 36: Superplane.Workflows.ListWorkflowEventsResponse
	(*WorkflowEvent)(nil),                     // 37: Superplane.Workflows.WorkflowEvent
	(*WorkflowEventWithExecutions)(nil),       // 38: Superplane.Workflows.WorkflowEventWithExecutions
	(*ListEventExecutionsRequest)(nil),        // 39: Superplane.Workflows.ListEventExecutionsRequest
	(*ListEventExecutionsResponse)(nil),       // 40: Superplane.Workflows.ListEventExecutionsResponse
	(*CancelExecutionRequest)(nil),            // 41: Superplane.Workflows.CancelExecutionRequest
	(*CancelExecutionResponse)(nil),           // 42: Superplane.Workflows.CancelExecutionResponse
	(*ResolveExecutionErrorsRequest)(nil),     // 43: Superplane.Workflows.ResolveExecutionErrorsRequest
	(*ResolveExecutionErrorsResponse)(nil),    // 44: Superplane.Workflows.ResolveExecutionErrorsResponse
	(*WorkflowNodeEventMessage)(nil),          // 45: Superplane.Workflows.WorkflowNodeEventMessage
	(*WorkflowNodeExecutionMessage)(nil),      // 46: Superplane.Workflows.WorkflowNodeExecutionMessage
	(*WorkflowNodeQueueItemMessage)(nil),      // 47: Superplane.Workflows.WorkflowNodeQueueItemMessage
	(*Workflow_Metadata)(nil),                 // 48: Superplane.Workflows.Workflow.Metadata
	(*Workflow_Spec)(nil),                     // 49: Superplane.Workflows.Workflow.Spec
	(*Workflow_Status)(nil),                   // 50: Superplane.Workflows.Workflow.Status
...
var file_workflows_proto_depIdxs = []int32{
	...
	48, // 6: Superplane.Workflows.Workflow.metadata:type_name -> Superplane.Workflows.Workflow.Metadata
	49, // 7: Superplane.Workflows.Workflow.spec:type_name -> Superplane.Workflows.Workflow.Spec
	50, // 8: Superplane.Workflows.Workflow.status:type_name -> Superplane.Workflows.Workflow.Status
	51, // 9: Superplane.Workflows.ListNodeEventsRequest.before:type_name -> google.protobuf.Timestamp
	37, // 10: Superplane.Workflows.ListNodeEventsResponse.events:type_name -> Superplane.Workflows.WorkflowEvent
	51, // 11: Superplane.Workflows.ListNodeEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	52, // 12: Superplane.Workflows.EmitNodeEventRequest.data:type_name -> google.protobuf.Struct
	51, // 13: Superplane.Workflows.ListNodeQueueItemsRequest.before:type_name -> google.protobuf.Timestamp
	30, // 14: Superplane.Workflows.ListNodeQueueItemsResponse.items:type_name -> Superplane.Workflows.WorkflowNodeQueueItem
	51, // 15: Superplane.Workflows.ListNodeQueueItemsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	53, // 16: Superplane.Workflows.UpdateNodePauseResponse.node:type_name -> Superplane.Components.Node
	0,  // 17: Superplane.Workflows.ListNodeExecutionsRequest.states:type_name -> Superplane.Workflows.WorkflowNodeExecution.State
	1,  // 18: Superplane.Workflows.ListNodeExecutionsRequest.results:type_name -> Superplane.Workflows.WorkflowNodeExecution.Result
	51, // 19: Superplane.Workflows.ListNodeExecutionsRequest.before:type_name -> google.protobuf.Timestamp
	29, // 20: Superplane.Workflows.ListNodeExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	51, // 21: Superplane.Workflows.ListNodeExecutionsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	29, // 22: Superplane.Workflows.ListChildExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	0,  // 23: Superplane.Workflows.WorkflowNodeExecution.state:type_name -> Superplane.Workflows.WorkflowNodeExecution.State
	1,  // 24: Superplane.Workflows.WorkflowNodeExecution.result:type_name -> Superplane.Workflows.WorkflowNodeExecution.Result
	2,  // 25: Superplane.Workflows.WorkflowNodeExecution.result_reason:type_name -> Superplane.Workflows.WorkflowNodeExecution.ResultReason
	52, // 26: Superplane.Workflows.WorkflowNodeExecution.input:type_name -> google.protobuf.Struct
	52, // 27: Superplane.Workflows.WorkflowNodeExecution.outputs:type_name -> google.protobuf.Struct
	51, // 28: Superplane.Workflows.WorkflowNodeExecution.created_at:type_name -> google.protobuf.Timestamp
	51, // 29: Superplane.Workflows.WorkflowNodeExecution.updated_at:type_name -> google.protobuf.Timestamp
	52, // 30: Superplane.Workflows.WorkflowNodeExecution.metadata:type_name -> google.protobuf.Struct
	52, // 31: Superplane.Workflows.WorkflowNodeExecution.configuration:type_name -> google.protobuf.Struct
	29, // 32: Superplane.Workflows.WorkflowNodeExecution.child_executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	37, // 33: Superplane.Workflows.WorkflowNodeExecution.root_event:type_name -> Superplane.Workflows.WorkflowEvent
	13, // 34: Superplane.Workflows.WorkflowNodeExecution.cancelled_by:type_name -> Superplane.Workflows.UserRef
	52, // 35: Superplane.Workflows.WorkflowNodeQueueItem.input:type_name -> google.protobuf.Struct
	37, // 36: Superplane.Workflows.WorkflowNodeQueueItem.root_event:type_name -> Superplane.Workflows.WorkflowEvent
	51, // 37: Superplane.Workflows.WorkflowNodeQueueItem.created_at:type_name -> google.protobuf.Timestamp
	52, // 38: Superplane.Workflows.InvokeNodeExecutionActionRequest.parameters:type_name -> google.protobuf.Struct
	52, // 39: Superplane.Workflows.InvokeNodeTriggerActionRequest.parameters:type_name -> google.protobuf.Struct
	52, // 40: Superplane.Workflows.InvokeNodeTriggerActionResponse.result:type_name -> google.protobuf.Struct
	51, // 41: Superplane.Workflows.ListWorkflowEventsRequest.before:type_name -> google.protobuf.Timestamp
	38, // 42: Superplane.Workflows.ListWorkflowEventsResponse.events:type_name -> Superplane.Workflows.WorkflowEventWithExecutions
	51, // 43: Superplane.Workflows.ListWorkflowEventsResponse.last_timestamp:type_name -> google.protobuf.Timestamp
	52, // 44: Superplane.Workflows.WorkflowEvent.data:type_name -> google.protobuf.Struct
	51, // 45: Superplane.Workflows.WorkflowEvent.created_at:type_name -> google.protobuf.Timestamp
	52, // 46: Superplane.Workflows.WorkflowEventWithExecutions.data:type_name -> google.protobuf.Struct
	51, // 47: Superplane.Workflows.WorkflowEventWithExecutions.created_at:type_name -> google.protobuf.Timestamp
	29, // 48: Superplane.Workflows.WorkflowEventWithExecutions.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	29, // 49: Superplane.Workflows.ListEventExecutionsResponse.executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	51, // 50: Superplane.Workflows.WorkflowNodeEventMessage.timestamp:type_name -> google.protobuf.Timestamp
	51, // 51: Superplane.Workflows.WorkflowNodeExecutionMessage.timestamp:type_name -> google.protobuf.Timestamp
	51, // 52: Superplane.Workflows.WorkflowNodeQueueItemMessage.timestamp:type_name -> google.protobuf.Timestamp
	51, // 53: Superplane.Workflows.Workflow.Metadata.created_at:type_name -> google.protobuf.Timestamp
	51, // 54: Superplane.Workflows.Workflow.Metadata.updated_at:type_name -> google.protobuf.Timestamp
	13, // 55: Superplane.Workflows.Workflow.Metadata.created_by:type_name -> Superplane.Workflows.UserRef
	53, // 56: Superplane.Workflows.Workflow.Spec.nodes:type_name -> Superplane.Components.Node
	54, // 57: Superplane.Workflows.Workflow.Spec.edges:type_name -> Superplane.Components.Edge
	29, // 58: Superplane.Workflows.Workflow.Status.last_executions:type_name -> Superplane.Workflows.WorkflowNodeExecution
	30, // 59: Superplane.Workflows.Workflow.Status.next_queue_items:type_name -> Superplane.Workflows.WorkflowNodeQueueItem
	37, // 60: Superplane.Workflows.Workflow.Status.last_events:type_name -> Superplane.Workflows.WorkflowEvent
	3,  // 61: Superplane.Workflows.Workflows.ListWorkflows:input_type -> Superplane.Workflows.ListWorkflowsRequest
	7,  // 62: Superplane.Workflows.Workflows.CreateWorkflow:input_type -> Superplane.Workflows.CreateWorkflowRequest
	5,  // 63: Superplane.Workflows.Workflows.DescribeWorkflow:input_type -> Superplane.Workflows.DescribeWorkflowRequest
	9,  // 64: Superplane.Workflows.Workflows.UpdateWorkflow:input_type -> Superplane.Workflows.UpdateWorkflowRequest
	11, // 65: Superplane.Workflows.Workflows.DeleteWorkflow:input_type -> Superplane.Workflows.DeleteWorkflowRequest
	19, // 66: Superplane.Workflows.Workflows.ListNodeQueueItems:input_type -> Superplane.Workflows.ListNodeQueueItemsRequest
	21, // 67: Superplane.Workflows.Workflows.DeleteNodeQueueItem:input_type -> Superplane.Workflows.DeleteNodeQueueItemRequest
	23, // 68: Superplane.Workflows.Workflows.UpdateNodePause:input_type -> Superplane.Workflows.UpdateNodePauseRequest
	25, // 69: Superplane.Workflows.Workflows.ListNodeExecutions:input_type -> Superplane.Workflows.ListNodeExecutionsRequest
	15, // 70: Superplane.Workflows.Workflows.ListNodeEvents:input_type -> Superplane.Workflows.ListNodeEventsRequest
	17, // 71: Superplane.Workflows.Workflows.EmitNodeEvent:input_type -> Superplane.Workflows.EmitNodeEventRequest
	31, // 72: Superplane.Workflows.Workflows.InvokeNodeExecutionAction:input_type -> Superplane.Workflows.InvokeNodeExecutionActionRequest
	33, // 73: Superplane.Workflows.Workflows.InvokeNodeTriggerAction:input_type -> Superplane.Workflows.InvokeNodeTriggerActionRequest
	27, // 74: Superplane.Workflows.Workflows.ListChildExecutions:input_type -> Superplane.Workflows.ListChildExecutionsRequest
	41, // 75: Superplane.Workflows.Workflows.CancelExecution:input_type -> Superplane.Workflows.CancelExecutionRequest
	43, // 76: Superplane.Workflows.Workflows.ResolveExecutionErrors:input_type -> Superplane.Workflows.ResolveExecutionErrorsRequest
	35, // 77: Superplane.Workflows.Workflows.ListWorkflowEvents:input_type -> Superplane.Workflows.ListWorkflowEventsRequest
	39, // 78: Superplane.Workflows.Workflows.ListEventExecutions:input_type -> Superplane.Workflows.ListEventExecutionsRequest
	4,  // 79: Superplane.Workflows.Workflows.ListWorkflows:output_type -> Superplane.Workflows.ListWorkflowsResponse
	8,  // 80: Superplane.Workflows.Workflows.CreateWorkflow:output_type -> Superplane.Workflows.CreateWorkflowResponse
	6,  // 81: Superplane.Workflows.Workflows.DescribeWorkflow:output_type -> Superplane.Workflows.DescribeWorkflowResponse
	10, // 82: Superplane.Workflows.Workflows.UpdateWorkflow:output_type -> Superplane.Workflows.UpdateWorkflowResponse
	12, // 83: Superplane.Workflows.Workflows.DeleteWorkflow:output_type -> Superplane.Workflows.DeleteWorkflowResponse
	20, // 84: Superplane.Workflows.Workflows.ListNodeQueueItems:output_type -> Superplane.Workflows.ListNodeQueueItemsResponse
	22, // 85: Superplane.Workflows.Workflows.DeleteNodeQueueItem:output_type -> Superplane.Workflows.DeleteNodeQueueItemResponse
	24, // 86: Superplane.Workflows.Workflows.UpdateNodePause:output_type -> Superplane.Workflows.UpdateNodePauseResponse
	26, // 87: Superplane.Workflows.Workflows.ListNodeExecutions:output_type -> Superplane.Workflows.ListNodeExecutionsResponse
	16, // 88: Superplane.Workflows.Workflows.ListNodeEvents:output_type -> Superplane.Workflows.ListNodeEventsResponse
	18, // 89: Superplane.Workflows.Workflows.EmitNodeEvent:output_type -> Superplane.Workflows.EmitNodeEventResponse
	32, // 90: Superplane.Workflows.Workflows.InvokeNodeExecutionAction:output_type -> Superplane.Workflows.InvokeNodeExecutionActionResponse
	34, // 91: Superplane.Workflows.Workflows.InvokeNodeTriggerAction:output_type -> Superplane.Workflows.InvokeNodeTriggerActionResponse
	28, // 92: Superplane.Workflows.Workflows.ListChildExecutions:output_type -> Superplane.Workflows.ListChildExecutionsResponse
	42, // 93: Superplane.Workflows.Workflows.CancelExecution:output_type -> Superplane.Workflows.CancelExecutionResponse
	44, // 94: Superplane.Workflows.Workflows.ResolveExecutionErrors:output_type -> Superplane.Workflows.ResolveExecutionErrorsResponse
	36, // 95: Superplane.Workflows.Workflows.ListWorkflowEvents:output_type -> Superplane.Workflows.ListWorkflowEventsResponse
	40, // 96: Superplane.Workflows.Workflows.ListEventExecutions:output_type -> Superplane.Workflows.ListEventExecutionsResponse
