...
- For direct canvas edits, prefer the shortest reliable path: read the draft canvas, list integrations only if integration IDs are needed, make the draft update, then report the result.
