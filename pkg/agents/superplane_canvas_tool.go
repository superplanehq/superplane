...
func (t *SuperPlaneCanvasTool) ExecuteCustomTool(ctx context.Context, session AgentSessionContext, toolUse CustomToolUse) CustomToolResult {
...
func (t *SuperPlaneCanvasTool) validateSessionBoundInput(session AgentSessionContext, requestedCanvasID string) error {
...
func (t *SuperPlaneCanvasTool) read(ctx context.Context, session AgentSessionContext, input superPlaneCanvasToolInput) (superPlaneCanvasReadResult, error) {
...
func (t *SuperPlaneCanvasTool) updateDraft(ctx context.Context, session AgentSessionContext, input superPlaneCanvasToolInput) (superPlaneCanvasUpdateResult, error) {
...
func (t *SuperPlaneCanvasTool) listIntegrations(session AgentSessionContext) (superPlaneCanvasIntegrationsResult, error) {
