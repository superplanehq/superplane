...
type RepoSnapshot struct {
	...
	Nodes                   []models.Node
	Edges                   []models.Edge
	ConsolePanels           []models.DashboardPanel
	ConsoleLayout           []models.DashboardLayoutItem
}
...
func LoadRepoSnapshot(
	...
	pbCanvas, err := canvasyaml.ParseCanvasYAML(canvasYAML)
	if err != nil {
	...
	console, err := models.DashboardFromYML(consoleYAML)
	if err != nil {
