...
func BuildConsoleYAMLFromDashboard(dashboard *models.DashboardYAML) ([]byte, error) {
	if dashboard == nil {
...
func BuildEmptyConsoleYAML(canvasID, canvasName string) ([]byte, error) {
	...
	dashboard := &models.CanvasDashboard{
		CanvasID: canvasUUID,
	}
	return models.DashboardToYML(dashboard, canvasName)
}
...
func BuildConsoleYAMLFromVersion(version *models.CanvasVersion) ([]byte, error) {
	...
	return models.DashboardToYML(models.CanvasDashboardFromVersion(version), version.Name)
}
