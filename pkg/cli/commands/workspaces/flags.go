...
func BindNameFlag(cmd *cobra.Command, dest *string) {
	cmd.Flags().StringVar(dest, "workspace", "", "workspace key or UUID (default: active workspace)")
	cmd.Flags().StringVar(dest, "factory", "", "workspace key or UUID (default: active workspace)")
