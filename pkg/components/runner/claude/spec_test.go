...
func TestBuildClaudeCodeBrokerTaskRunsOrderedSteps(t *testing.T) {
	...
	assert.Contains(t, runScript, "mcp__superplane__propose_plan")
	assert.NotContains(t, runScript, "mcp__superplane__propose_spec")
	assert.NotContains(t, runScript, "mcp__superplane__propose_confidence")
