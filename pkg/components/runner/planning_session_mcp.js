...
const TOOLS = [
  {
    name: "propose_spec",
    description:
      "Publish the full spec.md markdown for the open task. Include the title, Executive summary, and plan. Do not change the original request. Call this after you write the specification.",
    inputSchema: {
      type: "object",
      properties: {
        body: { type: "string" },
        ...
        questions: {
          ...
          items: {
            ...
            properties: {
              prompt: {
                type: "string",
                description: "The question shown to the person.",
              },
              options: {
                type: "array",
                description: "Two to four answer strings.",
                items: { type: "string" },
              },
            },
