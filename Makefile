...
# Agent tests (removed — agent/ directory deleted, replaced by pkg/agents/)
test.agent.evals:
	@echo "Agent evals removed — agent/ no longer exists"

test.agent.setup:
	@echo "Agent setup removed — agent/ no longer exists"

test.agent.unit:
	@echo "Agent unit tests moved to Go: go test ./pkg/agents/"
...
# dev.setup.agent removed — agent/ directory deleted
...
# gen.setup.agent removed — agent/ directory deleted
...
# openapi.python.client.gen removed — agent/ directory deleted
...
# agent.image.build removed — agent/ directory deleted
...
# agent.image.push removed — agent/ directory deleted
