...
MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles,me,components,blueprints,workflows
REST_API_MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles,me,components,blueprints,workflows
pb.gen:
