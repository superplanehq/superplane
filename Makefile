...
#
GOTESTSUM=$(COMPOSE) run --rm -e DB_NAME=superplane_test -e TASK_BROKER_BASE_URL= -e TASK_BROKER_FLEET_ID= -e TASK_BROKER_PUBLIC_URL= -v $(PWD)/tmp/screenshots:/app/test/screenshots app gotestsum --format short --junitfile junit-report.xml 
