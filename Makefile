...
MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles,me,manifests
REST_API_MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles,me,manifests
pb.gen:
