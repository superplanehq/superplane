...
MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles
REST_API_MODULES := authorization,organizations,secrets,integrations,canvases,users,groups,roles
pb.gen:
