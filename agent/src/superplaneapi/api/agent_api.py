...
class AgentApi:
    ...
    def _agents_create_agent_chat_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agents/builder/chats',
    ...
    def _agents_describe_agent_chat_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/agents/builder/chats/{chatId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _agents_list_agent_chat_messages_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/agents/builder/chats/{chatId}/messages',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def agents_prepare_config_assistant_suggest(
        self,
        ...
        :param body: (required)
        :type body: AgentsPrepareConfigAssistantSuggestRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._agents_prepare_config_assistant_suggest_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def agents_prepare_config_assistant_suggest_with_http_info(
        self,
        body: AgentsPrepareConfigAssistantSuggestRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentsPrepareConfigAssistantSuggestResponse]:
        """Prepare config assistant field suggest
    ...
    @validate_call
    def agents_prepare_config_assistant_suggest_without_preload_content(
        self,
        body: AgentsPrepareConfigAssistantSuggestRequest,
        _request_timeout: Union[
            None,
    ...
    def _agents_prepare_config_assistant_suggest_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agents/config/prepare-suggest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _agents_resume_agent_chat_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agents/builder/chats/{chatId}/resume',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
