...
class AgentApi:
    ...
    @validate_call
    def agents_suggest_configuration_field(
        self,
        ...
        :param body: (required)
        :type body: AgentsSuggestConfigurationFieldRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._agents_suggest_configuration_field_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def agents_suggest_configuration_field_with_http_info(
        self,
        body: AgentsSuggestConfigurationFieldRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentsSuggestConfigurationFieldResponse]:
        """Suggest a value for a configuration field
    ...
    @validate_call
    def agents_suggest_configuration_field_without_preload_content(
        self,
        body: AgentsSuggestConfigurationFieldRequest,
        _request_timeout: Union[
            None,
    ...
    def _agents_suggest_configuration_field_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agents/config/suggest-field',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
