...
class AgentApi:
    ...
    @validate_call
    def agents_generate_agent_chat_token(
        self,
        ...
        :param body: (required)
        :type body: AgentsGenerateAgentChatTokenRequest
        ...
        _param = self._agents_generate_agent_chat_token_serialize(
            body=body,
    ...
    @validate_call
    def agents_generate_agent_chat_token_with_http_info(
        self,
        body: AgentsGenerateAgentChatTokenRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentsGenerateAgentChatTokenResponse]:
        """Generates a new token for an agent chat
    ...
    @validate_call
    def agents_generate_agent_chat_token_without_preload_content(
        self,
        body: AgentsGenerateAgentChatTokenRequest,
        _request_timeout: Union[
            None,
    ...
    def _agents_generate_agent_chat_token_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/agents/chat/tokens',
