...
class MeApi:
    ...
    def me_regenerate_token(
        ...
        _param = self._me_regenerate_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def me_regenerate_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MeRegenerateTokenResponse]:
        """Regenerate API token
    ...
    @validate_call
    def me_regenerate_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _me_regenerate_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
