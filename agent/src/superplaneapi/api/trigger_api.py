...
class TriggerApi:
    ...
    def triggers_describe_trigger(
        ...
        _param = self._triggers_describe_trigger_serialize(
            name=name,
    ...
    @validate_call
    def triggers_describe_trigger_with_http_info(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TriggersDescribeTriggerResponse]:
        """Describe trigger
    ...
    @validate_call
    def triggers_describe_trigger_without_preload_content(
        self,
        name: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _triggers_describe_trigger_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def triggers_list_triggers(
        ...
        _param = self._triggers_list_triggers_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def triggers_list_triggers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TriggersListTriggersResponse]:
        """List triggers
    ...
    @validate_call
    def triggers_list_triggers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _triggers_list_triggers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
