...
with superplaneapi.ApiClient(configuration) as api_client:
    ...
    api_instance = superplaneapi.ActionApi(api_client)
    name = 'name_example' # str | 

    try:
        # Describe action
        api_response = api_instance.actions_describe_action(name)
        print("The response of ActionApi->actions_describe_action:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ActionApi->actions_describe_action: %s\n" % e)
...
------------ | ------------- | ------------- | -------------
*ActionApi* | [**actions_describe_action**](superplaneapi/docs/ActionApi.md#actions_describe_action) | **GET** /api/v1/actions/{name} | Describe action
*ActionApi* | [**actions_list_actions**](superplaneapi/docs/ActionApi.md#actions_list_actions) | **GET** /api/v1/actions | List actions
...
*AgentApi* | [**agents_delete_agent_chat**](superplaneapi/docs/AgentApi.md#agents_delete_agent_chat) | **DELETE** /api/v1/agents/chats/{chatId} | Delete an agent chat
...
*CanvasNodeApi* | [**canvases_invoke_node_trigger_hook**](superplaneapi/docs/CanvasNodeApi.md#canvases_invoke_node_trigger_hook) | **POST** /api/v1/canvases/{canvasId}/triggers/{nodeId}/hooks/{hookName} | Invoke trigger hook
...
*CanvasNodeExecutionApi* | [**canvases_invoke_node_execution_hook**](superplaneapi/docs/CanvasNodeExecutionApi.md#canvases_invoke_node_execution_hook) | **POST** /api/v1/canvases/{canvasId}/executions/{executionId}/hooks/{hookName} | Invoke execution hook
...
*OrganizationApi* | [**organizations_next_integration_setup_step**](superplaneapi/docs/OrganizationApi.md#organizations_next_integration_setup_step) | **PATCH** /api/v1/organizations/{id}/integrations/{integrationId}/next | Submit an integration setup step and go to the next
*OrganizationApi* | [**organizations_previous_integration_setup_step**](superplaneapi/docs/OrganizationApi.md#organizations_previous_integration_setup_step) | **PATCH** /api/v1/organizations/{id}/integrations/{integrationId}/previous | Revert the current integration setup step and go to the previous
...
*OrganizationApi* | [**organizations_update_integration_capabilities**](superplaneapi/docs/OrganizationApi.md#organizations_update_integration_capabilities) | **PUT** /api/v1/organizations/{id}/integrations/{integrationId}/capabilities | Update integration capabilities
*OrganizationApi* | [**organizations_update_integration_property**](superplaneapi/docs/OrganizationApi.md#organizations_update_integration_property) | **PUT** /api/v1/organizations/{id}/integrations/{integrationId}/properties | Update integration property
*OrganizationApi* | [**organizations_update_integration_secret**](superplaneapi/docs/OrganizationApi.md#organizations_update_integration_secret) | **PUT** /api/v1/organizations/{id}/integrations/{integrationId}/secrets | Update integration secret
...
## Documentation For Models
 ...
 - [ActionsDescribeActionResponse](superplaneapi/docs/ActionsDescribeActionResponse.md)
 - [ActionsListActionsResponse](superplaneapi/docs/ActionsListActionsResponse.md)
 ...
 - [CanvasesActOnCanvasChangeRequestRequestAction](superplaneapi/docs/CanvasesActOnCanvasChangeRequestRequestAction.md)
 ...
 - [CanvasesInvokeNodeExecutionHookBody](superplaneapi/docs/CanvasesInvokeNodeExecutionHookBody.md)
 - [CanvasesInvokeNodeTriggerHookBody](superplaneapi/docs/CanvasesInvokeNodeTriggerHookBody.md)
 - [CanvasesInvokeNodeTriggerHookResponse](superplaneapi/docs/CanvasesInvokeNodeTriggerHookResponse.md)
 ...
 - [IntegrationCapabilityState](superplaneapi/docs/IntegrationCapabilityState.md)
 - [IntegrationCapabilityStateState](superplaneapi/docs/IntegrationCapabilityStateState.md)
 - [IntegrationNodeRef](superplaneapi/docs/IntegrationNodeRef.md)
 - [IntegrationProperty](superplaneapi/docs/IntegrationProperty.md)
 - [IntegrationSetupState](superplaneapi/docs/IntegrationSetupState.md)
 - [IntegrationSetupStepDefinition](superplaneapi/docs/IntegrationSetupStepDefinition.md)
 - [IntegrationSetupStepDefinitionType](superplaneapi/docs/IntegrationSetupStepDefinitionType.md)
 - [IntegrationsCapabilityDefinition](superplaneapi/docs/IntegrationsCapabilityDefinition.md)
 - [IntegrationsCapabilityDefinitionType](superplaneapi/docs/IntegrationsCapabilityDefinitionType.md)
 - [IntegrationsCapabilityGroup](superplaneapi/docs/IntegrationsCapabilityGroup.md)
 - [IntegrationsIntegrationDefinition](superplaneapi/docs/IntegrationsIntegrationDefinition.md)
 - [MeMeResponse](superplaneapi/docs/MeMeResponse.md)
 ...
 - [OrganizationsIntegrationSecret](superplaneapi/docs/OrganizationsIntegrationSecret.md)
 ...
 - [OrganizationsNextIntegrationSetupStepBody](superplaneapi/docs/OrganizationsNextIntegrationSetupStepBody.md)
 - [OrganizationsNextIntegrationSetupStepResponse](superplaneapi/docs/OrganizationsNextIntegrationSetupStepResponse.md)
 ...
 - [OrganizationsPreviousIntegrationSetupStepResponse](superplaneapi/docs/OrganizationsPreviousIntegrationSetupStepResponse.md)
 ...
 - [OrganizationsUpdateIntegrationCapabilitiesBody](superplaneapi/docs/OrganizationsUpdateIntegrationCapabilitiesBody.md)
 - [OrganizationsUpdateIntegrationCapabilitiesResponse](superplaneapi/docs/OrganizationsUpdateIntegrationCapabilitiesResponse.md)
 - [OrganizationsUpdateIntegrationPropertyBody](superplaneapi/docs/OrganizationsUpdateIntegrationPropertyBody.md)
 - [OrganizationsUpdateIntegrationPropertyResponse](superplaneapi/docs/OrganizationsUpdateIntegrationPropertyResponse.md)
 - [OrganizationsUpdateIntegrationResponse](superplaneapi/docs/OrganizationsUpdateIntegrationResponse.md)
 - [OrganizationsUpdateIntegrationSecretBody](superplaneapi/docs/OrganizationsUpdateIntegrationSecretBody.md)
 - [OrganizationsUpdateIntegrationSecretResponse](superplaneapi/docs/OrganizationsUpdateIntegrationSecretResponse.md)
 ...
 - [SetupStepDefinitionRedirectPrompt](superplaneapi/docs/SetupStepDefinitionRedirectPrompt.md)
 - [SuperplaneActionsAction](superplaneapi/docs/SuperplaneActionsAction.md)
 - [SuperplaneActionsOutputChannel](superplaneapi/docs/SuperplaneActionsOutputChannel.md)
 ...
 - [SuperplaneComponentsEdge](superplaneapi/docs/SuperplaneComponentsEdge.md)
 ...
 - [SuperplaneSecretsSecret](superplaneapi/docs/SuperplaneSecretsSecret.md)
 ...
 - [UsersRoleAssignment](superplaneapi/docs/UsersRoleAssignment.md)
