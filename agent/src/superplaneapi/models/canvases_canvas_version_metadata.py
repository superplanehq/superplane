...
class CanvasesCanvasVersionMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "canvasId", "owner", "state", "publishedAt", "createdAt", "updatedAt", "name", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanvasesCanvasVersionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanvasesCanvasVersionMetadata from a dict"""
        if obj is None:
            return None
