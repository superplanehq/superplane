...
class GroupsGroupMetadata(BaseModel):
    """
    GroupsGroupMetadata
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "domainType", "domainId", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupsGroupMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupsGroupMetadata from a dict"""
        if obj is None:
            return None
