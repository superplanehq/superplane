...
class AuthorizationPermission(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["resource", "action", "domainType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthorizationPermission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthorizationPermission from a dict"""
        if obj is None:
            return None
