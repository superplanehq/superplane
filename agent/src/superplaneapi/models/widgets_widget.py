...
class WidgetsWidget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "label", "description", "icon", "color", "configuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WidgetsWidget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WidgetsWidget from a dict"""
        if obj is None:
            return None
