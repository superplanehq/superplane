...
class TriggersTrigger(BaseModel):
    """
    TriggersTrigger
    """ # noqa: E501
    ...
    example_data: Optional[Dict[str, Any]] = Field(default=None, alias="exampleData")
    __properties: ClassVar[List[str]] = ["name", "label", "description", "icon", "color", "configuration", "exampleData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggersTrigger from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggersTrigger from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "exampleData": obj.get("exampleData")
        })
        return _obj
