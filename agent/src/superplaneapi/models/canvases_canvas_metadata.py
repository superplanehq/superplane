...
class CanvasesCanvasMetadata(BaseModel):
    """
    ...
    canvas_group_id: Optional[StrictStr] = Field(default=None, alias="canvasGroupId")
    __properties: ClassVar[List[str]] = ["id", "organizationId", "name", "description", "createdAt", "updatedAt", "createdBy", "isTemplate", "canvasGroupId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanvasesCanvasMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanvasesCanvasMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "canvasGroupId": obj.get("canvasGroupId")
        })
        return _obj
