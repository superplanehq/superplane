...
class UsersAccountProvider(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["providerType", "providerId", "email", "displayName", "avatarUrl", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsersAccountProvider from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsersAccountProvider from a dict"""
        if obj is None:
            return None
