...
class ServiceAccountsServiceAccount(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "organizationId", "createdBy", "hasToken", "createdAt", "updatedAt", "createdByName", "createdByEmail"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceAccountsServiceAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceAccountsServiceAccount from a dict"""
        if obj is None:
            return None
