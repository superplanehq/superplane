...
class CanvasesCanvasSpec(BaseModel):
    """
    CanvasesCanvasSpec
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["nodes", "edges", "changeManagement", "readme"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanvasesCanvasSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanvasesCanvasSpec from a dict"""
        if obj is None:
            return None
