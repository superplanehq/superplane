...
class CanvasesCanvasChangeset(BaseModel):
    """
    CanvasChangeset describes a unit of change for a canvas version.
    """ # noqa: E501
    changes: Optional[List[CanvasChangesetChange]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanvasesCanvasChangeset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanvasesCanvasChangeset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "changes": [CanvasChangesetChange.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
