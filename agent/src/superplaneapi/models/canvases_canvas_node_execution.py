...
class CanvasesCanvasNodeExecution(BaseModel):
    ...
    report_entry: Optional[StrictStr] = Field(default=None, alias="reportEntry")
    canvas_version_id: Optional[StrictStr] = Field(default=None, alias="canvasVersionId")
    __properties: ClassVar[List[str]] = ["id", "canvasId", "nodeId", "parentExecutionId", "previousExecutionId", "state", "result", "resultReason", "resultMessage", "outputs", "createdAt", "updatedAt", "metadata", "configuration", "childExecutions", "rootEvent", "cancelledBy", "reportEntry", "canvasVersionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportEntry": obj.get("reportEntry"),
            "canvasVersionId": obj.get("canvasVersionId")
        })
        return _obj
