...
class SecretsCreateSecretRequest(BaseModel):
    """
    SecretsCreateSecretRequest
    """ # noqa: E501
    secret: Optional[SuperplaneSecretsSecret] = None
    ...
    __properties: ClassVar[List[str]] = ["secret", "domainType", "domainId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecretsCreateSecretRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecretsCreateSecretRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "secret": SuperplaneSecretsSecret.from_dict(obj["secret"]) if obj.get("secret") is not None else None,
