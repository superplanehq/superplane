...
export interface NavigationAltProps {
  user: User
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            {/* Paper Airplane Icon Logo */}
            <div className="flex-shrink-0">
              <div className="w-10 h-10 bg-sky-600 dark:bg-sky-300 rounded-full flex items-center justify-center">
            ...
            <div className="relative">
              ...
              >
                <div className="text-left">
                  <Heading level={1} className="text-lg font-semibold mb-0">{organization.name}</Heading>
                  {organization.plan && (
              ...
              {isOrgMenuOpen && (
                <div className="absolute left-0 mt-2 w-56 bg-white dark:bg-zinc-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                  <div className="py-1">
                    <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-700">
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <div>
                          <Text className="font-medium mb-0">{organization.name}</Text>
                          {organization.plan && (
                            <Badge color="blue" className="text-xs mt-1">{organization.plan}</Badge>
                          )}
                        </div>
