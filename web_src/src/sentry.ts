...
/**
 * Drops `TypeError: Failed to fetch` (and equivalents on other browsers) from
 * Sentry reports. These come from user-side connectivity issues — offline,
 * intermittent network, captive portals, ad-blockers — and the app already
 * handles them gracefully in the UI, so reporting them just creates noise.
 */
