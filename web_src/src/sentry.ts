 ...
 * get raised when a browser extension or content blocker corrupts the
...
function hintMatchesMinifiedReferenceError(hint: EventHint): boolean {
  ...
  if (original instanceof Error) {
    return original.name === "ReferenceError" && looksLikeMinifiedReferenceError(original.message);
  }
