  ...
  return (
    <div
      ...
      className={cn(
        ...
        isSelectable ? "cursor-pointer hover:bg-action-neutral-hover" : "cursor-default",
      )}
    ...
    >
      ...
      <span className="pointer-events-none relative z-0 flex min-w-0 flex-1 items-center gap-1.5">
        ...
        />
        <span className="min-w-0 flex-1 truncate text-xs font-medium text-content-primary">{event.title}</span>
      </span>
      ...
      {event.receivedAt ? (
        <span
          className="relative z-20 shrink-0 text-xs tabular-nums text-content-secondary"
