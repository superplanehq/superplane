  ...
  return (
    <DialogPortal>
      ...
      >
        ...
        {children}
        <DialogPrimitive.Close className="absolute top-3 right-2 flex h-6 w-6 cursor-pointer items-center justify-center rounded leading-none hover:bg-action-neutral-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 disabled:pointer-events-none">
          <X className="h-4 w-4" />
