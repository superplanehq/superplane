...
export const IntegrationResourceFieldRenderer = ({
  ...
  if (!hasRequiredParameters) {
    ...
    const hint =
      paramNames.length > 0 ? `Select ${paramNames.join(" and ")} first` : "Complete the required fields above";
    return <div className="text-sm text-gray-500 dark:text-gray-400">{hint}</div>;
  }
