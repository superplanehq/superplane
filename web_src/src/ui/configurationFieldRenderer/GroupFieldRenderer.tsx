...
export const GroupFieldRenderer = ({
  ...
  if (isLoading) {
    return <div className="text-sm text-content-secondary">Loading groups...</div>;
  }
  ...
  if (!groups || groups.length === 0) {
    return (
      <div className="space-y-2">
        ...
        <p className="text-xs text-content-secondary">No groups found in this organization.</p>
      </div>
    );
  }
