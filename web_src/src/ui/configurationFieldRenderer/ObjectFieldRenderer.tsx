...
export const ObjectFieldRenderer: React.FC<FieldRendererProps> = ({
    ...
    return (
      <>
        <div className="flex flex-col gap-2 relative">
          <div className="border rounded-md border-edge-strong p-2" style={{ height: "200px" }}>
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-auto rounded-md p-2 relative border border-edge-strong">
              <Editor
                height="600px"
                defaultLanguage="json"
                value={editorValue}
  ...
  return (
    <div className="border border-edge-strong rounded-md p-4 space-y-4">
