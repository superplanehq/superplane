...
export const Composite: React.FC<CompositeProps> = ({
      ...
      sections.push({
        ...
        handleComponent: (
          <div
            ...
            className="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors px-2 py-1 rounded"
          >
  ...
  const customField = isMissing ? (
    <div className="px-3 py-2 bg-orange-50 dark:bg-orange-900/30 border-t border-amber-200 dark:border-amber-700 flex items-center gap-2">
      <div className="flex-shrink-0">
        <svg className="h-4 w-4 text-amber-700 dark:text-amber-400" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
