...
export function RunNodeDetailContent({
  ...
  return (
    <div
      className="flex min-h-0 flex-1 flex-col overflow-hidden bg-surface-raised"
      data-testid={testId}
    ...
    >
      ...
      {isExecutionsLoading && !presentation.isTriggerNode ? (
        <div className="flex items-center justify-center gap-2 px-4 py-8 text-xs text-content-muted">
