...
export function RunNodeDetailHeader({
  ...
  return (
    <div className="flex h-9 shrink-0 items-stretch justify-between border-b border-edge-subtle pl-3">
      ...
      <div className="flex shrink-0 items-stretch">
        ...
        <div aria-hidden className="w-px self-stretch bg-edge-subtle" />
        <div className="flex items-center px-1">
