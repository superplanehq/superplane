...
const placeholder = "https://images.unsplash.com/photo-1576075796033-848c2a5f3696?w=800&dpr=2&q=80";

const renderAspectRatio = (args: AspectRatioArgs) => (
  <AspectRatio {...args} className="overflow-hidden rounded-md bg-muted">
    <img src={placeholder} alt="City skyline at night" className="h-full w-full object-cover" />
  </AspectRatio>
);
