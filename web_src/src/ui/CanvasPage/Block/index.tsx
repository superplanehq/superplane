  ...
  return (
    <div className="nodrag absolute top-full right-2 z-10 flex flex-col items-end gap-1">
      ...
      {showDiffAction ? (
        <button
          type="button"
          className="mt-1 flex items-center gap-1 rounded-full bg-surface-raised px-2 py-0.5 text-[10px] font-medium text-content-secondary opacity-0 outline outline-1 outline-edge-default transition hover:bg-action-neutral-hover focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-status-info-edge group-hover/block:opacity-100"
          onClick={(event) => {
