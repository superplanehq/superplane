...
interface HeaderProps {
  ...
  topViewMode?: "canvas" | "data";
  onTopViewModeChange?: (mode: "canvas" | "data") => void;
}
          ...
          <div className="justify-self-center">
            {topViewMode && onTopViewModeChange && (
              <div className="flex items-center rounded-md border border-gray-300 p-0.5">
                ...
                <button
                  type="button"
                  onClick={() => onTopViewModeChange("data")}
                  className={`rounded px-2 py-1 text-xs font-medium ${
                    topViewMode === "data" ? "bg-slate-900 text-white" : "text-gray-700 hover:bg-gray-100"
                  }`}
                >
                  Data
                </button>
