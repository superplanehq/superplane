  ...
  },
  {
    ...
    data: {
      ...
      composite: {
        ...
        parameters: [
          { icon: "clock", items: ["Dedupe TTL: 10m"] }
        ],
        metadata: [
          { icon: "alert-triangle", label: "Last issue: TypeError in CheckoutController" },
        ...
        stages: [
          {
            ...
            eventState: "success",
            eventTitle: "TypeError in CheckoutController after checkout@2025.10.27.4 deploy"
          },
          {
            pathName: "INFRA_FAIL",
            field: "$.alert_type",
    ...
    data: {
      ...
      composite: {
        ...
        metadata: [
          ...
          { icon: "git-commit", label: "Rollback: v2025.10.27.4 → v2025.10.27.3" },
...
const incidentResponseEdges: Edge[] = [
  ...
  { id: "e6", source: "policy-router", sourceHandle: "DEPLOY_ERROR", target: "rollback-release" },
  { id: "e7", source: "policy-router", sourceHandle: "SLO_BREACH", target: "scale-and-cache" },
  { id: "e8", source: "policy-router", sourceHandle: "INFRA_FAIL", target: "restart-workload" },
  { id: "e9", source: "policy-router", sourceHandle: "DEFAULT", target: "escalate-oncall" },
];
