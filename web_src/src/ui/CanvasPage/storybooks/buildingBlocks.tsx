    ...
    blocks: [
      // Triggers - GitHub
      {
        ...
        configuration: [
          ...
          { key: "secret", label: "Webhook Secret", type: "string", required: false },
        ],
        icon: "github",
        color: "gray",
      },
      {
        ...
        configuration: [
          { key: "repo", label: "Repository", type: "string", required: true },
          { key: "targetBranches", label: "Target Branches", type: "string[]", required: false },
      ...
      },
      {
        ...
        configuration: [
          { key: "repo", label: "Repository", type: "string", required: true },
          { key: "issueNumber", label: "Issue/PR Number", type: "number", required: false },
          { key: "contains", label: "Comment Contains", type: "string", required: false },
          { key: "secret", label: "Webhook Secret", type: "string", required: false },
        ],
        icon: "github",
        color: "gray",
      ...
      // Actions - GitHub
      {
        ...
        configuration: [
          { key: "repo", label: "Repository", type: "string", required: true },
          { key: "workflow", label: "Workflow", type: "string", required: true },
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        configuration: [
          { key: "project", label: "Project", type: "string", required: true },
          { key: "issueIid", label: "Issue/MR IID", type: "number", required: false },
          { key: "contains", label: "Comment Contains", type: "string", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "git-branch",
    ...
    blocks: [
      {
        ...
        configuration: [
          ...
          { key: "project", label: "Project", type: "string", required: true },
          { key: "pipeline", label: "Pipeline", type: "string", required: true },
      ...
      },
      {
        ...
        configuration: [
          ...
          { key: "project", label: "Project", type: "string", required: true },
          { key: "pipelineId", label: "Pipeline ID", type: "string", required: true },
          { key: "promotion", label: "Promotion Name", type: "string", required: true },
          { key: "token", label: "Token (secret)", type: "string", required: false },
        ],
        icon: "flag-triangle-right",
        color: "green",
    ...
    blocks: [
      {
        ...
        configuration: [
          ...
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "token", label: "Token (secret)", type: "string", required: false },
        ],
        icon: "cloud-sync",
        color: "red",
      },
      {
        ...
        configuration: [
          { key: "app", label: "Application", type: "string", required: true },
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "desired", label: "Desired Health", type: "enum", values: ["Healthy","Degraded","Suspended","Missing"], required: true },
      ...
      },
      {
        ...
        configuration: [
          { key: "app", label: "Application", type: "string", required: true },
          { key: "hard", label: "Hard Refresh", type: "boolean", required: false },
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "token", label: "Token (secret)", type: "string", required: false },
        ],
        icon: "cloud-sync",
      ...
      },
      {
        ...
        configuration: [
          { key: "app", label: "Application", type: "string", required: true },
          { key: "cascade", label: "Cascade", type: "boolean", required: false },
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "token", label: "Token (secret)", type: "string", required: false },
        ],
        icon: "cloud-sync",
      ...
      // Argo Workflows
      {
        ...
        configuration: [
          ...
          { key: "template", label: "Template", type: "string", required: true },
          { key: "parameters", label: "Parameters", type: "json", required: false },
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "token", label: "Token (secret)", type: "string", required: false },
        ],
      ...
      },
      {
        ...
        configuration: [
          { key: "namespace", label: "Namespace", type: "string", required: true },
          { key: "name", label: "Workflow Name", type: "string", required: true },
      ...
      },
      {
        ...
        configuration: [
          { key: "namespace", label: "Namespace", type: "string", required: true },
          { key: "name", label: "Workflow Name", type: "string", required: false },
          { key: "server", label: "Server URL", type: "string", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "cloud-sync",
  ...
  },
  {
    ...
    blocks: [
      // Triggers
      {
        ...
        configuration: [
          { key: "services", label: "Service IDs", type: "string[]", required: false },
      ...
      },
      {
        ...
        configuration: [
          { key: "scheduleIds", label: "Schedule IDs", type: "string[]", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "siren",
        color: "red",
      },
      {
        ...
        configuration: [
          { key: "serviceIds", label: "Service IDs", type: "string[]", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "siren",
        color: "red",
      ...
      // Actions - Incidents
      {
        ...
        configuration: [
          { key: "routingKey", label: "Routing Key (secret)", type: "string", required: true },
          { key: "summary", label: "Summary", type: "string", required: true },
          { key: "severity", label: "Severity", type: "enum", values: ["info","warning","error","critical"], required: true },
          { key: "source", label: "Source", type: "string", required: false },
          { key: "customDetails", label: "Custom Details", type: "json", required: false },
          { key: "dedupKey", label: "Dedup Key", type: "string", required: false },
        ],
        icon: "siren",
        color: "red",
      },
      {
        ...
        configuration: [
          { key: "routingKey", label: "Routing Key (secret)", type: "string", required: true },
          { key: "dedupKey", label: "Dedup/Incident Key", type: "string", required: true },
      ...
      },
      {
        ...
        configuration: [
          { key: "apiToken", label: "API Token (secret)", type: "string", required: true },
          { key: "incidentId", label: "Incident ID", type: "string", required: true },
          { key: "escalationLevel", label: "Escalation Level", type: "number", required: false },
        ],
        icon: "siren",
        color: "red",
      },
      {
        ...
        configuration: [
          { key: "apiToken", label: "API Token (secret)", type: "string", required: true },
          { key: "incidentId", label: "Incident ID", type: "string", required: true },
          { key: "assignees", label: "Assignee IDs", type: "string[]", required: true },
        ],
        icon: "siren",
        color: "red",
      },
      ...
      },
      {
        ...
        configuration: [
          { key: "apiToken", label: "API Token (secret)", type: "string", required: true },
          { key: "serviceIds", label: "Service IDs", type: "string[]", required: true },
          { key: "start", label: "Start (ISO8601)", type: "string", required: true },
          { key: "end", label: "End (ISO8601)", type: "string", required: true },
    ...
    blocks: [
      {
        ...
        configuration: [
          ...
          { key: "from", label: "From (s ago)", type: "number", required: true },
          { key: "to", label: "To (s ago)", type: "number", required: false },
          { key: "interval", label: "Interval (s)", type: "number", required: false },
          { key: "apiKey", label: "API Key (secret)", type: "string", required: false },
          { key: "appKey", label: "App Key (secret)", type: "string", required: false },
        ],
        icon: "dog",
        color: "purple",
      },
      {
        ...
        configuration: [
          ...
          { key: "status", label: "Status", type: "enum", values: ["OK","Alert","Warn","No Data","Ignored"], required: false },
          { key: "apiKey", label: "API Key (secret)", type: "string", required: false },
          { key: "appKey", label: "App Key (secret)", type: "string", required: false },
        ],
        icon: "dog",
      ...
      },
      {
        ...
        configuration: [
          ...
          { key: "tags", label: "Tags", type: "string[]", required: false },
          { key: "priority", label: "Priority", type: "enum", values: ["normal","low"], required: false },
          { key: "alertType", label: "Alert Type", type: "enum", values: ["info","success","warning","error"], required: false },
          { key: "apiKey", label: "API Key (secret)", type: "string", required: false },
          { key: "appKey", label: "App Key (secret)", type: "string", required: false },
        ],
        icon: "dog",
      ...
      },
      {
        ...
        configuration: [
          { key: "monitorIds", label: "Monitor IDs", type: "string[]", required: false },
          { key: "tags", label: "Tags", type: "string[]", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "dog",
      ...
      },
      {
        ...
        type: "trigger",
        outputChannels: [
          { id: "event", label: "Event" } as any,
        ],
        configuration: [
          { key: "query", label: "Query", type: "string", required: false },
          { key: "tags", label: "Tags", type: "string[]", required: false },
          { key: "priorities", label: "Priorities", type: "string[]", required: false },
          { key: "sources", label: "Sources", type: "string[]", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "dog",
        color: "purple",
      },
      {
        ...
        configuration: [
          { key: "query", label: "Query", type: "string", required: true },
          { key: "indexes", label: "Indexes", type: "string[]", required: false },
      ...
      },
      {
        ...
        configuration: [
          ...
          { key: "window", label: "Window (min)", type: "number", required: false },
          { key: "burnRate", label: "Burn Rate", type: "number", required: true },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "dog",
        color: "purple",
      },
      {
        ...
        configuration: [
          { key: "query", label: "Query", type: "string", required: true },
          { key: "sensitivity", label: "Sensitivity", type: "enum", values: ["low","medium","high"], required: false },
          { key: "window", label: "Window (min)", type: "number", required: false },
          { key: "token", label: "Webhook Token", type: "string", required: false },
        ],
        icon: "dog",
    ...
    blocks: [
      {
        ...
        configuration: [
          { key: "functionName", label: "Function Name", type: "string", required: true },
      ...
      },
      {
        ...
        configuration: [
          ...
          { key: "taskDefinition", label: "Task Definition", type: "string", required: true },
          { key: "region", label: "Region", type: "string", required: false },
          { key: "wait", label: "Wait for stability", type: "boolean", required: false },
        ],
        icon: "cloud",
        color: "orange",
      },
    ...
    blocks: [
      {
        ...
        configuration: [
          ...
          { key: "purgeEverything", label: "Purge Everything", type: "boolean", required: false },
      ...
      },
      {
        ...
        configuration: [
          { key: "zone", label: "Zone ID", type: "string", required: true },
          { key: "type", label: "Type", type: "enum", values: ["A","AAAA","CNAME","TXT"], required: true },
          { key: "name", label: "Name", type: "string", required: true },
          { key: "content", label: "Content", type: "string", required: true },
          { key: "ttl", label: "TTL", type: "number", required: false },
          { key: "proxied", label: "Proxied", type: "boolean", required: false },
        ],
        icon: "cloud",
        color: "yellow",
      },
      {
        ...
        outputChannels: [ { id: "deployed", label: "Deployed" } as any, { id: "failed", label: "Failed" } as any ],
        configuration: [
          { key: "scriptName", label: "Script Name", type: "string", required: true },
