...
export function FactoryNodeCardShell({
  ...
  return (
    <div
      ...
      className={cn(
        "canvas-node-drag-handle cursor-pointer overflow-hidden rounded-2xl border border-border bg-card shadow-[0_1px_2px_rgba(15,23,42,0.04),0_4px_12px_rgba(15,23,42,0.04)] dark:shadow-[0_1px_2px_rgba(0,0,0,0.35)] w-[280px]",
      ...
      <div className="px-3.5 pt-3.5 pb-3">
        <div className="flex items-start gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[14px] leading-snug font-semibold tracking-[-0.015em] text-card-foreground">{title}</div>
