...
import type { DashboardNodeStatus } from "./DashboardContext";
 ...
 */
export function deriveDashboardNodeStatuses(
  executionsByNodeId: Record<string, CanvasesCanvasNodeExecution[] | undefined>,
): Record<string, DashboardNodeStatus> {
  const out: Record<string, DashboardNodeStatus> = {};
...
export function statusFromExecution(execution: CanvasesCanvasNodeExecution): DashboardNodeStatus {
