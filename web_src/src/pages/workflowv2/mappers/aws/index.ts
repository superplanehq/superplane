...
import { queryMetricsInsightsMapper } from "./cloudwatch/query_metrics_insights";
...
export const componentMappers: Record<string, ComponentBaseMapper> = {
  ...
  "cloudwatch.queryMetricsInsights": queryMetricsInsightsMapper,
};
...
export const eventStateRegistry: Record<string, EventStateRegistry> = {
  ...
  "cloudwatch.queryMetricsInsights": buildActionStateRegistry("queried"),
};
