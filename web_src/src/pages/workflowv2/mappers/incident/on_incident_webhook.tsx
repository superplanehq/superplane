          ...
          <div>
            ...
            <div className="text-xs text-gray-800 dark:text-gray-100 mt-2 border-1 border-gray-300 dark:border-gray-600 px-2.5 py-2 bg-gray-50 dark:bg-gray-800 rounded-md">
              <ol className="list-decimal ml-4 space-y-1">
                ...
                <li>
                  Copy the <strong>Signing secret</strong> from the new endpoint and paste it into
                  the Signing secret field above.
                </li>
              </ol>
              {isHttp && (
                <p className="mt-3 text-xs text-amber-700 dark:text-amber-300" role="status">
                  incident.io requires HTTPS. Set <code className="bg-black/10 dark:bg-white/10 px-1 rounded">WEBHOOKS_BASE_URL</code> when starting the app, then re-save to get an HTTPS URL.
                </p>
              )}
              <div className="mt-3">
