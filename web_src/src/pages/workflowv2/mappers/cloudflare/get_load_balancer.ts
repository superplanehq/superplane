...
import { getLoadBalancerExecutionDetails } from "./base";
...
interface GetLoadBalancerConfiguration {
  loadBalancer?: string;
}

interface GetLoadBalancerNodeMetadata {
  loadBalancerName?: string;
}

export const getLoadBalancerMapper: ComponentBaseMapper = {
...
function metadataList(node: NodeInfo): MetadataItem[] {
  ...
  const nodeMetadata = node.metadata as GetLoadBalancerNodeMetadata | undefined;
  const configuration = node.configuration as GetLoadBalancerConfiguration;
