      ...
      <div className="border-t-1 border-gray-200 pt-4">
        <div className="space-y-3">
          <div>
            ...
            <div className="text-xs text-gray-800 dark:text-gray-100 mt-1 border-1 border-amber-950/20 px-2.5 py-2 bg-amber-50 dark:bg-amber-800 rounded-md font-mono whitespace-pre-line">
              {content}
            </div>
          </div>
        </div>
