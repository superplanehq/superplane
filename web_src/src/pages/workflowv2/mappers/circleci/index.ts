...
export const eventStateRegistry: Record<string, EventStateRegistry> = {
  ...
  getLastWorkflow: buildActionStateRegistry("retrieved"),
  getRecentWorkflowRuns: buildActionStateRegistry("retrieved"),
  getTestMetrics: buildActionStateRegistry("retrieved"),
  getFlakyTests: buildActionStateRegistry("retrieved"),
};
