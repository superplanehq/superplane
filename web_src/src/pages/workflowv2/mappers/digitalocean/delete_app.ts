...
import type { AppNodeMetadata, DeleteAppConfiguration } from "./types";

export const deleteAppMapper: ComponentBaseMapper = {
...
function metadataList(node: NodeInfo): MetadataItem[] {
  ...
  const configuration = node.configuration as DeleteAppConfiguration;
