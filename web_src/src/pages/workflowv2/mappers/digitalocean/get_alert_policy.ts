...
import { AlertPolicyNodeMetadata, GetAlertPolicyConfiguration } from "./types";
...
export const getAlertPolicyMapper: ComponentBaseMapper = {
...
function metadataList(node: NodeInfo): MetadataItem[] {
  ...
  const configuration = node.configuration as GetAlertPolicyConfiguration;

  if (nodeMetadata?.policyDesc) {
    metadata.push({ icon: "bell", label: nodeMetadata.policyDesc });
