...
function getSpecs(configuration: GetIncidentsConfiguration): ComponentBaseSpec[] | undefined {
  ...
  if (configuration?.assignmentGroup) {
    specs.push({
      ...
      values: [
        { badges: [{ label: configuration.assignmentGroup, bgColor: "bg-gray-100", textColor: "text-gray-700" }] },
      ],
    });
  }
  ...
  if (configuration?.state) {
    specs.push({
      ...
      values: [{ badges: [{ label: configuration.state, bgColor: "bg-gray-100", textColor: "text-gray-700" }] }],
    });
  }
  ...
  if (configuration?.urgency) {
    specs.push({
      ...
      values: [{ badges: [{ label: configuration.urgency, bgColor: "bg-gray-100", textColor: "text-gray-700" }] }],
    });
  }
