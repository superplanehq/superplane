...
/**
 * buildDash0ExecutionDetails formats the default output payload for execution details UI.
 */
...
/**
 * buildDash0EventSections builds the standard single-event section for Dash0 components.
 */
export function buildDash0EventSections(
  ...
  const timeAgo = formatTimeAgo(new Date(executionTime!));
