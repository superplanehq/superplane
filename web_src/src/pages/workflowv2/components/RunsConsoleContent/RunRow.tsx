import { CanvasesCanvasEventWithExecutions, CanvasesCanvasNodeExecution, CanvasesCanvasNodeQueueItem, ComponentsNode } from "@/api-client";
      ...
      {isExpanded && (executionRefs.length > 0 || queueItems.length > 0) && (
        <div className="bg-gray-50">
          ...
          {executionDetailsQuery.isError && executionRefs.length > 0 && (
            <div className="px-4 py-2 pl-11 text-xs text-red-600 border-t border-gray-200">Could not load run details.</div>
          )}
