                          ...
                          <div className="flex items-center gap-2">
                            {hasConflicts ? (
                              <Tooltip>
                                ...
                                <TooltipContent>Conflicted. Resolve conflicts before approving.</TooltipContent>
                              </Tooltip>
                            ) : null}
                ...
                <aside className="space-y-3">
                  ...
                  {showConflictResolutionCard ? (
                    <div className="rounded-xl border border-slate-200 bg-white p-4">
                      ...
                      <p className="mt-1 text-xs text-slate-600">Open resolver to merge conflicting changes.</p>
                      <Button
