...
import { useCreateAppInFolder } from "./useCreateAppInFolder";
...
export function CanvasFolderSection({
  ...
  const { createAppInFolder, isCreatingAppInFolder } = useCreateAppInFolder({
    folder,
    organizationId,
    canCreateCanvases,
    canUpdateCanvases,
  ...
  return (
    ...
    >
      <CanvasFolderHeader
        ...
        isCreatingAppInFolder={isCreatingAppInFolder}
        ...
        onCreateAppInFolder={() => void createAppInFolder()}
    ...
    <div className="mb-4 flex items-center justify-between gap-3">
      ...
      <div className="flex shrink-0 items-center gap-1">
        <CreateAppInFolderButton
          ...
          canUpdateCanvases={canUpdateCanvases}
          permissionsLoading={permissionsLoading}
          isCreating={isCreatingAppInFolder}
...
function CreateAppInFolderButton({
  ...
  return (
    <PermissionTooltip allowed={allowed} message={getCreateAppInFolderPermissionMessage(canCreateCanvases)}>
      <button
        type="button"
        className={cn(
        ...
        disabled={!canCreateInFolder || isCreating}
        onClick={onCreate}
      >
        {isCreating ? <Loader2 size={16} className="animate-spin" aria-hidden /> : <Plus size={16} aria-hidden />}
      </button>
    </PermissionTooltip>
  );
}
...
function getCreateAppInFolderPermissionMessage(canCreateCanvases: boolean) {
