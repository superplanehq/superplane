    ...
    <section className="mb-10" data-testid="home-factories-link">
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-slate-900 dark:text-gray-100">Navigate to Factories</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">Manage work orders, automations, and workspaces.</p>
        </div>
