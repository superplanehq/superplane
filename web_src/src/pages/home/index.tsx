...
import { useCanvasAppPreferences } from "@/hooks/useCanvasAppPreferences";
...
export function HomePage() {
  ...
  const { preferences, pinCanvas, starCanvas } = useCanvasAppPreferences(organizationId || "", account?.id);
  const preferredFilteredCanvases = applyCanvasAppPreferences(filteredCanvases, preferences);
      ...
      <div className="mx-auto w-full max-w-6xl p-8">
        ...
        {canvasError ? (
          ...
          <Content
            ...
            onTogglePin={pinCanvas}
            onToggleStar={starCanvas}
