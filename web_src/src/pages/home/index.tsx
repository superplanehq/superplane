  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 dark:bg-neutral-900">
      ...
      <main className="w-full h-full flex flex-column flex-grow-1">
        <div className="bg-slate-100 dark:bg-neutral-900 w-full flex-grow-1">
          <div className="p-8">
...
function WorkflowCard({ workflow, organizationId, navigate, onEdit }: WorkflowCardProps) {
  ...
  return (
    <div
      ...
      className="min-h-48 bg-white dark:bg-neutral-800 rounded-md outline outline-gray-950/15 hover:shadow-md transition-shadow cursor-pointer"
    >
      ...
      {filteredBlueprints.map((blueprint) => {
        ...
        return (
          <div
            ...
            className="min-h-48 bg-white dark:bg-neutral-800 rounded-md outline outline-slate-950/10 dark:border-neutral-700 hover:shadow-md transition-shadow cursor-pointer"
          >
