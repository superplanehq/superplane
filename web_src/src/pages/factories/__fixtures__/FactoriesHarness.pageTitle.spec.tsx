...
describe("client-side navigation updates document.title", () => {
  ...
  it("resets the tab title after navigating from a work order detail page back to the list", async () => {
    ...
    expect(document.title).toContain("Refunds Factory");
    ...
    expect(document.title).toBe("Work Orders · Refunds Factory · SuperPlane");
  }, 15000);
  ...
  it("updates the tab title when clicking between main workspace tabs", async () => {
    ...
    expect(document.title).toBe("Overview · Refunds Factory · SuperPlane");
    ...
    expect(document.title).toBe("Lines · Refunds Factory · SuperPlane");
    ...
    expect(document.title).toBe("Velocity · Refunds Factory · SuperPlane");
  }, 15000);
  ...
  it("updates the tab title when selecting a line inline, then back to the list", async () => {
    ...
    expect(document.title).toBe("Plan and Implement · Refunds Factory · SuperPlane");
  ...
  it("sets the tab title from the canvas name on a factory-owned app canvas", async () => {
    ...
    expect(document.title).toBe("Refund Implementer · Refunds Factory · SuperPlane");
  }, 15000);
  ...
  it("sets a distinct tab title for each factory settings section", async () => {
    ...
    expect(document.title).toBe("General · Settings · Refunds Factory · SuperPlane");
