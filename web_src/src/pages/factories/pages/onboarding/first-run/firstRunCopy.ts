...
export const FIRST_RUN_COPY = {
  ...
  analysis: {
    headline: "Analyzing your repository",
    body: "SuperPlane detects the languages and development commands. This can take a few minutes.",
    reassurance: "Nothing is changed. No work starts.",
    stage1: "Detecting languages and tools",
    stage2: "Finding setup and verification commands",
    stage3: "Saving workspace context",
