  ...
  return (
    <>
      <WorkOrderBoardLane
        ...
        banner={<BacklogColumnBanner panel={intakePanel} onSetupSentry={onSetupSentry} />}
...
function BacklogColumnBanner({ panel, onSetupSentry }: { panel?: BacklogIntakePanel; onSetupSentry?: () => void }) {
  if (!panel && !onSetupSentry) {
    return null;
  }
