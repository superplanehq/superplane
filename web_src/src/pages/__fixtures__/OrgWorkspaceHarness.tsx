...
// eslint-disable-next-line max-lines-per-function -- settings route table
function factorySettingsStorybookRoutes(OrganizationSpendingPage: ComponentType) {
  return [
    ...
    <Route
      ...
      element={<FactorySettingsGeneralPage />}
    />,
    <Route
    ...
    <Route
      ...
      element={<FactorySettingsUsagePage />}
    />,
    <Route
