...
import { integrationUsesNewSetupFlow } from "@/lib/integrationV2";
import { ArrowLeft, Loader2 } from "lucide-react";
import { Link, useParams } from "react-router-dom";
import { IntegrationDetails } from "./IntegrationDetails";
import { IntegrationDetailsV2 } from "./IntegrationDetailsV2";
...
export function IntegrationDetailsRoute({ organizationId }: IntegrationDetailsRouteProps) {
  ...
  if (integrationUsesNewSetupFlow(integration)) {
    return <IntegrationDetailsV2 organizationId={organizationId} />;
  }

  return <IntegrationDetails organizationId={organizationId} />;
}
