...
export function FilesView({
  ...
  return (
    <div
      className="absolute bottom-0 top-[5rem] z-10 grid min-h-0 grid-cols-[minmax(180px,260px)_minmax(0,1fr)] overflow-hidden bg-surface-canvas"
      style={{ left: editor.leftOffset, right: 0 }}
      data-testid="files-overlay"
    >
      <aside className="flex min-h-0 flex-col border-r border-edge-default bg-surface-raised">
        {editor.canManageRepositoryFiles ? (
          <div className="flex h-7 shrink-0 items-center gap-1 border-b border-edge-subtle px-2">
