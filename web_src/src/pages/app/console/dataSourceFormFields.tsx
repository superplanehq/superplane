  ...
  return (
    <>
      <div className="space-y-1.5">
        <Label className="text-xs font-medium text-content-secondary">Node (optional)</Label>
        <Select
...
function LimitField({
  ...
  return (
    <div className="space-y-1.5">
      <Label className="text-xs font-medium text-content-secondary">Limit</Label>
      <Input
        type="number"
        min={1}
        value={value ?? ""}
...
export function DataSourceMemoryFields({
  ...
  return (
    <>
      <div className="space-y-1.5">
        <Label className="text-xs font-medium text-content-secondary">Namespace</Label>
        <Input
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-medium text-content-secondary">Field path (optional)</Label>
        <Input
