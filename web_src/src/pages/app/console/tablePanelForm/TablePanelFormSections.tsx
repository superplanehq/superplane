  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        <Label className="text-xs font-medium text-content-secondary">Columns</Label>
      ...
      <div className="space-y-2">
        ...
        {value.render.columns.length === 0 ? (
          <p className="text-xs text-content-muted">{emptyColumnsHint(value.dataSource.kind)}</p>
        ) : null}
      </div>
    </div>
  );
    ...
    <div className="flex flex-wrap gap-1" data-testid="table-field-quick-add">
      {fields.map((f) => (
        <Button
          ...
          size="sm"
          variant="ghost"
          className="h-6 bg-action-neutral text-[10px] text-content-primary hover:bg-action-neutral-hover"
...
export function TablePanelRowStylesSection({
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        <Label className="text-xs font-medium text-content-secondary">Row background</Label>
        <Button
          type="button"
          size="sm"
          variant="outline"
