...
const HtmlCodeEditor = forwardRef<HtmlCodeEditorHandle, HtmlCodeEditorProps>(function HtmlCodeEditor(
  ...
  return (
    <div className="min-h-[160px] flex-1 overflow-hidden bg-surface-raised" data-testid="console-html-editor">
      <Editor
        height="100%"
        language="html"
        value={value}
      ...
      {!collapsed ? (
        <div className="min-h-0 flex-1 overflow-auto px-3 py-2">
          {body.trim() ? (
            ...
            <p className="text-[12px] text-content-muted">Preview will appear once you write HTML above.</p>
          )}
        </div>
      ) : null}
    </div>
