...
function buildXAxisTickShowIndices(
  data: Array<Record<string, unknown>>,
...
function formatXAxisTick(value: unknown, format: WidgetColumnFormat | undefined): string {
...
function formatXTooltipLabel(value: unknown, format: WidgetColumnFormat | undefined): string {
  if (value == null || value === "") return "";
...
function resolveCartesianYFormat(
