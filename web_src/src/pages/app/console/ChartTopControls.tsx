    ...
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1.5">
          <Label className="text-xs font-medium text-content-secondary">Chart type</Label>
          <Select
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-medium text-content-secondary">X-axis field</Label>
          <Input
            list={fieldListId}
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-medium text-content-secondary">Legend</Label>
          <Select
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1.5 col-span-2">
          <Label className="text-xs font-medium text-content-secondary">Stack by field (optional)</Label>
          <Input
            list={fieldListId}
            value={seriesField}
...
function ChartAxisFormatRow({
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      />
      <div className="space-y-1.5">
        <Label className="text-xs font-medium text-content-secondary">Y-axis label</Label>
        <Input
...
function ChartSortRow({
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      <div className="space-y-1.5 col-span-2">
        <Label className="text-xs font-medium text-content-secondary">Sort by (optional)</Label>
        <Input
          list={fieldListId}
          value={sortField}
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-medium text-content-secondary">Order</Label>
