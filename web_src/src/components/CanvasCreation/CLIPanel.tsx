...
function CliQuickReferenceSection() {
  return (
    <div className="bg-gray-900 rounded-xl p-4 font-mono text-sm">
      <span className="text-[11px] font-sans font-medium text-gray-400 uppercase tracking-wider">Quick reference</span>
  ...
  return (
    <div className="space-y-4">
      ...
      <CliConnectSection
        ...
        handleGenerateConnect={handleGenerateConnect}
      />
