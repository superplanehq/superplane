...
export function CanvasVersionsSidebar({ isOpen, children }: CanvasVersionsSidebarProps) {
  ...
  return (
    <aside
      ...
      className="relative z-21 flex h-full min-w-0 shrink-0 flex-col overflow-hidden border-r border-edge-default bg-surface-default"
    ...
    >
      ...
      >
        <div
          aria-hidden
          className={cn(
            "pointer-events-none absolute top-0 bottom-0 left-1/2 w-px -translate-x-1/2 bg-transparent transition-colors group-hover:bg-edge-strong",
