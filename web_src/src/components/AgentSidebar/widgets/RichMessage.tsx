...
const MARKDOWN_CLASSES =
  ...
  "[&_hr]:my-5 [&_hr]:border-0 [&_hr]:border-t [&_hr]:border-edge-default " +
  ...
  "[&_code]:rounded [&_code]:bg-surface-subtle [&_code]:px-1 [&_code]:py-0.5 [&_code]:text-xs " +
  ...
  "[&_thead]:bg-surface-subtle [&_th]:px-3 [&_th]:py-1.5 [&_th]:text-left [&_th]:font-semibold [&_th]:text-content-secondary " +
  "[&_th]:border-b [&_th]:border-edge-default " +
  "[&_td]:border-b [&_td]:border-edge-subtle [&_td]:px-3 [&_td]:py-1.5 [&_td]:text-content-secondary " +
  "[&_tbody_tr:nth-child(even)]:bg-surface-subtle/60 " +
  "[&_tr:last-child_td]:border-b-0 [&_tr:hover]:bg-action-neutral-hover";
