  ...
  return (
    <>
      <div
        ...
        className="my-4 w-full min-w-0 rounded-lg border border-slate-200 bg-white p-3 shadow-sm overflow-x-auto cursor-pointer hover:border-slate-300 transition-colors [&_svg]:max-w-full [&_svg]:h-auto [&_svg]:mx-auto"
      >
