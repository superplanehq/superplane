  ...
  return (
    <>
      ...
      <Button
        ...
        variant="ghost"
        size="icon"
        className="size-7 shrink-0 rounded-full text-content-secondary hover:bg-action-neutral-hover hover:text-content-primary"
      ...
      <div className="flex min-w-0 shrink-0 items-center gap-2">
        ...
        {sending && (
          <Button
            ...
            variant="outline"
            size="icon"
            className="size-7 shrink-0 rounded-full border-edge-default bg-surface-raised text-content-secondary hover:bg-action-neutral-hover"
            onClick={onStop}
            disabled={stopping}
