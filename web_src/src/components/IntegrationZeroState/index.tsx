...
const IntegrationZeroState = ({ integrationType, label, canvasId, organizationId, onSuccess, hasError = false }: IntegrationZeroStateProps) => {
  const [showModal, setShowModal] = useState(false);

  return (
    <>
      <div className={`text-center m-4 py-8 rounded-md ${hasError
