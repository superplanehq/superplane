  ...
  return (
    <div className="bg-white dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 p-6 text-left">
      ...
      <form onSubmit={(e) => {
            ...
            return (
              <div className='group w-full flex items-center'>
                {isCustomEmailSuggestion ? (
                  isSelected ?
                    <span className="material-symbols-outlined text-xs! text-zinc-600 dark:text-zinc-400 ml-1">mail</span>
                    :
                  ...
                  <Avatar
                    ...
                    className={isSelected ? "size-4" : "size-8"}
                  />
                )}
        ...
        <Button
          type="submit"
          disabled={selectedUsers.length === 0 || isLoading || disabled}
          color="blue"
        >
