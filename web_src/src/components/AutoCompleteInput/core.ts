...
export const EXPR_FUNCTIONS: readonly ExprFunction[] = [
  ...
  },
  {
    ...
    snippet: "order().",
    description:
      "Returns the work order for this run when dispatched from a factory, exposing id, title, description, factory_id, state, result, url, source, artifacts, and comments (both loaded when accessed).",
