...
export function CanvasNodeSearchPage({ actions, onBack }: { actions: PaletteAction[]; onBack: () => void }) {
  return (
    <NestedPage onBack={onBack}>
      <CommandGroup heading="Components">
        {actions.length === 0 ? (
          <CommandItem disabled value="no components" className="min-h-12 rounded-lg px-3 py-2.5">
            <span className="text-sm text-slate-500">No components found.</span>
          </CommandItem>
        ) : (
