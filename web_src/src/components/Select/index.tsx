  ...
  return (
    <div className="relative">
      <div
        ...
        className={twMerge(
          "relative flex items-center justify-between w-full px-3 py-2 text-sm bg-surface-raised text-content-primary",
          "border rounded-md cursor-pointer focus:outline-none focus:ring-2",
          error ? "border-red-300 dark:border-red-600 focus:ring-red-500" : "border-edge-default focus:ring-blue-500",
      ...
      >
        <div className="flex items-center min-w-0 flex-1">
          ...
          <span className={twMerge("block truncate", !selectedOption && "text-content-secondary")}>
        ...
        <Icon
          ...
          size="sm"
          className="ml-2 text-content-muted flex-shrink-0"
        />
      </div>
      ...
      {isOpen && (
        ...
        >
          <div ref={listRef}>
            {options.length === 0 ? (
              <div className="px-3 py-2 text-sm text-content-secondary">No options available</div>
            ) : (
              options.map((option) => {
                ...
                return (
                  <div
                    ...
                    className="relative cursor-pointer select-none px-3 py-2 text-sm hover:bg-blue-50 dark:hover:bg-blue-900/20 text-content-primary transition-colors duration-150"
                    onClick={(e) => {
                      e.preventDefault();
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {option.description && (
                            <span className="block truncate text-xs text-content-secondary">{option.description}</span>
                          )}
                        </div>
                      </div>
