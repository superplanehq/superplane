...
export type ActionsDescribeActionResponse = {
  action?: SuperplaneActionsAction;
};

export type ActionsListActionsResponse = {
  actions?: Array<SuperplaneActionsAction>;
};
...
export type CanvasesActOnCanvasChangeRequestBody = {
  action?: CanvasesActOnCanvasChangeRequestRequestAction;
};

export type CanvasesActOnCanvasChangeRequestRequestAction =
  | "ACTION_UNSPECIFIED"
  | "ACTION_APPROVE"
  | "ACTION_REJECT"
  | "ACTION_REOPEN"
...
export type CanvasesCanvasDashboard = {
  canvasId?: string;
  panels?: Array<CanvasesDashboardPanel>;
  layout?: Array<CanvasesDashboardLayoutItem>;
  updatedAt?: string;
};
...
export type CanvasesCanvasNodeExecutionResult =
  | "RESULT_UNKNOWN"
  | "RESULT_PASSED"
  | "RESULT_FAILED"
  | "RESULT_CANCELLED";
...
export type CanvasesDashboardLayoutItem = {
  i?: string;
  x?: number;
  y?: number;
  w?: number;
...
export type CanvasesDashboardPanel = {
  id?: string;
  type?: string;
  content?: unknown;
};
...
export type CanvasesGetCanvasDashboardResponse = {
  dashboard?: CanvasesCanvasDashboard;
};
...
export type CanvasesUpdateCanvasDashboardBody = {
  panels?: Array<CanvasesDashboardPanel>;
  layout?: Array<CanvasesDashboardLayoutItem>;
};

export type CanvasesUpdateCanvasDashboardResponse = {
  dashboard?: CanvasesCanvasDashboard;
};
 ...
 */
export type IntegrationCapabilityStateState =
  | "STATE_UNAVAILABLE"
  | "STATE_AVAILABLE"
  | "STATE_REQUESTED"
  | "STATE_ENABLED"
...
export type IntegrationSetupStepDefinitionType =
  | "UNKNOWN"
  | "INPUTS"
  | "REDIRECT_PROMPT"
...
export type SuperplaneActionsAction = {
  name?: string;
  label?: string;
  description?: string;
  configuration?: Array<ConfigurationField>;
...
export type SuperplaneActionsOutputChannel = {
  name?: string;
  label?: string;
  description?: string;
};
...
export type AgentsGetCanvasAgentChatResponse2 =
  AgentsGetCanvasAgentChatResponses[keyof AgentsGetCanvasAgentChatResponses];
...
export type AgentsSendAgentChatMessageResponse2 =
  AgentsSendAgentChatMessageResponses[keyof AgentsSendAgentChatMessageResponses];
...
export type CanvasFoldersListCanvasFoldersError =
  CanvasFoldersListCanvasFoldersErrors[keyof CanvasFoldersListCanvasFoldersErrors];
...
export type CanvasFoldersListCanvasFoldersResponse2 =
  CanvasFoldersListCanvasFoldersResponses[keyof CanvasFoldersListCanvasFoldersResponses];
...
export type CanvasFoldersCreateCanvasFolderError =
  CanvasFoldersCreateCanvasFolderErrors[keyof CanvasFoldersCreateCanvasFolderErrors];
...
export type CanvasFoldersCreateCanvasFolderResponse2 =
  CanvasFoldersCreateCanvasFolderResponses[keyof CanvasFoldersCreateCanvasFolderResponses];
...
export type CanvasFoldersDeleteCanvasFolderError =
  CanvasFoldersDeleteCanvasFolderErrors[keyof CanvasFoldersDeleteCanvasFolderErrors];
...
export type CanvasFoldersDeleteCanvasFolderResponse2 =
  CanvasFoldersDeleteCanvasFolderResponses[keyof CanvasFoldersDeleteCanvasFolderResponses];
...
export type CanvasFoldersUpdateCanvasFolderError =
  CanvasFoldersUpdateCanvasFolderErrors[keyof CanvasFoldersUpdateCanvasFolderErrors];
...
export type CanvasFoldersUpdateCanvasFolderResponse2 =
  CanvasFoldersUpdateCanvasFolderResponses[keyof CanvasFoldersUpdateCanvasFolderResponses];
...
export type CanvasFoldersUpdateCanvasFolderPositionError =
  CanvasFoldersUpdateCanvasFolderPositionErrors[keyof CanvasFoldersUpdateCanvasFolderPositionErrors];
...
export type CanvasFoldersUpdateCanvasFolderPositionResponse2 =
  CanvasFoldersUpdateCanvasFolderPositionResponses[keyof CanvasFoldersUpdateCanvasFolderPositionResponses];
...
export type CanvasesGetCanvasDashboardData = {
  body?: never;
  path: {
    canvasId: string;
  };
  query?: never;
  url: "/api/v1/canvases/{canvasId}/dashboard";
};

export type CanvasesGetCanvasDashboardErrors = {
  /**
   * An unexpected error response.
   */
  default: GooglerpcStatus;
...
export type CanvasesGetCanvasDashboardError = CanvasesGetCanvasDashboardErrors[keyof CanvasesGetCanvasDashboardErrors];

export type CanvasesGetCanvasDashboardResponses = {
  /**
   * A successful response.
   */
  200: CanvasesGetCanvasDashboardResponse;
};

export type CanvasesGetCanvasDashboardResponse2 =
  CanvasesGetCanvasDashboardResponses[keyof CanvasesGetCanvasDashboardResponses];

export type CanvasesUpdateCanvasDashboardData = {
  body: CanvasesUpdateCanvasDashboardBody;
  path: {
    canvasId: string;
  };
  query?: never;
...
export type CanvasesUpdateCanvasDashboardErrors = {
  /**
   * An unexpected error response.
   */
  default: GooglerpcStatus;
...
export type CanvasesUpdateCanvasDashboardError =
  CanvasesUpdateCanvasDashboardErrors[keyof CanvasesUpdateCanvasDashboardErrors];

export type CanvasesUpdateCanvasDashboardResponses = {
  /**
   * A successful response.
   */
  200: CanvasesUpdateCanvasDashboardResponse;
};

export type CanvasesUpdateCanvasDashboardResponse2 =
  CanvasesUpdateCanvasDashboardResponses[keyof CanvasesUpdateCanvasDashboardResponses];
...
export type CanvasesInvokeNodeExecutionHookError =
  CanvasesInvokeNodeExecutionHookErrors[keyof CanvasesInvokeNodeExecutionHookErrors];
...
export type CanvasesInvokeNodeExecutionHookResponse2 =
  CanvasesInvokeNodeExecutionHookResponses[keyof CanvasesInvokeNodeExecutionHookResponses];
...
export type CanvasesReemitTriggerEventResponse2 =
  CanvasesReemitTriggerEventResponses[keyof CanvasesReemitTriggerEventResponses];
...
export type CanvasesInvokeNodeTriggerHookError =
  CanvasesInvokeNodeTriggerHookErrors[keyof CanvasesInvokeNodeTriggerHookErrors];
...
export type CanvasesInvokeNodeTriggerHookResponse2 =
  CanvasesInvokeNodeTriggerHookResponses[keyof CanvasesInvokeNodeTriggerHookResponses];
...
export type OrganizationsUpdateIntegrationCapabilitiesError =
  OrganizationsUpdateIntegrationCapabilitiesErrors[keyof OrganizationsUpdateIntegrationCapabilitiesErrors];
...
export type OrganizationsUpdateIntegrationCapabilitiesResponse2 =
  OrganizationsUpdateIntegrationCapabilitiesResponses[keyof OrganizationsUpdateIntegrationCapabilitiesResponses];
...
export type OrganizationsNextIntegrationSetupStepError =
  OrganizationsNextIntegrationSetupStepErrors[keyof OrganizationsNextIntegrationSetupStepErrors];
...
export type OrganizationsNextIntegrationSetupStepResponse2 =
  OrganizationsNextIntegrationSetupStepResponses[keyof OrganizationsNextIntegrationSetupStepResponses];
...
export type OrganizationsPreviousIntegrationSetupStepError =
  OrganizationsPreviousIntegrationSetupStepErrors[keyof OrganizationsPreviousIntegrationSetupStepErrors];
...
export type OrganizationsPreviousIntegrationSetupStepResponse2 =
  OrganizationsPreviousIntegrationSetupStepResponses[keyof OrganizationsPreviousIntegrationSetupStepResponses];
...
export type OrganizationsUpdateIntegrationPropertyError =
  OrganizationsUpdateIntegrationPropertyErrors[keyof OrganizationsUpdateIntegrationPropertyErrors];
...
export type OrganizationsUpdateIntegrationPropertyResponse2 =
  OrganizationsUpdateIntegrationPropertyResponses[keyof OrganizationsUpdateIntegrationPropertyResponses];
...
export type OrganizationsUpdateIntegrationSecretError =
  OrganizationsUpdateIntegrationSecretErrors[keyof OrganizationsUpdateIntegrationSecretErrors];
...
export type OrganizationsUpdateIntegrationSecretResponse2 =
  OrganizationsUpdateIntegrationSecretResponses[keyof OrganizationsUpdateIntegrationSecretResponses];
