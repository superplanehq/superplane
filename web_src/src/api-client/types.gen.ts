...
export type OrganizationsGetUsageResponse = {
    usage?: OrganizationsUsageInfo;
};
...
export type OrganizationsUsageCounters = {
    canvases?: string;
    users?: string;
    integrations?: string;
...
export type OrganizationsUsageInfo = {
    profileName?: string;
    effectiveLimits?: OrganizationsUsageLimits;
    currentUsage?: OrganizationsUsageCounters;
    hasOverrides?: boolean;
    isUnlimited?: boolean;
};

export type OrganizationsUsageLimits = {
    maxOrgsPerAccount?: number;
    maxCanvasesPerOrg?: number;
...
export type OrganizationsGetUsageData = {
    body?: never;
    path: {
        id: string;
    };
...
export type OrganizationsGetUsageErrors = {
    /**
     * An unexpected error response.
     */
    default: GooglerpcStatus;
...
export type OrganizationsGetUsageError = OrganizationsGetUsageErrors[keyof OrganizationsGetUsageErrors];

export type OrganizationsGetUsageResponses = {
    /**
     * A successful response.
     */
    200: OrganizationsGetUsageResponse;
};

export type OrganizationsGetUsageResponse2 = OrganizationsGetUsageResponses[keyof OrganizationsGetUsageResponses];
