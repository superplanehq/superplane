...
import type { AuthorizationListCanvasGroupsData, AuthorizationListCanvasGroupsResponse2, AuthorizationListCanvasGroupsError, AuthorizationCreateCanvasGroupData, AuthorizationCreateCanvasGroupResponse2, AuthorizationCreateCanvasGroupError, AuthorizationDeleteCanvasGroupData, AuthorizationDeleteCanvasGroupResponse2, AuthorizationDeleteCanvasGroupError, AuthorizationGetCanvasGroupData, AuthorizationGetCanvasGroupResponse2, AuthorizationGetCanvasGroupError, AuthorizationUpdateCanvasGroupData, AuthorizationUpdateCanvasGroupResponse2, AuthorizationUpdateCanvasGroupError, AuthorizationGetCanvasGroupUsersData, AuthorizationGetCanvasGroupUsersResponse2, AuthorizationGetCanvasGroupUsersError, AuthorizationAddUserToCanvasGroupData, AuthorizationAddUserToCanvasGroupResponse2, AuthorizationAddUserToCanvasGroupError, AuthorizationRemoveUserFromCanvasGroupData, AuthorizationRemoveUserFromCanvasGroupResponse2, AuthorizationRemoveUserFromCanvasGroupError, AuthorizationGetCanvasUsersData, AuthorizationGetCanvasUsersResponse2, AuthorizationGetCanvasUsersError, AuthorizationListOrganizationGroupsData, AuthorizationListOrganizationGroupsResponse2, AuthorizationListOrganizationGroupsError, AuthorizationCreateOrganizationGroupData, AuthorizationCreateOrganizationGroupResponse2, AuthorizationCreateOrganizationGroupError, AuthorizationDeleteOrganizationGroupData, AuthorizationDeleteOrganizationGroupResponse2, AuthorizationDeleteOrganizationGroupError, AuthorizationGetOrganizationGroupData, AuthorizationGetOrganizationGroupResponse2, AuthorizationGetOrganizationGroupError, AuthorizationUpdateOrganizationGroupData, AuthorizationUpdateOrganizationGroupResponse2, AuthorizationUpdateOrganizationGroupError, AuthorizationGetOrganizationGroupUsersData, AuthorizationGetOrganizationGroupUsersResponse2, AuthorizationGetOrganizationGroupUsersError, AuthorizationAddUserToOrganizationGroupData, AuthorizationAddUserToOrganizationGroupResponse2, AuthorizationAddUserToOrganizationGroupError, AuthorizationRemoveUserFromOrganizationGroupData, AuthorizationRemoveUserFromOrganizationGroupResponse2, AuthorizationRemoveUserFromOrganizationGroupError, AuthorizationGetOrganizationUsersData, AuthorizationGetOrganizationUsersResponse2, AuthorizationGetOrganizationUsersError, AuthorizationListRolesData, AuthorizationListRolesResponse2, AuthorizationListRolesError, AuthorizationCreateRoleData, AuthorizationCreateRoleResponse2, AuthorizationCreateRoleError, AuthorizationAssignRoleData, AuthorizationAssignRoleResponse2, AuthorizationAssignRoleError, AuthorizationDescribeRoleData, AuthorizationDescribeRoleResponse2, AuthorizationDescribeRoleError, AuthorizationRemoveRoleData, AuthorizationRemoveRoleResponse2, AuthorizationRemoveRoleError, AuthorizationDeleteRoleData, AuthorizationDeleteRoleResponse2, AuthorizationDeleteRoleError, AuthorizationUpdateRoleData, AuthorizationUpdateRoleResponse2, AuthorizationUpdateRoleError, AuthorizationListUserPermissionsData, AuthorizationListUserPermissionsResponse2, AuthorizationListUserPermissionsError, AuthorizationGetUserRolesData, AuthorizationGetUserRolesResponse2, AuthorizationGetUserRolesError, SuperplaneListCanvasesData, SuperplaneListCanvasesResponse2, SuperplaneListCanvasesError, SuperplaneCreateCanvasData, SuperplaneCreateCanvasResponse2, SuperplaneCreateCanvasError, SuperplaneListConnectionGroupsData, SuperplaneListConnectionGroupsResponse2, SuperplaneListConnectionGroupsError, SuperplaneCreateConnectionGroupData, SuperplaneCreateConnectionGroupResponse2, SuperplaneCreateConnectionGroupError, SuperplaneDescribeConnectionGroupData, SuperplaneDescribeConnectionGroupResponse2, SuperplaneDescribeConnectionGroupError, SuperplaneUpdateConnectionGroupData, SuperplaneUpdateConnectionGroupResponse2, SuperplaneUpdateConnectionGroupError, SuperplaneListConnectionGroupFieldSetsData, SuperplaneListConnectionGroupFieldSetsResponse2, SuperplaneListConnectionGroupFieldSetsError, SuperplaneListEventSourcesData, SuperplaneListEventSourcesResponse2, SuperplaneListEventSourcesError, SuperplaneCreateEventSourceData, SuperplaneCreateEventSourceResponse2, SuperplaneCreateEventSourceError, SuperplaneResetEventSourceKeyData, SuperplaneResetEventSourceKeyResponse2, SuperplaneResetEventSourceKeyError, SuperplaneDescribeEventSourceData, SuperplaneDescribeEventSourceResponse2, SuperplaneDescribeEventSourceError, SuperplaneListIntegrationsData, SuperplaneListIntegrationsResponse2, SuperplaneListIntegrationsError, SuperplaneCreateIntegrationData, SuperplaneCreateIntegrationResponse2, SuperplaneCreateIntegrationError, SuperplaneDescribeIntegrationData, SuperplaneDescribeIntegrationResponse2, SuperplaneDescribeIntegrationError, SuperplaneListSecretsData, SuperplaneListSecretsResponse2, SuperplaneListSecretsError, SuperplaneCreateSecretData, SuperplaneCreateSecretResponse2, SuperplaneCreateSecretError, SuperplaneDeleteSecretData, SuperplaneDeleteSecretResponse2, SuperplaneDeleteSecretError, SuperplaneDescribeSecretData, SuperplaneDescribeSecretResponse2, SuperplaneDescribeSecretError, SuperplaneUpdateSecretData, SuperplaneUpdateSecretResponse2, SuperplaneUpdateSecretError, SuperplaneListStagesData, SuperplaneListStagesResponse2, SuperplaneListStagesError, SuperplaneCreateStageData, SuperplaneCreateStageResponse2, SuperplaneCreateStageError, SuperplaneUpdateStageData, SuperplaneUpdateStageResponse2, SuperplaneUpdateStageError, SuperplaneDescribeStageData, SuperplaneDescribeStageResponse2, SuperplaneDescribeStageError, SuperplaneListStageEventsData, SuperplaneListStageEventsResponse2, SuperplaneListStageEventsError, SuperplaneApproveStageEventData, SuperplaneApproveStageEventResponse2, SuperplaneApproveStageEventError, SuperplaneDescribeCanvasData, SuperplaneDescribeCanvasResponse2, SuperplaneDescribeCanvasError, OrganizationsListOrganizationsData, OrganizationsListOrganizationsResponse2, OrganizationsListOrganizationsError, OrganizationsCreateOrganizationData, OrganizationsCreateOrganizationResponse2, OrganizationsCreateOrganizationError, OrganizationsDeleteOrganizationData, OrganizationsDeleteOrganizationResponse2, OrganizationsDeleteOrganizationError, OrganizationsDescribeOrganizationData, OrganizationsDescribeOrganizationResponse2, OrganizationsDescribeOrganizationError, OrganizationsUpdateOrganizationData, OrganizationsUpdateOrganizationResponse2, OrganizationsUpdateOrganizationError } from './types.gen';
 ...
 */
export const authorizationListCanvasGroups = <ThrowOnError extends boolean = false>(options: Options<AuthorizationListCanvasGroupsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationListCanvasGroupsResponse2, AuthorizationListCanvasGroupsError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups',
        ...options
    });
};
 ...
 */
export const authorizationCreateCanvasGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationCreateCanvasGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthorizationCreateCanvasGroupResponse2, AuthorizationCreateCanvasGroupError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups',
        ...options,
        headers: {
 ...
 */
export const authorizationDeleteCanvasGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationDeleteCanvasGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<AuthorizationDeleteCanvasGroupResponse2, AuthorizationDeleteCanvasGroupError, ThrowOnError>({
 ...
 */
export const authorizationGetCanvasGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetCanvasGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetCanvasGroupResponse2, AuthorizationGetCanvasGroupError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups/{groupName}',
        ...options
    });
};
 ...
 */
export const authorizationUpdateCanvasGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationUpdateCanvasGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AuthorizationUpdateCanvasGroupResponse2, AuthorizationUpdateCanvasGroupError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups/{groupName}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Get canvas group users
 * Returns users that belong to a specific group within a canvas
 */
export const authorizationGetCanvasGroupUsers = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetCanvasGroupUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetCanvasGroupUsersResponse2, AuthorizationGetCanvasGroupUsersError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups/{groupName}/users',
        ...options
    });
};
 ...
 */
export const authorizationAddUserToCanvasGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationAddUserToCanvasGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthorizationAddUserToCanvasGroupResponse2, AuthorizationAddUserToCanvasGroupError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/groups/{groupName}/users',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const authorizationGetCanvasUsers = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetCanvasUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetCanvasUsersResponse2, AuthorizationGetCanvasUsersError, ThrowOnError>({
        url: '/api/v1/authorization/canvases/{canvasIdOrName}/users',
        ...options
    });
};
 ...
 */
export const authorizationCreateOrganizationGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationCreateOrganizationGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthorizationCreateOrganizationGroupResponse2, AuthorizationCreateOrganizationGroupError, ThrowOnError>({
        url: '/api/v1/authorization/groups',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const authorizationDeleteOrganizationGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationDeleteOrganizationGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<AuthorizationDeleteOrganizationGroupResponse2, AuthorizationDeleteOrganizationGroupError, ThrowOnError>({
 ...
 */
export const authorizationGetOrganizationGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetOrganizationGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetOrganizationGroupResponse2, AuthorizationGetOrganizationGroupError, ThrowOnError>({
        url: '/api/v1/authorization/groups/{groupName}',
        ...options
    });
};
 ...
 */
export const authorizationUpdateOrganizationGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationUpdateOrganizationGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<AuthorizationUpdateOrganizationGroupResponse2, AuthorizationUpdateOrganizationGroupError, ThrowOnError>({
        url: '/api/v1/authorization/groups/{groupName}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const authorizationGetOrganizationGroupUsers = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetOrganizationGroupUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetOrganizationGroupUsersResponse2, AuthorizationGetOrganizationGroupUsersError, ThrowOnError>({
 ...
 */
export const authorizationAddUserToOrganizationGroup = <ThrowOnError extends boolean = false>(options: Options<AuthorizationAddUserToOrganizationGroupData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AuthorizationAddUserToOrganizationGroupResponse2, AuthorizationAddUserToOrganizationGroupError, ThrowOnError>({
        url: '/api/v1/authorization/groups/{groupName}/users',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const authorizationGetOrganizationUsers = <ThrowOnError extends boolean = false>(options: Options<AuthorizationGetOrganizationUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorizationGetOrganizationUsersResponse2, AuthorizationGetOrganizationUsersError, ThrowOnError>({
        url: '/api/v1/authorization/organizations/{organizationId}/users',
        ...options
    });
};
 ...
 * List integrations for a canvas
 */
export const superplaneListIntegrations = <ThrowOnError extends boolean = false>(options: Options<SuperplaneListIntegrationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SuperplaneListIntegrationsResponse2, SuperplaneListIntegrationsError, ThrowOnError>({
        url: '/api/v1/canvases/{canvasIdOrName}/integrations',
        ...options
    });
};
 ...
 */
export const superplaneCreateIntegration = <ThrowOnError extends boolean = false>(options: Options<SuperplaneCreateIntegrationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SuperplaneCreateIntegrationResponse2, SuperplaneCreateIntegrationError, ThrowOnError>({
        url: '/api/v1/canvases/{canvasIdOrName}/integrations',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Describe an integration for a canvas
 */
export const superplaneDescribeIntegration = <ThrowOnError extends boolean = false>(options: Options<SuperplaneDescribeIntegrationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SuperplaneDescribeIntegrationResponse2, SuperplaneDescribeIntegrationError, ThrowOnError>({
        url: '/api/v1/canvases/{canvasIdOrName}/integrations/{idOrName}',
        ...options
    });
};
