 ...
 */
export const usersRegenerateToken = <ThrowOnError extends boolean = true>(options: Options<UsersRegenerateTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UsersRegenerateTokenResponse2, UsersRegenerateTokenError, ThrowOnError>({
