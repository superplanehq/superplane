...
/**
 * List integration components
 * List integration components
 */
export const integrationsListComponents = <ThrowOnError extends boolean = true>(options: Options<IntegrationsListComponentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<IntegrationsListComponentsResponse, IntegrationsListComponentsError, ThrowOnError>({
