...
/**
 * List connection group event rejections
 * Returns a list of events that were rejected by the specified connection group
 */
export const superplaneListConnectionGroupRejections = <ThrowOnError extends boolean = true>(options: Options<SuperplaneListConnectionGroupRejectionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SuperplaneListConnectionGroupRejectionsResponse2, SuperplaneListConnectionGroupRejectionsError, ThrowOnError>({
 ...
 */
export const superplaneBulkListEvents = <ThrowOnError extends boolean = true>(options: Options<SuperplaneBulkListEventsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SuperplaneBulkListEventsResponse2, SuperplaneBulkListEventsError, ThrowOnError>({
...
/**
 * Bulk list stage events
 * Returns stage events for multiple stages in a single request to optimize loading performance
 */
export const superplaneBulkListStageEvents = <ThrowOnError extends boolean = true>(options: Options<SuperplaneBulkListStageEventsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SuperplaneBulkListStageEventsResponse2, SuperplaneBulkListStageEventsError, ThrowOnError>({
...
/**
 * Cancel a stage event
 * Cancels the specified stage event (canvas can be referenced by ID or name)
 */
export const superplaneCancelStageEvent = <ThrowOnError extends boolean = true>(options: Options<SuperplaneCancelStageEventData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SuperplaneCancelStageEventResponse2, SuperplaneCancelStageEventError, ThrowOnError>({
...
/**
 * List stage event rejections
 * Returns a list of events that were rejected by the specified stage
 */
export const superplaneListStageRejections = <ThrowOnError extends boolean = true>(options: Options<SuperplaneListStageRejectionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SuperplaneListStageRejectionsResponse2, SuperplaneListStageRejectionsError, ThrowOnError>({
