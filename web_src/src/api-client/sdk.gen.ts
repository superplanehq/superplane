 ...
 * List integration resources
 */
export const integrationsListResources = <ThrowOnError extends boolean = true>(options: Options<IntegrationsListResourcesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<IntegrationsListResourcesResponse2, IntegrationsListResourcesError, ThrowOnError>({
 ...
 */
export const organizationsUpdateInvitation = <ThrowOnError extends boolean = true>(options: Options<OrganizationsUpdateInvitationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<OrganizationsUpdateInvitationResponse2, OrganizationsUpdateInvitationError, ThrowOnError>({
        url: '/api/v1/organizations/{id}/invitations/{invitationId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
