 ...
 */
export const superplaneDeleteCanvas = <ThrowOnError extends boolean = false>(options: Options<SuperplaneDeleteCanvasData, ThrowOnError>) => {
 ...
 */
export const groupsDescribeGroup = <ThrowOnError extends boolean = false>(options: Options<GroupsDescribeGroupData, ThrowOnError>) => {
 ...
 */
export const groupsListGroupUsers = <ThrowOnError extends boolean = false>(options: Options<GroupsListGroupUsersData, ThrowOnError>) => {
 ...
 */
export const usersListUserRoles = <ThrowOnError extends boolean = false>(options: Options<UsersListUserRolesData, ThrowOnError>) => {
