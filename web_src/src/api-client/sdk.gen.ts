...
/**
 * List resources
 * List available resources for an integration (repositories, projects, etc.)
 */
...
/**
 * Get type manifests
 * Returns all executor and event source type manifests
 */
export const manifestServiceGetManifests = <ThrowOnError extends boolean = true>(options?: Options<ManifestServiceGetManifestsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ManifestServiceGetManifestsResponse, ManifestServiceGetManifestsError, ThrowOnError>({
