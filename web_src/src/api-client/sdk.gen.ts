 ...
 * Remove a subject (user or invitation) from a canvas
 */
export const superplaneRemoveSubject = <ThrowOnError extends boolean = true>(options: Options<SuperplaneRemoveSubjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<SuperplaneRemoveSubjectResponse2, SuperplaneRemoveSubjectError, ThrowOnError>({
...
/**
 * Remove a subject from an organization
 * Removes a subject (user or invitation) from an organization (can be referenced by ID or name)
 */
export const organizationsRemoveSubject = <ThrowOnError extends boolean = true>(options: Options<OrganizationsRemoveSubjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<OrganizationsRemoveSubjectResponse, OrganizationsRemoveSubjectError, ThrowOnError>({
