...
/** Organization experimental feature: manual "Add intake" entry for Notion in the Backlog column menu. */
export const FEATURE_FACTORY_NOTION_INTAKE = "factory_notion_intake";
