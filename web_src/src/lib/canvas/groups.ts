...
export function collectGroupChildIds(node: SuperplaneComponentsNode): string[] {
...
export function buildChildToGroupMap(nodes: SuperplaneComponentsNode[]): Map<string, string> {
