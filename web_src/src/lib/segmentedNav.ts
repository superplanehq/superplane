...
export const SEGMENTED_NAV_CLASSES =
  "inline-flex h-7 min-h-7 items-center justify-center gap-0 rounded-full p-1 bg-action-neutral";

export const SEGMENTED_NAV_XS_CLASSES =
  "inline-flex h-6 min-h-6 items-center justify-center gap-0 rounded-full p-0.5 bg-action-neutral";
...
export const SEGMENTED_NAV_TAB_ACTIVE_CLASSES = "bg-action-selected text-content-primary shadow-sm";

export const SEGMENTED_NAV_TAB_INACTIVE_CLASSES = "text-content-secondary hover:text-content-primary";
