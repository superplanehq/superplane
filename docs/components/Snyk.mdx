...
To get a Snyk API token, go to your [Snyk account settings](https://app.snyk.io/account).
...
- **Project ID**: Optional project filter - if specified, only issues from this project will trigger
- **Severity**: Optional severity filter - only issues of this severity or higher will trigger (low, medium, high, critical)
...
```json
{
  "data": {
    ...
    "organizationId": "3a3dac70-cfeb-4648-9471-4f398bdf0f31",
