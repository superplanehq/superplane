...
<CardGrid>
  ...
  <LinkCard title="Verify DNS Configuration" href="#verify-dns-configuration" description="Trigger DNS verification for a Render custom domain" />
</CardGrid>
...
<a id="verify-dns-configuration"></a>

## Verify DNS Configuration

The Verify DNS Configuration component asks Render to verify the DNS configuration for a custom domain.
...
```json
{
  ...
  "timestamp": "2026-02-05T16:25:00.000000Z",
  "type": "render.dnsConfiguration.verification.requested"
}
```
