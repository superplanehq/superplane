...
<CardGrid>
  ...
  <LinkCard title="Add Task Artifact" href="#add-task-artifact" description="Attach a typed artifact (markdown note, branch, or link) to a work order" />
  ...
  <LinkCard title="Create Task" href="#create-task" description="Create a new work order" />
...
The Add Task Artifact component stores a typed artifact against a work order.
...
The Create Task component creates a new work order in the factory. This component can only be used in factory-owned apps.
