...
<CardGrid>
  ...
  <LinkCard title="Run OpenCode" href="#run-open-code" description="Runs OpenCode on a fleet runner" />
...
<a id="run-open-code"></a>

## Run OpenCode

**Component key:** `runnerOpenCode`

Runs [OpenCode](https://opencode.ai/docs/cli/) in non-interactive mode on a fleet runner.
