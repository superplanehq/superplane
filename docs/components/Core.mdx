...
The URL, query-param values, form-data values, and the body (JSON string values, plain text, XML) accept inline organization-secret references using the form:
