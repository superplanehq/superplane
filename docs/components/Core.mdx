...
<CardGrid>
  ...
  <LinkCard title="List Pull Requests" href="#list-pull-requests" description="List factory pull requests for a repository from the database" />
...
<a id="list-pull-requests"></a>

## List Pull Requests

**Component key:** `listPullRequests`

The List Pull Requests component reads factory pull requests for one repository from the SuperPlane database. It does not call GitHub.
