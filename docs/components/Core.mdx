...
<CardGrid>
  ...
  <LinkCard title="Runner" href="#runner" description="Run shell commands on provisioned compute with full logs, managed by your SuperPlane deployment." />
...
Run shell commands in a managed, ephemeral environment on dedicated runners.
