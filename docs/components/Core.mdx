...
<CardGrid>
  ...
  <LinkCard title="Run Bash" href="#run-bash" description="Run Bash commands in a short-lived, isolated environment managed by your SuperPlane deployment." />
...
Run Bash commands in a managed, ephemeral environment.
