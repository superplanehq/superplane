...
<CardGrid>
  ...
  <LinkCard title="Create Task Order" href="#create-task-order" description="Create a new work order" />
...
<a id="create-task-order"></a>

## Create Task Order

**Component key:** `createWorkOrder`

The Create Task Order component creates a new work order in the factory. This component can only be used in factory-owned apps.
