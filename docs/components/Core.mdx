...
<CardGrid>
  ...
  <LinkCard title="Run Bash" href="#run-bash" description="Run Bash commands in an ephemeral build environment backed by AWS CodeBuild." />
...
Run Bash commands in a managed ephemeral build environment.
