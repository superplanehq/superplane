...
<CardGrid>
  <LinkCard
    title="When Alert Fires"
    href="#when-alert-fires"
    description="Trigger a workflow when a Kibana alert rule fires"
  />
  <LinkCard
    title="When Case Status Changes"
    href="#when-case-status-changes"
    description="React when an Elastic Security case status changes"
  />
</CardGrid>
...
<CardGrid>
  <LinkCard
    title="Create Case"
    href="#create-case"
    description="Create a new case in Kibana Security"
  />
  <LinkCard
    title="Get Case"
    href="#get-case"
    description="Retrieve a Kibana Security case by ID"
  />
  <LinkCard
    title="Index Document"
    href="#index-document"
    description="Write a JSON document to an Elasticsearch index"
  />
  <LinkCard
    title="Update Case"
    href="#update-case"
    description="Update an existing Kibana Security case"
  />
</CardGrid>
...
- **Statuses** _(optional)_: Only fire when a case has one of these statuses. Leave empty to fire for any case update.
- **Severities** _(optional)_: Only fire for cases with one of these severities. Leave empty to accept all severities.
- **Tags** _(optional)_: Only fire for cases that include at least one tag matching any of these predicates. Leave empty to accept all cases.
...
- **Document ID** _(optional)_: A stable ID for idempotent writes. If omitted, Elasticsearch generates one automatically. Providing an ID means re-runs update the existing document rather than creating a duplicate.
