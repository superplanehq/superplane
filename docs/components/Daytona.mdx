...
- **Target Region**: Target region for the sandbox (e.g. us, eu, local)
...
- The sandbox must be created first using Create Sandbox
...
- **Force Delete**: Optional flag to force deletion even if sandbox is running
