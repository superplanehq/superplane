...
<CardGrid>
  ...
  <LinkCard title="Update Agent" href="#update-agent" description="Swap the knowledge base attached to a DigitalOcean Gradient AI agent" />
...
The Update Agent component swaps the knowledge base attached to an existing Gradient AI agent.
...
```json
{
  "data": {
    ...
    "newKnowledgeBaseId": "a1b2c3d4-0000-0000-0000-000000000002",
    "previousKnowledgeBaseId": "a1b2c3d4-0000-0000-0000-000000000001"
  },
  "timestamp": "2025-01-01T00:00:00Z",
  "type": "digitalocean.agent.updated"
}
```
