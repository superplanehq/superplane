...
The Create Batch Message component uses [Anthropic's Message Batches API](https://platform.claude.com/docs/en/build-with-claude/batch-processing) to process many prompts asynchronously in one request, at a lower cost than issuing them individually.
