...
<CardGrid>
  ...
  <LinkCard title="S3 • Create Bucket" href="#s3-•-create-bucket" description="Create an AWS S3 bucket" />
  <LinkCard title="S3 • Copy Object" href="#s3-•-copy-object" description="Copy an object within AWS S3" />
  <LinkCard title="S3 • Delete Object" href="#s3-•-delete-object" description="Delete an object from an AWS S3 bucket" />
  <LinkCard title="S3 • Head Object" href="#s3-•-head-object" description="Retrieve metadata for an S3 object without downloading it" />
  <LinkCard title="S3 • Head Bucket" href="#s3-•-head-bucket" description="Check whether an S3 bucket exists and is accessible" />
  <LinkCard title="S3 • Get Object Attributes" href="#s3-•-get-object-attributes" description="Retrieve attributes for an S3 object" />
  <LinkCard title="S3 • Put Object" href="#s3-•-put-object" description="Upload an object to an AWS S3 bucket" />
  <LinkCard title="S3 • Delete Bucket" href="#s3-•-delete-bucket" description="Delete an empty AWS S3 bucket" />
  <LinkCard title="S3 • Empty Bucket" href="#s3-•-empty-bucket" description="Delete all objects in an AWS S3 bucket" />
...
The Create Bucket component creates an AWS S3 bucket in the specified region.
...
```json
{
  "data": {
    ...
    "location": "/my-example-bucket"
  },
  "timestamp": "2026-02-28T10:00:00.000000000Z",
  "type": "aws.s3.bucket"
}
```
...
The Copy Object component copies an S3 object from one location to another within S3.
...
The Head Object component retrieves metadata for an S3 object without downloading the object data.
...
```json
{
  "data": {
    ...
    "etag": "d41d8cd98f00b204e9800998ecf8427e",
    "lastModified": "Fri, 28 Feb 2026 10:00:00 GMT",
...
The Head Bucket component checks whether an S3 bucket exists and is accessible.
...
The Get Object Attributes component retrieves attributes such as ETag, storage class, and size for an S3 object.
...
The Put Object component uploads content to an S3 object.
...
The Empty Bucket component deletes all objects in an S3 bucket. This is useful as a prerequisite before deleting the bucket itself.
