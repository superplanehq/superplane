...
<CardGrid>
  ...
  <LinkCard title="EC2 • Associate Elastic IP" href="#ec2-•-associate-elastic-ip" description="Associate or disassociate an Elastic IP address with an EC2 instance" />
...
The Associate Elastic IP component associates or disassociates an Elastic IP address with an EC2 instance.
