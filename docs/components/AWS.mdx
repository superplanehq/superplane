...
<CardGrid>
  ...
  <LinkCard title="EC2 • Associate Elastic IP" href="#ec2-•-associate-elastic-ip" description="Associate or disassociate an Elastic IP address with an EC2 resource" />
...
<a id="ec2-•-associate-elastic-ip"></a>

## EC2 • Associate Elastic IP

**Component key:** `aws.ec2.associateElasticIP`

The Associate Elastic IP component associates or disassociates an Elastic IP address with an EC2 instance or network interface.
