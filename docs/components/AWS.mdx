...
The Query component executes an instant PromQL query against an Amazon Managed Service for Prometheus workspace (`GET /api/v1/query`).
...
The Query Range component executes a range PromQL query against an Amazon Managed Service for Prometheus workspace (`GET /api/v1/query_range`).
