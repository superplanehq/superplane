...
<CardGrid>
  ...
  <LinkCard title="CloudWatch • Get Metric Data" href="#cloud-watch-•-get-metric-data" description="Fetch ECS, ALB, RDS, or SQS metrics from CloudWatch over a lookback window" />
  ...
  <LinkCard title="CloudWatch • Send Metric Data" href="#cloud-watch-•-send-metric-data" description="Publish a custom metric data point to CloudWatch from a workflow" />
  ...
  <LinkCard title="EC2 • Delete Alarm" href="#ec2-•-delete-alarm" description="Delete a CloudWatch metric alarm for an EC2 instance" />
  ...
  <LinkCard title="EC2 • Get Alarm" href="#ec2-•-get-alarm" description="Fetch the current state and details of a CloudWatch alarm for an EC2 instance" />
...
<a id="cloud-watch-•-get-metric-data"></a>

## CloudWatch • Get Metric Data

**Component key:** `aws.cloudwatch.getMetricData`

The Get Metric Data component retrieves a CloudWatch metric for an ECS service, an Application Load Balancer, an RDS instance, or an SQS queue over a configurable lookback window, the same way `aws.ec2.getInstanceMetrics` does for EC2 instances.
...
```json
{
  "data": {
    ...
    "datapoints": [
      ...
      {
        "timestamp": "2026-05-29T08:10:00Z",
        "value": 45.91
      }
    ],
    "dimensions": [
  ...
  "timestamp": "2026-05-29T09:00:00.657831534Z",
  "type": "aws.cloudwatch.metricData"
}
```
...
<a id="cloud-watch-•-send-metric-data"></a>

## CloudWatch • Send Metric Data

**Component key:** `aws.cloudwatch.sendMetricData`

The Send Metric Data component publishes a single custom metric value to CloudWatch, creating the metric if it doesn't already exist.
...
```json
{
  ...
  "timestamp": "2026-05-29T09:00:00.657831534Z",
  "type": "aws.cloudwatch.metricSent"
}
```
...
<a id="ec2-•-delete-alarm"></a>

## EC2 • Delete Alarm

**Component key:** `aws.ec2.deleteAlarm`
...
```json
{
  ...
  "timestamp": "2026-06-03T16:38:01.123456789Z",
...
<a id="ec2-•-get-alarm"></a>

## EC2 • Get Alarm

**Component key:** `aws.ec2.getAlarm`
...
{
  "data": {
    "alarmArn": "arn:aws:cloudwatch:us-east-1:123456789012:alarm:cpuUsage",
  ...
  "timestamp": "2026-06-03T16:37:20.636935245Z",
  "type": "aws.ec2.alarm"
}
```
