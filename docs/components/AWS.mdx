...
```json
{
  "data": {
    ...
    "detail": {
      "alarmName": "snaketoy-web-cpu-high",
      "configuration": {
        "description": "CPU utilization above 90% for 5 minutes on the snaketoy-web ASG",
        "metrics": [
          {
            "id": "m1",
            "metricStat": {
              "metric": {
                "dimensions": {
                  "AutoScalingGroupName": "snaketoy-web-asg"
                },
                "name": "CPUUtilization",
                "namespace": "AWS/EC2"
              },
      ...
      "previousState": {
        "reason": "Threshold Crossed: 1 datapoint [35.0 (10/02/26 20:30:00)] was not greater than or equal to the threshold (90.0).",
        "reasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-02-10T20:30:33.842+0000\",\"startDate\":\"2026-02-10T20:25:00.000+0000\",\"statistic\":\"Average\",\"period\":60,\"recentDatapoints\":[35.0],\"threshold\":90.0}",
        "timestamp": "2026-02-10T20:30:33.847+0000",
        "value": "OK"
      },
      "state": {
        "reason": "Threshold Crossed: 1 datapoint [95.0 (10/02/26 20:34:00)] was greater than or equal to the threshold (90.0).",
        "reasonData": "{\"version\":\"1.0\",\"queryDate\":\"2026-02-10T20:35:33.218+0000\",\"startDate\":\"2026-02-10T20:30:00.000+0000\",\"statistic\":\"Average\",\"period\":60,\"recentDatapoints\":[95.0],\"threshold\":90.0,\"evaluatedDatapoints\":[{\"timestamp\":\"2026-02-10T20:34:00.000+0000\",\"value\":95.0}]}",
        "timestamp": "2026-02-10T20:35:33.412+0000",
        "value": "ALARM"
      }
    },
    ...
    "region": "us-east-1",
    "resources": [
      "arn:aws:cloudwatch:us-east-1:123456789012:alarm:snaketoy-web-cpu-high"
    ],
    "source": "aws.cloudwatch",
    "time": "2026-02-10T20:35:33Z",
    "version": "0"
  },
  "timestamp": "2026-02-10T20:35:34.018Z",
...
```json
{
  "data": {
    ...
    "detail": {
      ...
      "domainName": "acme-labs",
      "domainOwner": "123456789012",
      "eventDeduplicationId": "5f87d1a3-2c1f-4ab0-8f55-8f4c2b4a5c76",
      "operationType": "Created",
      "packageFormat": "npm",
      "packageName": "snaketoy-web",
      "packageNamespace": "acme-labs",
      "packageVersion": "1.5.0",
      "packageVersionRevision": "E30D52B451F42F41",
      "packageVersionState": "Published",
      "repositoryAdministrator": "arn:aws:sts::123456789012:assumed-role/snaketoy-publisher-role/renato-dev",
    ...
    "region": "us-east-1",
    "resources": [
      "arn:aws:codeartifact:us-east-1:123456789012:repository/acme-labs/internal-npm"
    ],
    "source": "aws.codeartifact",
    "time": "2026-03-04T14:25:30Z",
    "version": "0"
  },
  "timestamp": "2026-03-04T14:25:31.142Z",
...
```json
{
  "data": {
    "account": "123456789012",
    "detail": {
      "execution-id": "21f8c0a4-3e2b-4d18-9c5a-7b1d8e0f4a92",
      "execution-trigger": {
        "trigger-detail": "arn:aws:sts::123456789012:assumed-role/snaketoy-deploy-role/renato-dev",
        "trigger-type": "StartPipelineExecution"
      },
      "pipeline": "snaketoy-deploy",
    ...
    "id": "8b1a4c7d-9e0f-2a3b-4c5d-6e7f8a9b0c1d",
    "region": "us-east-1",
    "resources": [
      "arn:aws:codepipeline:us-east-1:123456789012:snaketoy-deploy"
    ],
    "source": "aws.codepipeline",
    "time": "2026-02-24T15:21:42Z",
    "version": "0"
  },
  "timestamp": "2026-02-24T15:21:42.984Z",
...
```json
{
  "data": {
    ...
    "detail": {
      ...
      "RequestId": "7b6c5d4e-9f8a-41c2-b3d4-e5f60718293a",
      "State": "available"
    },
  ...
  "timestamp": "2026-02-10T12:10:01.482Z",
  "type": "aws.ec2.image"
}
```
...
```json
{
  "data": {
    ...
    "detail": {
      "action-type": "PUSH",
      "image-digest": "sha256:9c2f1b03a8e1d647c2d4e9af3120cd5e8aab2c14b5e7d12a91f0b4c8e6d3a2f7",
      "image-tag": "v1.5.0",
      "repository-name": "snaketoy-web",
      "result": "SUCCESS"
    },
    ...
    "resources": [],
    "source": "aws.ecr",
    "time": "2026-03-01T11:42:18Z",
    "version": "0"
  },
  "timestamp": "2026-03-01T11:42:18.421Z",
...
```json
{
  "data": {
    ...
    "region": "us-east-1",
    "resources": [
      "arn:aws:ecr:us-east-1:123456789012:repository/snaketoy-web"
    ],
    "source": "aws.ecr",
    "time": "2026-03-01T11:46:22Z",
    "version": "0"
  },
  "timestamp": "2026-03-01T11:46:23.018Z",
...
{
  "data": {
    "Message": "{\"orderId\":\"ord_8f3a2b1c\",\"customerId\":\"cus_7d2e9f1a\",\"status\":\"created\",\"totalCents\":3497,\"currency\":\"USD\",\"createdAt\":\"2026-01-10T10:00:00Z\"}",
    "MessageAttributes": {
      "eventType": {
        "Type": "String",
        "Value": "order.created"
      ...
      "tenant": {
        "Type": "String",
        "Value": "acme-prod-12348"
      }
    },
    "MessageId": "95df01b4-ee98-5cb9-9903-4c221d41eb5e",
    "Signature": "EXAMPLEpH+..0OoH2YgFHc7yqf3SfWaHJ1sV2lxwRkKlvN6yc1jYdQfA3Bws1eRgTC2vH+rSE5e7H7YmL3nN5XAvXwjz0CQpjPbUsVqf1ZdfUdsW8HJ7T0YZGrlH5q4qYf5e6kQ4mE/dqGd4r2Y0mFZ6e6dq3PsR7Hc=",
    "SignatureVersion": "1",
    "SigningCertURL": "https://sns.us-east-1.amazonaws.com/SimpleNotificationService-9c6465fa7f48f5cacd23014631ec1136.pem",
    "Subject": "order.created",
    "Timestamp": "2026-01-10T10:00:00.984Z",
    "TopicArn": "arn:aws:sns:us-east-1:123456789012:orders-events",
    "Type": "Notification",
    "UnsubscribeURL": "https://sns.us-east-1.amazonaws.com/?Action=Unsubscribe\u0026SubscriptionArn=arn:aws:sns:us-east-1:123456789012:orders-events:11a2b3c4-5d6e-7f80-91a2-b3c4d5e6f708"
  },
  "timestamp": "2026-01-10T10:00:02.124Z",
