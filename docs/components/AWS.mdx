...
<CardGrid>
  ...
  <LinkCard title="CodeBuild • On Build Completed" href="#code-build-•-on-build-completed" description="Listen to AWS CodeBuild build state change events" />
...
<CardGrid>
  ...
  <LinkCard title="CodeBuild • Get Build Status" href="#code-build-•-get-build-status" description="Retrieve the status and details of an AWS CodeBuild build" />
  <LinkCard title="CodeBuild • Start Build" href="#code-build-•-start-build" description="Start an AWS CodeBuild build and wait for it to complete" />
  <LinkCard title="CodeBuild • Stop Build" href="#code-build-•-stop-build" description="Stop a running AWS CodeBuild build" />
...
<a id="code-build-•-on-build-completed"></a>

## CodeBuild • On Build Completed

The On Build Completed trigger starts a workflow execution when AWS CodeBuild emits a build state change event.
...
```json
{
  "data": {
    "account": "123456789012",
    "detail": {
      "build-id": "arn:aws:codebuild:us-east-1:123456789012:build/demo-project:00000000-0000-0000-0000-000000000001",
      "build-status": "SUCCEEDED",
      "current-phase": "COMPLETED",
      "project-name": "demo-project",
      "additional-information": {
        "initiator": "codebuild/demo-project",
        "build-start-time": "Feb 24, 2026 3:21:42 PM"
      }
    },
    ...
    "region": "us-east-1",
    "resources": [
      "arn:aws:codebuild:us-east-1:123456789012:build/demo-project:00000000-0000-0000-0000-000000000001"
    ],
    "source": "aws.codebuild",
    "time": "2026-02-24T15:25:12Z",
    "version": "0"
  },
  "timestamp": "2026-02-24T15:25:22.212Z",
...
<a id="code-build-•-get-build-status"></a>

## CodeBuild • Get Build Status

The Get Build Status component retrieves the full details of an AWS CodeBuild build.
...
{
  "data": {
    "id": "my-build-project:a1b2c3d4-5678-90ab-cdef-111122223333",
    "arn": "arn:aws:codebuild:us-east-1:123456789012:build/my-build-project:a1b2c3d4-5678-90ab-cdef-111122223333",
    "buildNumber": 42,
    "buildStatus": "SUCCEEDED",
    "projectName": "my-build-project",
    "currentPhase": "COMPLETED",
    "startTime": 1707570922.518,
    "endTime": 1707571022.518,
    "initiator": "codebuild/my-build-project",
    "buildComplete": true
  },
  "timestamp": "2026-02-10T14:37:02.518372841Z",
  "type": "aws.codebuild.build"
}
```

<a id="code-build-•-start-build"></a>

## CodeBuild • Start Build

The Start Build component triggers an AWS CodeBuild build and waits for it to complete.
...
```json
{
  "data": {
    ...
    "detail": {
      ...
      "build-id": "my-build-project:a1b2c3d4-5678-90ab-cdef-111122223333",
      "build-status": "SUCCEEDED",
      "current-phase": "COMPLETED"
    }
  },
  "timestamp": "2026-02-10T14:35:22.518372841Z",
  "type": "aws.codebuild.build.finished"
}
```

<a id="code-build-•-stop-build"></a>

## CodeBuild • Stop Build

The Stop Build component stops a running AWS CodeBuild build.
