...
The Run Task component starts one or more ECS tasks.
...
```json
{
  "data": {
    ...
    "tasks": [
      {
        "clusterArn": "arn:aws:ecs:eu-central-1:555666777888:cluster/payments-cluster-prod",
        "createdAt": "2026-01-22T08:14:55Z",
        "desiredStatus": "RUNNING",
        "group": "service:payments-api-service",
        "lastStatus": "RUNNING",
        "launchType": "FARGATE",
        "platformVersion": "1.4.0",
        "startedBy": "ecs-svc/9182736455647382910",
        "stoppedReason": "",
        "taskArn": "arn:aws:ecs:eu-central-1:555666777888:task/payments-cluster-prod/3f2a1b9c8d7e6f5a4b3c2d1e0f9a8b7c",
        "taskDefinitionArn": "arn:aws:ecs:eu-central-1:555666777888:task-definition/payments-api:12"
      }
    ]
  },
  "timestamp": "2026-01-22T08:15:12.452187341Z",
  "type": "aws.ecs.task"
}
```
...
The Stop Task component requests ECS to stop a running task.
...
```json
{
  "data": {
    "task": {
      "clusterArn": "arn:aws:ecs:ap-southeast-1:444555666777:cluster/analytics-cluster-staging",
      "createdAt": "2026-01-18T06:42:11Z",
      "desiredStatus": "STOPPED",
      "group": "service:analytics-worker-service",
      "lastStatus": "STOPPED",
      "launchType": "FARGATE",
      "platformVersion": "1.4.0",
      "startedBy": "ecs-svc/5647382910293847561",
      "stoppedReason": "Essential container in task exited",
      "taskArn": "arn:aws:ecs:ap-southeast-1:444555666777:task/analytics-cluster-staging/7c6b5a4d3e2f1a0987b6c5d4e3f2a1b0",
      "taskDefinitionArn": "arn:aws:ecs:ap-southeast-1:444555666777:task-definition/analytics-worker:23"
    }
  },
  "timestamp": "2026-01-18T06:48:33.118274556Z",
  "type": "aws.ecs.task"
}
```
