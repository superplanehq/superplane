...
- **Infrastructure provisioning**: Create S3 buckets as part of automated infrastructure setup workflows
- **Environment setup**: Provision storage buckets for new projects or environments
- **Data pipeline preparation**: Create staging or output buckets before running data processing workflows
