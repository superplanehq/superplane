...
<CardGrid>
  ...
  <LinkCard title="EC2 • Update Alarm" href="#ec2-•-update-alarm" description="Update an existing CloudWatch metric alarm for an EC2 instance" />
...
<a id="ec2-•-create-alarm"></a>

## EC2 • Create Alarm

**Component key:** `aws.ec2.createAlarm`
...
<a id="ec2-•-update-alarm"></a>

## EC2 • Update Alarm

**Component key:** `aws.ec2.updateAlarm`

The Update Alarm component modifies an existing CloudWatch metric alarm scoped to an EC2 instance.
