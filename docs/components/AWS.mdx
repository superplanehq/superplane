...
The Run Pipeline component starts an AWS CodePipeline execution and waits for it to complete.
...
- Falls back to polling if webhook events do not arrive in time
