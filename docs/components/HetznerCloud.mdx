...
Create and delete Hetzner Cloud servers and load balancers, and create/delete server snapshots
...
<CardGrid>
  ...
  <LinkCard title="Create Snapshot" href="#create-snapshot" description="Create a snapshot image from an existing Hetzner Cloud server." />
  ...
  <LinkCard title="Delete Snapshot" href="#delete-snapshot" description="Delete a snapshot image from Hetzner Cloud." />
