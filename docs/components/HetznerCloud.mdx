...
<CardGrid>
  <LinkCard
    title="Create Server"
    href="#create-server"
    description="Create a Hetzner Cloud server and wait for the action to complete"
  />
  <LinkCard
    title="Delete Server"
    href="#delete-server"
    description="Delete a Hetzner Cloud server and wait for the action to complete"
  />
  <LinkCard
    title="Create Load Balancer"
    href="#create-load-balancer"
    description="Create a Hetzner Cloud Load Balancer"
  />
  <LinkCard
    title="Delete Load Balancer"
    href="#delete-load-balancer"
    description="Delete a Hetzner Cloud Load Balancer"
  />
</CardGrid>
...
- **Algorithm** (optional): The load balancing algorithm — Round Robin (default) or Least Connections
