...
<CardGrid>
  ...
  <LinkCard title="Get Incident" href="#get-incident" description="Retrieve an incident from Rootly by ID" />
</CardGrid>
...
- **Incident status checks**: Fetch current incident details to drive workflow decisions
- **Data enrichment**: Retrieve incident information to enrich notifications or reports
- **Conditional workflows**: Check incident severity or status before taking further action
- **Cross-system sync**: Pull incident data to sync with external tools
