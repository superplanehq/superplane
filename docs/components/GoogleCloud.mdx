...
<CardGrid>
  ...
  <LinkCard title="Monitoring • Create Alerting Policy" href="#monitoring-•-create-alerting-policy" description="Create a Cloud Monitoring alerting policy that triggers when a Compute Engine instance metric crosses a threshold" />
  ...
  <LinkCard title="Monitoring • Update Alerting Policy" href="#monitoring-•-update-alerting-policy" description="Update an existing Cloud Monitoring alerting policy's threshold, state, or notifications" />
...
The Create Alerting Policy component creates a Cloud Monitoring alerting policy that fires when a Compute Engine instance metric crosses a threshold for a sustained duration.
