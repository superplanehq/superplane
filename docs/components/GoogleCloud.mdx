...
<CardGrid>
  ...
  <LinkCard title="Compute • Create TPU Node" href="#compute-•-create-tpu-node" description="Create a Cloud TPU node (TPU VM) in a Google Cloud project" />
  <LinkCard title="Compute • Delete TPU Node" href="#compute-•-delete-tpu-node" description="Delete a Cloud TPU node from a Google Cloud project" />
  <LinkCard title="Compute • Get TPU Node" href="#compute-•-get-tpu-node" description="Read the details and status of a Cloud TPU node" />
...
<a id="compute-•-create-tpu-node"></a>

## Compute • Create TPU Node

**Component key:** `gcp.tpu.createNode`

The Create Node component provisions a new Cloud TPU node (TPU VM) and waits for it to become ready before emitting.
...
```json
{
  "data": {
    ...
    "createTime": "2026-01-28T10:30:00.000Z",
    "health": "HEALTHY",
    "ipAddresses": [
      "10.128.0.5"
    ],
    ...
    "name": "my-tpu",
    "resourceName": "projects/my-project/locations/us-central1-b/nodes/my-tpu",
    "runtimeVersion": "tpu-vm-tf-2.16.1",
    "state": "READY"
  },
  "timestamp": "2026-01-28T10:30:00.000Z",
  "type": "gcp.tpu.node.created"
}
```

<a id="compute-•-delete-tpu-node"></a>

## Compute • Delete TPU Node

**Component key:** `gcp.tpu.deleteNode`

The Delete Node component deletes a Cloud TPU node and waits for the deletion to complete.
...
```json
{
  ...
  "timestamp": "2026-01-28T10:30:00.000Z",
  "type": "gcp.tpu.node.deleted"
}
```

<a id="compute-•-get-tpu-node"></a>

## Compute • Get TPU Node

**Component key:** `gcp.tpu.getNode`

The Get Node component reads the current details and status of a Cloud TPU node.
