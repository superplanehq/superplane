...
The Update Firewall Rule component changes an existing VPC firewall rule. For priority, protocols/ports, ranges, and description, toggle on only the fields you want to change; everything else is left untouched. **Targets** and **Source filter** are dropdowns that default to **"No change."**
