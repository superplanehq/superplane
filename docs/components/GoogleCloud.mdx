...
<CardGrid>
  ...
  <LinkCard title="Managed Prometheus • Query" href="#managed-prometheus-•-query" description="Run a PromQL query against Google Cloud Managed Service for Prometheus" />
...
The Query component runs a PromQL query against Google Cloud Managed Service for Prometheus (GMP).
