...
<CardGrid>
  <LinkCard title="Artifact Registry • Analyze Artifact" href="#artifact-registry-•-analyze-artifact" description="Analyze an Artifact Registry image for vulnerabilities and wait for results" />
...
{
  "action": "INSERT",
  "digest": "us-central1-docker.pkg.dev/my-project/my-repo/my-image@sha256:abc123def456",
...
<a id="artifact-registry-•-analyze-artifact"></a>

## Artifact Registry • Analyze Artifact

Queries Container Analysis for vulnerability occurrences on a container image and emits the results immediately.
...
```json
{
  ...
  "timestamp": "2025-01-01T00:05:00Z",
  "type": "gcp.artifactregistry.artifactAnalysis"
}
```
