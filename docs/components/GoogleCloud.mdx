...
<CardGrid>
  ...
  <LinkCard title="Cloud Storage • On Object Finalized" href="#cloud-storage-•-on-object-finalized" description="Trigger a workflow when a new object is created or overwritten in a Cloud Storage bucket" />
...
<CardGrid>
  ...
  <LinkCard title="Cloud Storage • Upload Object" href="#cloud-storage-•-upload-object" description="Upload an object to a Google Cloud Storage bucket" />
...
The On Object Finalized trigger starts a workflow execution when a new object is created or overwritten in a Google Cloud Storage bucket.
...
Retrieves the metadata of an object stored in a Google Cloud Storage bucket.
...
Uploads content as an object to a Google Cloud Storage bucket.
