...
The Expire Snooze component ends an active snooze immediately by moving its end time to now, so the policies it covers resume sending notifications. It is the GCP equivalent of expiring an Alertmanager silence.
