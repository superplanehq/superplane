...
<CardGrid>
  <LinkCard title="Get Pipeline" href="#get-pipeline" description="Retrieve a Semaphore pipeline by ID" />
...
The Get Pipeline component fetches a Semaphore pipeline by its ID.
