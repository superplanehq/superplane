...
<CardGrid>
  <LinkCard title="Get Job Logs" href="#get-job-logs" description="Get Semaphore job log output" />
...
The Get Job Logs component retrieves the log output for a Semaphore job by job ID.
