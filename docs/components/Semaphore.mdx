...
<CardGrid>
  ...
  <LinkCard title="Wait for Pipeline" href="#wait-for-pipeline" description="Wait for a Semaphore pipeline to finish" />
</CardGrid>
...
<a id="wait-for-pipeline"></a>

## Wait for Pipeline

**Component key:** `semaphore.waitForPipeline`

The Wait for Pipeline component waits for a Semaphore pipeline that was started elsewhere to finish, and routes the flow based on its result.
