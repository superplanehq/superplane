...
<CardGrid>
  ...
  <LinkCard title="On Commit Status" href="#on-commit-status" description="Listen to commit status changes in a GitLab project" />
...
**Trigger key:** `gitlab.onCommitStatus`

The On Commit Status trigger starts a workflow execution when the CI status of a commit changes in a GitLab project.
...
```json
{
  "data": {
    "builds": [
      {
        ...
        "created_at": "2026-02-13 17:59:40 UTC",
        "duration": 19,
        "environment": null,
        "failure_reason": null,
        "finished_at": "2026-02-13 18:00:00 UTC",
        "id": 998877,
        "manual": false,
        "name": "security-scan",
        "queued_duration": 1,
        "runner": null,
        "stage": "external",
        "started_at": "2026-02-13 17:59:41 UTC",
        "status": "success",
        "user": {
      ...
      },
      {
        ...
        "created_at": "2026-02-13 17:56:00 UTC",
        "duration": 120,
        "environment": null,
        "failure_reason": null,
        "finished_at": "2026-02-13 17:59:30 UTC",
        "id": 998876,
        "manual": false,
        "name": "unit-tests",
        "queued_duration": 3,
        ...
        "stage": "test",
        "started_at": "2026-02-13 17:57:30 UTC",
        "status": "success",
        "user": {
          "avatar_url": "https://gitlab.com/uploads/-/system/user/avatar/22/avatar.png",
          "email": "jrivera@example.com",
      ...
      },
      {
        ...
        "environment": null,
        "failure_reason": null,
        "finished_at": "2026-02-13 17:57:20 UTC",
        "id": 998875,
        "manual": false,
        "name": "build-image",
        "queued_duration": 4,
        ...
        "stage": "build",
        "started_at": "2026-02-13 17:56:04 UTC",
        "status": "success",
        "user": {
          "avatar_url": "https://gitlab.com/uploads/-/system/user/avatar/22/avatar.png",
          "email": "jrivera@example.com",
    ...
    "commit": {
      ...
      "timestamp": "2026-02-13T17:55:42+00:00",
    ...
    "merge_request": {
      ...
      "source_branch": "improve-ci-pipeline",
      "source_project_id": 987,
      "state": "opened",
      "target_branch": "main",
      "target_project_id": 987,
      "title": "Improve CI pipeline",
      "url": "https://gitlab.com/group/example-project/-/merge_requests/12"
    },
    "object_attributes": {
    ...
    "source_pipeline": {
      ...
      "project": {
        "id": 41,
        "path_with_namespace": "group/upstream-project",
        "web_url": "https://gitlab.com/group/upstream-project"
      }
    },
    "user": {
      "avatar_url": "https://gitlab.com/uploads/-/system/user/avatar/22/avatar.png",
