...
<CardGrid>
  ...
  <LinkCard title="Get Issue" href="#get-issue" description="Get a GitLab issue by IID" />
...
The Get Issue component retrieves a single issue from a GitLab project by its internal ID (IID).
...
```json
{
  "data": {
    ...
    "closed_at": null,
    "closed_by": null,
    "created_at": "2026-02-10T15:31:46.176Z",
    "description": "The login page fails to render on Safari",
    "due_date": null,
    "id": 41,
    "iid": 7,
    "labels": [
    ...
    "updated_at": "2026-02-12T09:12:03.000Z",
    "web_url": "https://gitlab.example.com/my-group/my-project/-/issues/7"
  },
