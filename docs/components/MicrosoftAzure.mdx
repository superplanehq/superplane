...
<CardGrid>
  ...
  <LinkCard title="Invoke Function" href="#invoke-function" description="Invokes an HTTP-triggered Azure Function" />
...
2. Constructs the function URL: https://&lbrace;functionApp&rbrace;.azurewebsites.net/api/&lbrace;functionName&rbrace;
