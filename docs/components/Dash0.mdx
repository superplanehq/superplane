...
<CardGrid>
  ...
  <LinkCard title="Get HTTP Synthetic Check" href="#get-http-synthetic-check" description="Fetch an existing HTTP synthetic check from Dash0 by ID" />
...
The Get HTTP Synthetic Check component retrieves a synthetic check from Dash0 by its ID. Use the check ID from a Create/Update output (e.g. metadata.labels["dash0.com/id"]) or from the Dash0 dashboard.
...
```json
{
  ...
  "timestamp": "2026-01-19T12:00:00Z",
  "type": "dash0.syntheticCheck.retrieved"
}
```
