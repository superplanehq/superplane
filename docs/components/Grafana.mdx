...
<CardGrid>
  ...
  <LinkCard title="Render Panel" href="#render-panel" description="Render a Grafana dashboard panel as a PNG image" />
...
The Render Panel component renders a Grafana dashboard panel as a PNG image using the Grafana Image Renderer.
