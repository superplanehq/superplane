...
Connect Grafana alerts, alert rules, annotations, silences, and data queries to SuperPlane workflows
...
<CardGrid>
  ...
  <LinkCard title="Get Data Source" href="#get-data-source" description="Retrieve details for a specific Grafana data source" />
...
The Get Data Source component fetches the full details of a single Grafana data source.
