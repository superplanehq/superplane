...
```json
{
  "data": {
    "notes": [
      ...
      {
        "id": "PNOTE002",
        "content": "Confirmed the issue is related to connection pool exhaustion. Scaling up the database connections.",
        "created_at": "2024-01-15T12:30:00Z",
        "user": {
          "html_url": "https://example.pagerduty.com/users/PUSER02",
          "id": "PUSER02",
          "summary": "Jane Smith",
          "type": "user_reference"
        },
