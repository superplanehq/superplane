...
<CardGrid>
  <LinkCard title="Acknowledge Incident" href="#acknowledge-incident" description="Acknowledge an incident in PagerDuty" />
  ...
  <LinkCard title="Escalate Incident" href="#escalate-incident" description="Escalate an incident to a specific level (high-urgency only)" />
  ...
  <LinkCard title="Reassign Escalation Policy" href="#reassign-escalation-policy" description="Reassign an incident to a different escalation policy" />
  <LinkCard title="Resolve Incident" href="#resolve-incident" description="Resolve an incident in PagerDuty" />
