...
<CardGrid>
  ...
  />
  <LinkCard
    title="On Incident Annotated"
    href="#on-incident-annotated"
    description="Listen to incident annotation events"
  />
  <LinkCard
    title="On Incident Status Update"
    href="#on-incident-status-update"
...
<CardGrid>
  <LinkCard
    ...
    href="#acknowledge-incident"
    description="Acknowledge an incident in PagerDuty"
  />
  <LinkCard
    title="Annotate Incident"
    href="#annotate-incident"
    description="Add a note to an existing incident in PagerDuty"
  />
  <LinkCard
  ...
  <LinkCard
    ...
    href="#escalate-incident"
    description="Escalate an incident to a specific level (high-urgency only)"
  />
  <LinkCard
    title="List Incidents"
    href="#list-incidents"
    description="Query PagerDuty to get a list of all open incidents (triggered and acknowledged)"
  />
  <LinkCard
    title="List Log Entries"
    href="#list-log-entries"
    description="List all log entries (audit trail) for a PagerDuty incident"
  />
  <LinkCard
    title="List Notes"
    href="#list-notes"
    description="List all notes (timeline entries) for a PagerDuty incident"
  />
  <LinkCard
    title="Reassign Escalation Policy"
    href="#reassign-escalation-policy"
    description="Reassign an incident to a different escalation policy"
  />
  <LinkCard
    title="Resolve Incident"
    href="#resolve-incident"
    description="Resolve an incident in PagerDuty"
  />
  <LinkCard
    title="Snooze Incident"
    href="#snooze-incident"
    description="Snooze an acknowledged incident in PagerDuty"
  />
  <LinkCard
    title="Update Incident"
    href="#update-incident"
...
:::caution[High-Urgency Incidents Only]
This action only works on **high-urgency incidents**. Low-urgency incidents cannot be escalated in PagerDuty. For low-urgency incidents, use the [Reassign Escalation Policy](#reassign-escalation-policy) action instead.
:::
...
- **Escalation Level**: The level to escalate to (1-10). This is the level number within the incident's current escalation policy. (Required)
- **From Email**: Email address of a valid PagerDuty user (required for App OAuth, optional for API tokens)

### Behavior

When an incident is escalated, it moves to the specified escalation level in the escalation policy. The new responders at that level will be notified immediately.
  ...
  "data": {
    "incident": {
      ...
      "assignments": [
        {
          "assignee": {
            "html_url": "https://subdomain.pagerduty.com/users/PUSER02",
            "id": "PUSER02",
            "self": "https://api.pagerduty.com/users/PUSER02",
            "summary": "Manager Smith",
            "type": "user_reference"
          },
          "at": "2015-10-06T21:42:00Z"
        }
      ],
      "created_at": "2015-10-06T21:30:42Z",
      "escalation_policy": {
      ...
      "incident_key": "baf7cf21b1da41b4b0221008339ff357",
      "incident_number": 1234,
      "last_status_change_at": "2015-10-06T21:42:00Z",
      "last_status_change_by": {
        "html_url": "https://subdomain.pagerduty.com/users/PXPGF42",
        "id": "PXPGF42",
        "self": "https://api.pagerduty.com/users/PXPGF42",
      ...
      "title": "The server is on fire.",
      "type": "incident",
      "updated_at": "2015-10-06T21:42:00Z",
      "urgency": "high"
    }
  },
  "timestamp": "2026-01-19T12:00:00Z",
...
<a id="reassign-escalation-policy"></a>

## Reassign Escalation Policy

The Reassign Escalation Policy component changes the escalation policy of an existing PagerDuty incident.
...
```json
{
  "data": {
    "incident": {
      ...
      "created_at": "2015-10-06T21:30:42Z",
      "escalation_policy": {
        "html_url": "https://subdomain.pagerduty.com/escalation_policies/PNEWPOL",
        "id": "PNEWPOL",
        "self": "https://api.pagerduty.com/escalation_policies/PNEWPOL",
...
```json
{
  ...
  "type": "pagerduty.notes.list"
    "incident": {
      ...
      "incident_key": "baf7cf21b1da41b4b0221008339ff357",
      "incident_number": 1234,
      "last_status_change_at": "2015-10-06T21:45:00Z",
      "last_status_change_by": {
        "html_url": "https://subdomain.pagerduty.com/users/PXPGF42",
        "id": "PXPGF42",
        "self": "https://api.pagerduty.com/users/PXPGF42",
      ...
      "resolved_at": "2015-10-06T21:45:00Z",
      "self": "https://api.pagerduty.com/incidents/PT4KHLK",
      "service": {
        "html_url": "https://subdomain.pagerduty.com/service-directory/PWIXJZS",
        "id": "PWIXJZS",
      ...
      "title": "The server is on fire.",
      "type": "incident",
      "updated_at": "2015-10-06T21:45:00Z",
      "urgency": "high"
    }
  },
  "timestamp": "2026-01-19T12:00:00Z",
