...
The List Log Entries component retrieves all log entries (audit trail) for a PagerDuty incident. Log entries provide a complete record of all incident activity including triggers, acknowledgments, escalations, reassignments, and annotations.
...
- **Limit**: Maximum number of log entries to return (optional, default: 100)
