...
<CardGrid>
  ...
  <LinkCard title="Get Workflow Usage" href="#get-workflow-usage" description="Get GitHub Actions workflow usage and billing information" />
...
The Get Workflow Usage component retrieves billable usage information for GitHub Actions workflows.
  ...
  "data": [
    {
      ...
      "workflow": {
        "badge_url": "https://github.com/acme/widgets/workflows/CI/badge.svg",
