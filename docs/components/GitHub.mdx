...
<CardGrid>
  ...
  <LinkCard title="Get Billing Usage" href="#get-billing-usage" description="Retrieve billable GitHub Actions usage (minutes) for the organization" />
...
<a id="get-billing-usage"></a>

## Get Billing Usage

The Get Billing Usage component retrieves billable GitHub Actions usage (minutes) for the installation's organization.
...
```json
{
  ...
  "timestamp": "2026-02-09T04:47:31.680755501Z",
  "type": "github.billing.usage"
}
```
