...
```json
{
  "data": {
    ...
    "repository": {
      ...
      "pushed_at": "2026-02-22T09:18:54Z",
  ...
  "timestamp": "2026-02-22T09:18:55.402817351Z",
...
```json
{
  "data": {
    ...
    "issue": {
      ...
      "body": "## Summary\n\nWhen the player presses the **Pause** key (`P`) while the apple-eaten animation is playing, the game freezes and the score stops updating. Resuming with `P` doesn't recover; only a full reload helps.\n\n## Steps to reproduce\n\n1. Start a new game\n2. Eat an apple and immediately press `P` during the eat animation\n3. Press `P` again to resume\n\n## Expected\n\nThe game pauses, then resumes normally with the score intact.\n\n## Actual\n\nThe canvas stops repainting and the score counter stays at the value it had when the apple was eaten.\n\n## Environment\n\n- Browser: Chrome 132 on macOS 14.5\n- Build: v1.4.0",
      "closed_at": null,
      "comments": 0,
      "comments_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/comments",
      "created_at": "2026-02-25T18:42:11Z",
      "draft": false,
      "events_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/events",
      "html_url": "https://github.com/acme-labs/snaketoy/issues/73",
      "id": 5183047291,
      "labels": [
        {
          "color": "d73a4a",
          ...
          "id": 889120329,
          "name": "bug",
          "node_id": "LA_kwDOQ7c2jM8AAAABN9qLiQ",
          "url": "https://api.github.com/repos/acme-labs/snaketoy/labels/bug"
        }
      ],
      "labels_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/labels{/name}",
      "locked": false,
      "milestone": null,
      "node_id": "I_kwDOQ7c2jM7nKlA7",
      "number": 73,
      ...
      "reactions": {
        ...
        "rocket": 0,
        "total_count": 0,
        "url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/reactions"
      },
      "repository_url": "https://api.github.com/repos/acme-labs/snaketoy",
      "state": "open",
      "state_reason": null,
      "timeline_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/timeline",
      "title": "Game freezes when pressing Pause during apple animation",
      "updated_at": "2026-02-25T18:42:11Z",
      "url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73",
      "user": {
        "avatar_url": "https://avatars.githubusercontent.com/u/90231477?v=4",
        "events_url": "https://api.github.com/users/renato-dev/events{/privacy}",
        "followers_url": "https://api.github.com/users/renato-dev/followers",
  ...
  "timestamp": "2026-02-25T18:42:13.184502771Z",
  "type": "github.issue"
}
```
...
```json
{
  "data": {
    ...
    "comment": {
      ...
      "body": "Reproduced on Firefox 124 as well. Looks like the requestAnimationFrame loop is being cancelled but never re-armed when the eat animation owns the timer. I can take a stab at this tomorrow.",
      "created_at": "2026-02-25T19:03:38Z",
      "html_url": "https://github.com/acme-labs/snaketoy/issues/73#issuecomment-4928461002",
      "id": 4928461002,
      "issue_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73",
      "node_id": "IC_kwDOQ7c2jM7zXz4K",
      "performed_via_github_app": null,
      "reactions": {
        "+1": 1,
        "-1": 0,
        ...
        "rocket": 0,
        "total_count": 1,
        "url": "https://api.github.com/repos/acme-labs/snaketoy/issues/comments/4928461002/reactions"
      },
      "updated_at": "2026-02-25T19:03:38Z",
      "url": "https://api.github.com/repos/acme-labs/snaketoy/issues/comments/4928461002",
      "user": {
    ...
    "issue": {
      ...
      "timeline_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73/timeline",
      "title": "Game freezes when pressing Pause during apple animation",
      "updated_at": "2026-02-25T19:03:42Z",
      "url": "https://api.github.com/repos/acme-labs/snaketoy/issues/73",
      "user": {
        "avatar_url": "https://avatars.githubusercontent.com/u/90231477?v=4",
        "events_url": "https://api.github.com/users/renato-dev/events{/privacy}",
  ...
  "timestamp": "2026-02-25T19:03:42.521307118Z",
...
```json
{
  "data": {
    ...
    "pull_request": {
      "_links": {
        ...
        "statuses": {
          "href": "https://api.github.com/repos/acme-labs/snaketoy/statuses/9c2f1b03a8e1d647c2d4e9af3120cd5e8aab2c14"
        }
      },
      "active_lock_reason": null,
      "additions": 18,
      ...
      "base": {
        ...
        "sha": "1f5d8a02e8d4c5b6e9a1f2c3d4e5f6071829a3b4",
        "user": {
          "avatar_url": "https://avatars.githubusercontent.com/u/55120911?v=4",
          "events_url": "https://api.github.com/users/acme-labs/events{/privacy}",
          "followers_url": "https://api.github.com/users/acme-labs/followers",
      ...
      "body": "Renames the game title shown in the UI from \"Snake\" to \"Snake Toy\" to match the marketing copy. Updates the page header, favicon tooltip, and a couple of doc strings.\n\n## What changed\n\n- Updated `\u003ctitle\u003e` and `\u003ch1\u003e` text\n- Renamed instances in `README.md`\n- Refreshed screenshots in `docs/`\n\n## Out of scope\n\n- The npm package name; happy to do that in a follow-up.",
      "changed_files": 4,
      "closed_at": null,
      "comments": 0,
      "comments_url": "https://api.github.com/repos/acme-labs/snaketoy/issues/42/comments",
      ...
      "draft": false,
      "head": {
        "label": "acme-labs:rename-snaketoy",
        "ref": "rename-snaketoy",
        "repo": {
          "allow_forking": true,
          "archive_url": "https://api.github.com/repos/acme-labs/snaketoy/{archive_format}{/ref}",
        ...
        "sha": "9c2f1b03a8e1d647c2d4e9af3120cd5e8aab2c14",
        "user": {
          "avatar_url": "https://avatars.githubusercontent.com/u/55120911?v=4",
          "events_url": "https://api.github.com/users/acme-labs/events{/privacy}",
          "followers_url": "https://api.github.com/users/acme-labs/followers",
      ...
      "review_comments_url": "https://api.github.com/repos/acme-labs/snaketoy/pulls/42/comments",
      "state": "open",
      "statuses_url": "https://api.github.com/repos/acme-labs/snaketoy/statuses/9c2f1b03a8e1d647c2d4e9af3120cd5e8aab2c14",
      "title": "Rename title from 'Snake' to 'Snake Toy'",
      "updated_at": "2026-02-25T18:02:11Z",
      "url": "https://api.github.com/repos/acme-labs/snaketoy/pulls/42",
      "user": {
        "avatar_url": "https://avatars.githubusercontent.com/u/90231477?v=4",
        "events_url": "https://api.github.com/users/renato-dev/events{/privacy}",
  ...
  "timestamp": "2026-02-25T18:02:13.487229014Z",
...
```json
{
  "data": {
    ...
    "release": {
      "assets": [
        {
          "browser_download_url": "https://github.com/acme-labs/snaketoy/releases/download/v1.5.0/snaketoy-v1.5.0.zip",
          "content_type": "application/zip",
          "created_at": "2026-03-01T11:42:18Z",
          "download_count": 0,
          "id": 188432019,
          "label": null,
          "name": "snaketoy-v1.5.0.zip",
          "node_id": "RA_kwDOQ7c2jM8AAAAACyZsmw",
          "size": 248713,
          "state": "uploaded",
          "updated_at": "2026-03-01T11:42:21Z",
          "uploader": {
            "avatar_url": "https://avatars.githubusercontent.com/u/77100412?v=4",
            "events_url": "https://api.github.com/users/acme-ci/events{/privacy}",
            "followers_url": "https://api.github.com/users/acme-ci/followers",
          ...
          "url": "https://api.github.com/repos/acme-labs/snaketoy/releases/assets/188432019"
        }
      ],
      "assets_url": "https://api.github.com/repos/acme-labs/snaketoy/releases/188430021/assets",
      "author": {
        "avatar_url": "https://avatars.githubusercontent.com/u/90231477?v=4",
        "events_url": "https://api.github.com/users/renato-dev/events{/privacy}",
        "followers_url": "https://api.github.com/users/renato-dev/followers",
      ...
      "body": "## Highlights\n\n- New score multiplier when eating two apples in a row\n- Fixed a long-standing freeze when pressing Pause during the eat animation (#73)\n- Updated screenshots in `docs/`\n\n## Upgrade notes\n\nNo breaking changes. Just refresh the page to load the new build.\n\n## Contributors\n\nThanks to @jules-ramirez for reviewing the multiplier change.",
      "created_at": "2026-03-01T11:38:02Z",
      "draft": false,
      "html_url": "https://github.com/acme-labs/snaketoy/releases/tag/v1.5.0",
      "id": 188430021,
      "mentions_count": 1,
      "name": "v1.5.0 — Score multiplier",
      "node_id": "RE_kwDOQ7c2jM4LPCwF",
      "prerelease": false,
      "published_at": "2026-03-01T11:42:24Z",
      "tag_name": "v1.5.0",
      "tarball_url": "https://api.github.com/repos/acme-labs/snaketoy/tarball/v1.5.0",
      "target_commitish": "main",
      "upload_url": "https://uploads.github.com/repos/acme-labs/snaketoy/releases/188430021/assets{?name,label}",
      "url": "https://api.github.com/repos/acme-labs/snaketoy/releases/188430021",
      "zipball_url": "https://api.github.com/repos/acme-labs/snaketoy/zipball/v1.5.0"
    },
    "repository": {
      "allow_forking": true,
      "archive_url": "https://api.github.com/repos/acme-labs/snaketoy/{archive_format}{/ref}",
      ...
      "private": false,
      "pulls_url": "https://api.github.com/repos/acme-labs/snaketoy/pulls{/number}",
      "pushed_at": "2026-03-01T11:42:24Z",
      "releases_url": "https://api.github.com/repos/acme-labs/snaketoy/releases{/id}",
      "size": 1432,
      "ssh_url": "git@github.com:acme-labs/snaketoy.git",
      "stargazers_count": 24,
      ...
      "trees_url": "https://api.github.com/repos/acme-labs/snaketoy/git/trees{/sha}",
      "updated_at": "2026-03-01T11:42:24Z",
      "url": "https://api.github.com/repos/acme-labs/snaketoy",
      "visibility": "public",
      "watchers": 24,
      "watchers_count": 24,
  ...
  "timestamp": "2026-03-01T11:42:25.198321047Z",
  "type": "github.release"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-01T11:38:01.219450873Z",
...
```json
{
  "data": {
    "actor": {
      "avatar_url": "https://avatars.githubusercontent.com/u/87654321?v=4",
      "gravatar_id": "",
      "html_url": "https://github.com/renatodev",
      "id": 87654321,
      "login": "renatodev",
      "node_id": "MDQ6VXNlcjg3NjU0MzIx",
      "site_admin": false,
      "type": "User",
      "url": "https://api.github.com/users/renatodev"
    },
    "artifacts_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901/artifacts",
    "cancel_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901/cancel",
    "check_suite_id": 11223344556,
    "check_suite_node_id": "CS_kwDOBb1AaA0000000",
    "check_suite_url": "https://api.github.com/repos/acme-labs/snaketoy/check-suites/11223344556",
    "conclusion": "success",
    "created_at": "2026-03-10T14:22:11Z",
    "event": "push",
    "head_branch": "main",
    ...
    "head_repository": {
      "description": "A toy snake game service",
      "fork": false,
      "full_name": "acme-labs/snaketoy",
      "html_url": "https://github.com/acme-labs/snaketoy",
      "id": 987654321,
    ...
    "head_sha": "4f9c2e1a7b3d45c0d1e9f23456789abcdeffed01",
    "html_url": "https://github.com/acme-labs/snaketoy/actions/runs/12345678901",
    "id": 12345678901,
    "jobs_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901/jobs",
    "logs_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901/logs",
    "name": "CI",
    "node_id": "WFR_kwLOBb1AaA123456789",
    "path": ".github/workflows/ci.yml",
    "pull_requests": [],
    ...
    "rerun_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901/rerun",
    "run_attempt": 1,
    "run_number": 42,
    "run_started_at": "2026-03-10T14:22:11Z",
    "status": "completed",
    ...
    "updated_at": "2026-03-10T14:25:30Z",
    "url": "https://api.github.com/repos/acme-labs/snaketoy/actions/runs/12345678901",
    "workflow_id": 9876543,
    "workflow_url": "https://api.github.com/repos/acme-labs/snaketoy/actions/workflows/9876543"
  },
