...
<CardGrid>
  ...
  <LinkCard title="On Dependabot Alert" href="#on-dependabot-alert" description="Listen to Dependabot alert events" />
...
<a id="on-dependabot-alert"></a>

## On Dependabot Alert

**Trigger key:** `github.onDependabotAlert`

The On Dependabot Alert trigger starts a workflow execution when GitHub reports a Dependabot alert in a repository.
