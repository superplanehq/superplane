...
<CardGrid>
  ...
  <LinkCard title="Find Pull Request" href="#find-pull-request" description="Find an existing pull request in a GitHub repository by branch" />
  ...
  <LinkCard title="Wait For Pull Request Mergeable" href="#wait-for-pull-request-mergeable" description="Wait until GitHub reports whether a pull request has a merge conflict" />
</CardGrid>
...
**Component key:** `github.findPullRequest`

The Find Pull Request component looks up a pull request in a GitHub repository by its head branch, so a workflow can decide whether to create a new pull request or update one that already exists.
...
<a id="wait-for-pull-request-mergeable"></a>

## Wait For Pull Request Mergeable

**Component key:** `github.waitForPullRequestMergeable`

The Wait For Pull Request Mergeable component polls one pull request until GitHub finishes computing mergeability.
