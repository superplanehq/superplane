...
<CardGrid>
  ...
  <LinkCard title="Request Pull Request Reviewer" href="#request-pull-request-reviewer" description="Request reviewers on a GitHub pull request" />
...
<a id="request-pull-request-reviewer"></a>

## Request Pull Request Reviewer

**Component key:** `github.requestPullRequestReviewer`

The Request Pull Request Reviewer component requests individual users and/or teams to review a GitHub pull request.
