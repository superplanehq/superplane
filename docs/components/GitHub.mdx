...
<CardGrid>
  ...
  <LinkCard title="Get Repository Issues" href="#get-repository-issues" description="List issues from a GitHub repository" />
...
<a id="get-repository-issues"></a>

## Get Repository Issues

The Get Repository Issues component retrieves a list of issues from a GitHub repository.
...
```json
{
  "data": [
    ...
    {
      "body": "Would be great to have a dark mode option in the settings.",
      "comments_count": 7,
