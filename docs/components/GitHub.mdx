...
<CardGrid>
  ...
  <LinkCard title="Get Workflow Usage" href="#get-workflow-usage" description="Retrieve billable GitHub Actions usage (minutes) for an organization" />
...
The Get Workflow Usage component retrieves **billable** GitHub Actions usage for the integration installation's organization using GitHub's billing usage API.
