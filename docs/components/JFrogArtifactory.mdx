...
<CardGrid>
  ...
  <LinkCard title="Upload Artifact" href="#upload-artifact" description="Upload an artifact to JFrog Artifactory" />
</CardGrid>
...
<a id="upload-artifact"></a>

## Upload Artifact

The Upload Artifact component deploys an artifact to a JFrog Artifactory repository.
...
```json
{
  ...
  "timestamp": "2026-01-23T12:00:00Z",
  "type": "jfrogArtifactory.artifact.uploaded"
}
```
