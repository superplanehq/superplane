...
<CardGrid>
  ...
  <LinkCard title="On Function Invoked" href="#on-function-invoked" description="Fires when an OCI Function is invoked (via OCI Events / Audit trail)" />
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard title="Delete Application" href="#delete-application" description="Delete an OCI Functions application and all of its functions" />
...
<a id="on-function-invoked"></a>

## On Function Invoked

The On Function Invoked trigger starts a workflow execution whenever an OCI Function invocation is recorded by the OCI Audit trail.
...
```json
{
  ...
  "data": {
    "additionalDetails": {
      ...
      "X-Oracle-Oci-Request-Id": "B1234567890ABCDEF1234567890ABCDE"
    },
    ...
    "definedTags": {},
    "freeFormTags": {},
    "resourceId": "ocid1.fnfunc.oc1.eu-frankfurt-1.aaaaExample1234567890abcdefghijklmnopqrstuvwxyz",
    "resourceName": "my-function"
  },
  "eventID": "e1a2b3c4-1234-5678-abcd-ef1234567890",
  "eventTime": "2026-04-22T20:34:05Z",
  "eventType": "com.oraclecloud.functions.invokefunction",
  "eventTypeVersion": "2.0",
  "extensions": {
    "compartmentId": "ocid1.tenancy.oc1..aaaaaaaExample1234567890abcdefghijklmnopqrstuvwxyz1234567890"
...
The Delete Application component removes an Oracle Cloud Infrastructure Functions application and all functions it contains.
