...
<CardGrid>
  ...
  <LinkCard title="Delete Image" href="#delete-image" description="Delete an OCI image by OCID" />
  <LinkCard title="Get Image" href="#get-image" description="Get OCI image details by OCID" />
  <LinkCard title="Update Image" href="#update-image" description="Update an OCI image display name" />
</CardGrid>
...
The Delete Image component deletes an OCI Compute image.
...
The Get Image component retrieves metadata for an OCI Compute image.
...
The Update Image component updates the display name of an OCI Compute image.
