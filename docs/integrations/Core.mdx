...
The Time Gate component delays event processing until a specific time window is reached, allowing you to control when events proceed through your workflow.
