...
Query PagerDuty to get a list of all open incidents (triggered and acknowledged)

### Configuration

| Name | Label | Type | Required | Description |
| --- | --- | --- | --- | --- |
| services | Services | app-installation-resource | no | Filter incidents by specific services. If not specified, all services are included. |
