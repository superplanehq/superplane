...
| `addPullRequestActivity` | required `pullRequestId`, optional `description` | Links the current run to the pull request. Idempotent. `description` records why the run is linked and can use event data. |
