...
| `SUPERPLANE_MAX_RUNNER_PAYLOAD_SIZE` | `4194304` (4 MiB) | Maximum serialized size of a runner completion payload, in bytes. Also caps runner broker webhook request bodies. |
