...
CREATE TABLE public.canvas_folders (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT canvas_folders_background_color_check CHECK (((background_color)::text = ANY ((ARRAY['color_1'::character varying, 'color_2'::character varying, 'color_3'::character varying, 'color_4'::character varying, 'color_5'::character varying, 'color_6'::character varying])::text[])))
);
