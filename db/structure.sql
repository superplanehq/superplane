...
--
ALTER TABLE
    ONLY public.stage_event_tags
ADD
    CONSTRAINT stage_event_tags_pkey PRIMARY KEY (name, value, stage_event_id);
...
ALTER TABLE
    ONLY public.stage_event_tags
ADD
    CONSTRAINT stage_event_tags_stage_event_id_fkey FOREIGN KEY (stage_event_id) REFERENCES public.stage_events(id);
